...
- [x] 1.1 Add `textDefaultShadowSkewX` to the PPJ schema, native leaf registry,
      capability reference, and generated manual; verify JSON and maintainer
      contract checks.
- [x] 1.2 Project an existing paragraph default outer-shadow `kx` as a
...
- [x] 2.1 Extend edit-plan validation and expected-value proof for the strict
      ...
      closed.
- [x] 2.2 Splice only `a:outerShdw/@kx` in the owning SlidePart; verify sibling
