...
description: "Use a compact operational control language for throughput, owners, blockers, and next actions."
---
...
Use a compact operational page with graphite type, green status evidence, and orange escalation signals. Organize by baselines, columns, owners, and timestamps rather than rounded panels. Dense pages must still expose one operating conclusion.
