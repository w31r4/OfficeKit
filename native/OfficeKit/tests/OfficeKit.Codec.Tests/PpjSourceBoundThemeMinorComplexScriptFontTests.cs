...
{
    [Fact]
    public void PpjSourceBoundThemeMinorComplexScriptFontEditsOnlyOwnedSlotAndReprojects()
    {
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            {
                SourceUri = "deck.assets/source/theme-minor-complex-script-font.pptx",
            },
        });
        ...
        Assert.Contains(nativeRef["capabilities"]!.AsArray(), capability =>
            capability!["operation"]!.GetValue<string>() == "setThemeMinorFontComplexScript" &&
            capability["fields"]!.AsArray().Any(field => field!.GetValue<string>() == "fontScheme.minorComplexScript"));
        ...
        editedProgram["design"]!["theme"]!["fontScheme"]!["minorComplexScript"] = "Nebula Hebrew";
        ...
        using (var package = PresentationDocument.Open(stream, false))
        {
            ...
            Assert.Equal("Nebula Hebrew", fontScheme.MinorFont.ComplexScriptFont!.Typeface!.Value);
        }
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/theme-minor-complex-script-font.pptx",
            },
        });
        Assert.True(reprojected.Ok, Diagnostics(reprojected));
        var reprojectedProgram = JsonNode.Parse(reprojected.PresentationProgram.ProgramJson.ToByteArray())!.AsObject();
        Assert.Equal("Nebula Hebrew", reprojectedProgram["design"]!["theme"]!["fontScheme"]!["minorComplexScript"]!.GetValue<string>());
        ...
        tamperedProgram["design"]!["theme"]!["nativeRef"]!["capabilities"]!.AsArray()
            .Single(capability => capability!["operation"]!.GetValue<string>() == "setThemeMinorFontComplexScript")!["fields"] = new JsonArray("fontScheme.major");
