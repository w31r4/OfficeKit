...
{
    [Fact]
    public void PpjSourceBoundShape3dSceneLightRigDirectionLeafEditsAndReprojects()
    {
        var authored = Invoke(ExportRequest());
        Assert.True(authored.Ok, Diagnostics(authored));
        var source = AddShape3dSceneLightRigDirection(RemoveEmbeddedPpj(authored.File.ToByteArray()), "t");
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            {
                SourceUri = "deck.assets/source/shape-3d-scene-light-rig-direction.pptx",
            },
        });
        ...
        Assert.Contains("<a:lightRig rig=\"threePt\" dir=\"br\"", editedXml, StringComparison.Ordinal);
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/shape-3d-scene-light-rig-direction.pptx",
            },
        });
    ...
    private static byte[] AddShape3dSceneLightRigDirection(byte[] source, string direction)
    {
