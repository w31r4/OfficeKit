...
{
    [Fact]
    public void PpjSourceBoundShape3dExtrusionRgbLeafEditsAndReprojects()
    {
        var authored = Invoke(ExportRequest());
        Assert.True(authored.Ok, Diagnostics(authored));
        var source = AddShape3dExtrusionRgb(RemoveEmbeddedPpj(authored.File.ToByteArray()), "663399");
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            {
                SourceUri = "deck.assets/source/shape-3d-extrusion-rgb.pptx",
            },
        });
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/shape-3d-extrusion-rgb.pptx",
            },
        });
    ...
    private static byte[] AddShape3dExtrusionRgb(byte[] source, string rgb)
    {
