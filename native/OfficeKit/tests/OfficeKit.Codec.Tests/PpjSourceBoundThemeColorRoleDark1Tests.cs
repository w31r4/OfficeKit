...
{
    [Fact]
    public void PpjSourceBoundThemeColorRoleDark1EditsOnlyDark1AndReprojects()
    {
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            {
                SourceUri = "deck.assets/source/theme-color-role-dark1.pptx",
            },
        });
        ...
        editedProgram["design"]!["theme"]!["colorRoles"]!["dark1"] = "#ABCDEF";
        ...
        using (var package = PresentationDocument.Open(stream, false))
        {
            ...
            Assert.Equal("ABCDEF", scheme.Dark1Color!.RgbColorModelHex!.Val!.Value);
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/theme-color-role-dark1.pptx",
            },
        });
        Assert.True(reprojected.Ok, Diagnostics(reprojected));
        var reprojectedProgram = JsonNode.Parse(reprojected.PresentationProgram.ProgramJson.ToByteArray())!.AsObject();
        Assert.Equal("#ABCDEF", reprojectedProgram["design"]!["theme"]!["colorRoles"]!["dark1"]!.GetValue<string>());

        var unauthorizedProgram = JsonNode.Parse(projectedProgram.ToJsonString())!.AsObject();
        unauthorizedProgram["design"]!["theme"]!["colorRoles"]!.AsObject().Remove("dark1");
        ...
        unownedProgram["design"]!["theme"]!["colorRoles"]!["dark2"] = "#202122";
        ...
        tamperedProgram["design"]!["theme"]!["nativeRef"]!["capabilities"]!.AsArray()
            .Single(capability => capability!["operation"]!.GetValue<string>() == "setThemeColorRoleDark1")!["fields"] = new JsonArray("colorRoles.dark2");
