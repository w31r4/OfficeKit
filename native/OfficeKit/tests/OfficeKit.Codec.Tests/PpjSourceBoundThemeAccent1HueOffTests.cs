...
{
    [Fact]
    public void PpjSourceBoundThemeAccent1HueOffEditsOnlyHueOffAndReprojects()
    {
        ...
        {
            Role = "accent1",
            HueOffsetAngleThousandth = 750_000,
        });
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            {
                SourceUri = "deck.assets/source/theme-accent1-hueOff.pptx",
            },
        });
        ...
        Assert.Equal(12.5, projectedTransform["hueOff"]!.GetValue<double>());
        var nativeRef = Assert.IsType<JsonObject>(projectedTheme["nativeRef"]);
        Assert.Contains(nativeRef["capabilities"]!.AsArray(), capability =>
            capability!["operation"]!.GetValue<string>() == "setThemeAccent1HueOff" &&
            capability["fields"]!.AsArray().Any(field => field!.GetValue<string>() == "accentTransforms.accent1.hueOff"));
        ...
        editedProgram["design"]!["theme"]!["accentTransforms"]!["accent1"]!["hueOff"] = 30.0;
        ...
        using (var package = PresentationDocument.Open(stream, false))
        {
            ...
            Assert.Equal(1_800_000, Assert.Single(accent1.Elements<A.HueOffset>()).Val!.Value);
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/theme-accent1-hueOff.pptx",
            },
        });
        Assert.True(reprojected.Ok, Diagnostics(reprojected));
        var reprojectedProgram = JsonNode.Parse(reprojected.PresentationProgram.ProgramJson.ToByteArray())!.AsObject();
        Assert.Equal(30.0, reprojectedProgram["design"]!["theme"]!["accentTransforms"]!["accent1"]!["hueOff"]!.GetValue<double>());

        var unauthorizedProgram = JsonNode.Parse(projectedProgram.ToJsonString())!.AsObject();
        unauthorizedProgram["design"]!["theme"]!["accentTransforms"]!["accent1"]!["hueOff"] = 40.0;
        unauthorizedProgram["design"]!["theme"]!["nativeRef"]!["capabilities"]!.AsArray()
            .Single(capability => capability!["operation"]!.GetValue<string>() == "setThemeAccent1HueOff")!["fields"] = new JsonArray("accentTransforms.accent1.tint");
        ...
        deletionProgram["design"]!["theme"]!["accentTransforms"]!["accent1"]!.AsObject().Remove("hueOff");
        ...
        siblingProgram["design"]!["theme"]!["accentTransforms"]!["accent1"]!["hueMod"] = 0.1;
        ...
        outOfRangeProgram["design"]!["theme"]!["accentTransforms"]!["accent1"]!["hueOff"] = 361.0;
