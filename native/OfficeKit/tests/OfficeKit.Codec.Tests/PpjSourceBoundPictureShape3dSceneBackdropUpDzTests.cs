...
{
    [Fact]
    public void PpjSourceBoundPictureShape3dSceneBackdropUpDzLeafEditsAndReprojects()
    {
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest { SourceUri = "deck.assets/source/picture-backdrop-up-dz.pptx" },
        });
        ...
        Assert.Equal(6, target["value"]!.GetValue<long>());
        target["value"] = 7;
        ...
        Assert.Contains("<a:up dx=\"4\" dy=\"5\" dz=\"7\"", xml, StringComparison.Ordinal);
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest { SourceUri = "deck.assets/edited/picture-backdrop-up-dz.pptx" },
        });
        ...
        var reprojectedTarget = Assert.Single(reprojectedImage["nativeRef"]!["leaves"]!.AsArray().Select(leaf => leaf!.AsObject())
            .Where(leaf => leaf["kind"]!.GetValue<string>() == "shape3dSceneBackdropUpDzEmu"));
        Assert.Equal(7, reprojectedTarget["value"]!.GetValue<long>());
    }
}
