...
export const HELP_CATALOG = [
  ...
  { artifactKind: "workbook", kind: "api", name: "officeKitStatus", summary: "Lazily initialize the bundled OfficeKit WebAssembly runtime and report its protocol, assembly, and integrity manifest." },
...
const WORKBOOK_HELP_SCHEMAS = {
  ...
  "officeKitStatus": helpSchema({}, "status", "object", "Bundled OfficeKit runtime status with protocolVersion, assemblyName, and integrity manifest."),
