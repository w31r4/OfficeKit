...
Use this style when the brief matches **place handbook; promotion presentation**. It is designed for
public audiences, communities, brand teams. Its visual premise is River-blue routes alternate between narrative and practical guide spreads. The style is a
...
**big idea → audience truth → creative system → waves or experiences → measured outcome → next move**. This style is not a good fit for **investment diligence**;
...
- Use **#EEE8DC** as the main field, **#243535** for primary type, **#277B91** for the decisive signal, **#D66552** for secondary evidence, and **#D2C8B7** for rules or context.
...
- The recurring structure is **wayfinding, variable page silhouettes, documentary imagery**. Vary the silhouette between
...
The expected density is **mixed**: spaciousness must create emphasis, not hide missing content. Alternate page
...
- **Page skeleton.** Use beige paper, a river-blue axis, and one chapter accent. The common skeleton is a left lead-in with the question or sample and a right evidence zone divided by fine lines, not rounded cards.
- **Type rhythm.** Use sans for titles and navigation with a serif narrative layer when the page needs a handbook voice. Keep chapter labels small and practical.
- **Evidence carriers.** Use leader-line anatomy diagrams, image evidence matrices, pairwise sample comparisons, timelines, and practical tables. Every line should point to a named feature.
- **Images and layers.** Documentary images of real people and places are preferred for identity. Crop with square corners, retain source/alt text, and never use staged stock as a substitute.
- **Pacing.** Alternate a story spread, a sample or method spread, and a practical takeaway. Keep one chapter color active at a time and make the final page useful after the talk.
- **Selection rule.** Choose this style for handbooks, field guides, travel/service narratives, and practical design research.
