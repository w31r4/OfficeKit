...
Use this style when the brief matches **annual investment outlook; finance presentation**. It is designed for
investors, finance leaders, analysts. Its visual premise is Navy authority and mint evidence give an outlook editorial momentum. The style is a
...
**stance → drivers → evidence → scenarios → risks → decision or allocation**. This style is not a good fit for **heritage luxury**;
...
- Use **#F7F9F8** as the main field, **#112A3C** for primary type, **#27D69B** for the decisive signal, **#9C78D7** for secondary evidence, and **#DDE6E3** for rules or context.
...
- The recurring structure is **prospectus, variable page silhouettes, documentary imagery**. Vary the silhouette between
  cover, evidence, data, process, comparison, and decision pages rather than
  repeating a component grid.
- Use a forward-looking field, large directional type, and a small number of evidence anchors. Separate outlook assumptions from observed history.
...
- **Page skeleton.** Open with a navy prospectus field, a bold thesis, and one mint evidence signal; body pages return to a calm light field with generous horizontal movement. Use an image-led opening only when it establishes the market or world.
- **Type rhythm.** Use a condensed or strongly weighted display for the outlook thesis and a neutral sans for evidence. The headline should feel decisive while the numbers stay audit-friendly.
- **Evidence carriers.** Use outlook lines, scenario ranges, market maps, thesis rails, and one main chart per page. Separate base, upside, and downside with labels and assumptions, not color alone.
- **Images and layers.** Use one atmospheric or documentary image for the opening or a chapter. Do not fill analysis pages with stock imagery; preserve image crop and contrast if text shares the field.
- **Pacing.** Thesis → drivers → evidence → scenarios → risk. Navy pages create momentum; light pages do the proof work. Mint should land on the chosen signal or action.
- **Selection rule.** Choose this style for market outlooks, investment prospectuses, and strategic narratives that need editorial momentum.

## Signature moves and variation limits

- Let **prospectus** recur as a quiet identity cue on selected pages; it must
