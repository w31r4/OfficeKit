...
{
    [Fact]
    public void PpjSourceBoundThemeMajorFontEditsOnlyLatinMajorSlotAndReprojects()
    {
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            {
                SourceUri = "deck.assets/source/theme-major-font.pptx",
            },
        });
        ...
        Assert.Contains(nativeRef["capabilities"]!.AsArray(), capability =>
            capability!["operation"]!.GetValue<string>() == "setThemeFontScheme" &&
            capability["fields"]!.AsArray().Any(field => field!.GetValue<string>() == "fontScheme.major"));
        ...
        editedProgram["design"]!["theme"]!["fontScheme"]!["major"] = "Nebula Sans";
        ...
        using (var package = PresentationDocument.Open(stream, false))
        {
            ...
            Assert.Equal("Nebula Sans", fontScheme.MajorFont!.LatinFont!.Typeface!.Value);
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/theme-major-font.pptx",
            },
        });
        Assert.True(reprojected.Ok, Diagnostics(reprojected));
        var reprojectedProgram = JsonNode.Parse(reprojected.PresentationProgram.ProgramJson.ToByteArray())!.AsObject();
        Assert.Equal("Nebula Sans", reprojectedProgram["design"]!["theme"]!["fontScheme"]!["major"]!.GetValue<string>());

        var unauthorizedProgram = JsonNode.Parse(editedProgram.ToJsonString())!.AsObject();
        unauthorizedProgram["design"]!["theme"]!["fontScheme"]!["minor"] = "Changed Minor";
        ...
        tamperedProgram["design"]!["theme"]!["nativeRef"]!["capabilities"]!.AsArray()
            .Single(capability => capability!["operation"]!.GetValue<string>() == "setThemeFontScheme")!["fields"] = new JsonArray("fontScheme.minor");
