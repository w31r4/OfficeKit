...
{
    [Fact]
    public void PpjSourceBoundCustomGeometryPathCubicControl1YEditsAndReprojects()
    {
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            {
                SourceUri = "deck.assets/source/custom-geometry-path-cubic-control1-y.pptx",
            },
        });
        ...
        var cubicLeaves = projectedShape["nativeRef"]!["leaves"]!.AsArray()
            ...
            .Where(leaf => leaf["kind"]!.GetValue<string>() == "customGeometryPathCubicControl1Y")
            .ToArray();
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/custom-geometry-path-cubic-control1-y.pptx",
            },
        });
