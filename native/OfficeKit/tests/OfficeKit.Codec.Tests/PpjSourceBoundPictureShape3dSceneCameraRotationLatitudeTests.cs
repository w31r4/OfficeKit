...
{
    [Fact]
    public void PpjSourceBoundPictureShape3dSceneCameraRotationLatitudeLeafEditsAndReprojects()
    {
        ...
        var source = AddPictureShape3dSceneCameraRotationLatitude(RemoveEmbeddedPpj(authored.File.ToByteArray()), "0");
        var projected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/source/picture-shape-3d-scene-camera-rotation-latitude.pptx",
            },
        });
        ...
        var target = Assert.Single(projectedImage["nativeRef"]!["leaves"]!.AsArray()
            ...
            .Where(leaf => leaf["kind"]!.GetValue<string>() == "shape3dSceneCameraRotationLatitude60000"));
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/picture-shape-3d-scene-camera-rotation-latitude.pptx",
            },
        });
    ...
    private static byte[] AddPictureShape3dSceneCameraRotationLatitude(byte[] source, string latitude)
    {
