...
{
    [Fact]
    public void PpjSourceBoundCustomGeometryPathQuadraticControlYEditsAndReprojects()
    {
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            {
                SourceUri = "deck.assets/source/custom-geometry-path-quadratic-control-y.pptx",
            },
        });
        ...
        var quadraticLeaves = projectedShape["nativeRef"]!["leaves"]!.AsArray()
            ...
            .Where(leaf => leaf["kind"]!.GetValue<string>() == "customGeometryPathQuadraticControlY")
            .ToArray();
        ...
        Assert.Contains("x=\"300\" y=\"250\"", editedXml, StringComparison.Ordinal);
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/custom-geometry-path-quadratic-control-y.pptx",
            },
        });
