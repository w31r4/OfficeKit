...
export async function createProtectedInputWorkbook(outputPath) {
  ...
  // OfficeKit retains the native sheet and style graph around this edit.
  ...
  return {
    ...
    preview,
    audit: {
      schema: "office-kit.spreadsheet-worksheet-protection-workflow.v1",
...
if (entry === import.meta.url) {
  const outputPath = path.resolve(process.argv[2] || "officekit-worksheet-protection-workflow.xlsx");
