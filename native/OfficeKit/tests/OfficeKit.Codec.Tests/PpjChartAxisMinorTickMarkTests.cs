...
{
    [Fact]
    public void PpjChartAxisMinorTickMarksAuthorAndEditSourceChart()
    {
        ...
        {
            ["xMinorTickMark"] = new JsonObject { ["kind"] = "string", ["value"] = "out" },
            ["yMinorTickMark"] = new JsonObject { ["kind"] = "string", ["value"] = "in" },
        };
        ...
        {
            ["minorTickMark"] = new JsonObject { ["token"] = "xMinorTickMark" },
        };
        chart["yAxis"] = new JsonObject
        {
            ["minorTickMark"] = new JsonObject { ["token"] = "yMinorTickMark" },
        };
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest { SourceUri = "minor-tick-mark/source.pptx" },
        });
        ...
        var projectedChart = projectedProgram["pages"]!.AsArray()
            ...
            .Select(item => item!.AsObject())
            .Single(item => item["type"]!.GetValue<string>() == "chart");
        Assert.Equal("out", projectedChart["xAxis"]!["minorTickMark"]!.GetValue<string>());
        Assert.Equal("in", projectedChart["yAxis"]!["minorTickMark"]!.GetValue<string>());

        projectedProgram["design"]!["grammar"]!["tokens"] = new JsonObject
        {
            ["xMinorTickMarkEdited"] = new JsonObject { ["kind"] = "string", ["value"] = "none" },
            ["yMinorTickMarkEdited"] = new JsonObject { ["kind"] = "string", ["value"] = "cross" },
        };
        projectedChart["xAxis"]!["minorTickMark"] = new JsonObject { ["token"] = "xMinorTickMarkEdited" };
        projectedChart["yAxis"]!["minorTickMark"] = new JsonObject { ["token"] = "yMinorTickMarkEdited" };
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            Family = ArtifactFamily.Presentation,
            File = edited.File,
            PresentationProgram = new PresentationProgramRequest { SourceUri = "minor-tick-mark/edited.pptx" },
        });
        ...
        var reprojectedChart = reprojectedProgram["pages"]!.AsArray()
            ...
            .Select(item => item!.AsObject())
            .Single(item => item["type"]!.GetValue<string>() == "chart");
        Assert.Equal("none", reprojectedChart["xAxis"]!["minorTickMark"]!.GetValue<string>());
        Assert.Equal("cross", reprojectedChart["yAxis"]!["minorTickMark"]!.GetValue<string>());
    }
}
