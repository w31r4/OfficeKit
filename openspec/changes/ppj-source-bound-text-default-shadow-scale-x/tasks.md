...
- [x] 1.1 Add `textDefaultShadowScaleX` to the PPJ schema, native leaf registry,
      capability reference, and generated manual; verify JSON contract checks.
- [x] 1.2 Project the existing paragraph default outer-shadow `sx` as a
...
- [x] 2.1 Extend edit-plan validation and expected-value proof for the signed
      ...
      closed.
- [x] 2.2 Splice only `a:outerShdw/@sx` in the owning SlidePart; verify sibling
