...
if (presentationNativeLeafHelp) {
  ...
  presentationNativeLeafHelp.summary += " Imported ordinary shapes with one canonical direct `a:effectLst/a:outerShdw` expose bounded `shadowBlurRadiusEmu`, `shadowDistanceEmu`, `shadowDirectionDegrees`, and `shadowAlignment` leaves; each edit splices only its proven geometry token and preserves shadow color, alpha, and effect topology. Irregular or inherited shadows remain source-owned and fail closed.";
}
if (presentationInspectLeavesHelp) {
  ...
  presentationInspectLeavesHelp.summary += " Canonical imported outer shadows expose revision-bound `shadowBlurRadiusEmu`, `shadowDistanceEmu`, `shadowDirectionDegrees`, and `shadowAlignment` leaves when one direct effect list and one direct outer shadow are proven; irregular graphs remain opaque.";
}
...
if (presentationNativeLeafReceipt) {
  ...
  presentationNativeLeafReceipt.description += " A `shadowBlurRadiusEmu`, `shadowDistanceEmu`, `shadowDirectionDegrees`, or `shadowAlignment` leaf changes only its proven direct `a:outerShdw` geometry attribute, preserving shadow color, alpha, effect topology, and unrelated parts; irregular or inherited shadows remain source-owned.";
}
