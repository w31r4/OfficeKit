...
{
    [Fact]
    public void PpjSourceBoundPictureShape3dBevelTopPresetLeafEditsAndReprojects()
    {
        ...
        var source = AddPictureShape3dBevelTopPreset(RemoveEmbeddedPpj(authored.File.ToByteArray()));
        var projected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/source/picture-shape-3d-bevel-top-preset.pptx",
            },
        });
        ...
        var target = Assert.Single(projectedImage["nativeRef"]!["leaves"]!.AsArray()
            ...
            .Where(leaf => leaf["kind"]!.GetValue<string>() == "shape3dBevelTopPreset"));
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/picture-shape-3d-bevel-top-preset.pptx",
            },
        });
        ...
        Assert.Equal("softRound", reprojectedImage["nativeRef"]!["leaves"]!.AsArray()
            .Select(leaf => leaf!.AsObject())
            .Single(leaf => leaf["kind"]!.GetValue<string>() == "shape3dBevelTopPreset")["value"]!.GetValue<string>());
    }

    private static byte[] AddPictureShape3dBevelTopPreset(byte[] source)
    {
