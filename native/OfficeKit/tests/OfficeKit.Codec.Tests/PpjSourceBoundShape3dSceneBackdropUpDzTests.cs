...
{
    [Fact]
    public void PpjSourceBoundShape3dSceneBackdropUpDzLeafEditsAndReprojects()
    {
        var authored = Invoke(ExportRequest());
        Assert.True(authored.Ok, Diagnostics(authored));
        var source = AddShape3dSceneBackdropUpDz(RemoveEmbeddedPpj(authored.File.ToByteArray()), "0");
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            {
                SourceUri = "deck.assets/source/shape-3d-scene-backdrop-up-dz.pptx",
            },
        });
        ...
        var target = Assert.Single(projectedShape["nativeRef"]!["leaves"]!.AsArray()
            ...
            .Where(leaf => leaf["kind"]!.GetValue<string>() == "shape3dSceneBackdropUpDzEmu"));
        ...
        Assert.Contains("<a:up dx=\"0\" dy=\"1\" dz=\"500\"", editedXml, StringComparison.Ordinal);
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/shape-3d-scene-backdrop-up-dz.pptx",
            },
        });
    ...
    private static byte[] AddShape3dSceneBackdropUpDz(byte[] source, string upDz)
    {
        ...
        using (var package = PresentationDocument.Open(stream, true))
        {
            ...
            up.SetAttribute(new OpenXmlAttribute("dz", string.Empty, upDz));
