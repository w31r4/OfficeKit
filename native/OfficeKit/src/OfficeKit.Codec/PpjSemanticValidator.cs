...
internal static class PpjSemanticValidator
{
    ...
    private static readonly IReadOnlyDictionary<string, IReadOnlySet<string>> CapabilityFields =
        new Dictionary<string, IReadOnlySet<string>>(StringComparer.Ordinal)
        {
            ...
            ["setTextField"] = Set("text.paragraphs[].runs[].field.type", "text.paragraphs[].runs[].field.id", "table.rows[].cells[].text.paragraphs[].runs[].field.type", "table.rows[].cells[].text.paragraphs[].runs[].field.id"),
            ["setTextParagraphStyle"] = Set("textStyles", "text.paragraphs[].style.alignment", "text.paragraphs[].style.level", "text.paragraphs[].style.defaultTabSize", "text.paragraphs[].style.eastAsianLineBreak", "text.paragraphs[].style.latinLineBreak", "text.paragraphs[].style.hangingPunctuation", "text.paragraphs[].style.fontAlignment", "text.paragraphs[].style.direction", "text.paragraphs[].style.bullet.startAt", "text.paragraphs[].style.bullet.character", "text.paragraphs[].style.bullet.fontFamily", "text.paragraphs[].style.bullet.fontFollowText", "text.paragraphs[].style.bullet.color", "text.paragraphs[].style.bullet.colorFollowText", "text.paragraphs[].style.bullet.size", "text.paragraphs[].style.bullet.sizePercent", "text.paragraphs[].style.bullet.sizeFollowText", "text.paragraphs[].style.bullet.scheme", "text.paragraphs[].style.bullet.format", "text.paragraphs[].style.tabStops", "text.paragraphs[].style.noTabStops", "text.paragraphs[].style.spaceBefore", "text.paragraphs[].style.spaceBeforeMultiplier", "text.paragraphs[].style.spaceAfter", "text.paragraphs[].style.spaceAfterMultiplier", "text.paragraphs[].style.lineSpacing", "text.paragraphs[].style.lineSpacingMultiplier", "text.paragraphs[].style.indent", "text.paragraphs[].style.rightIndent", "text.paragraphs[].style.hanging", "text.paragraphs[].style.defaultText.bold", "text.paragraphs[].style.defaultText.italic", "text.paragraphs[].style.defaultText.size", "text.paragraphs[].style.defaultText.fontFamily", "text.paragraphs[].style.defaultText.fontFamilyEastAsia", "text.paragraphs[].style.defaultText.fontFamilyComplexScript", "text.paragraphs[].style.defaultText.language", "text.paragraphs[].style.defaultText.kerning", "text.paragraphs[].style.defaultText.letterSpacing", "text.paragraphs[].style.defaultText.baseline", "text.paragraphs[].style.defaultText.capitalization", "text.paragraphs[].style.defaultText.strike", "text.paragraphs[].style.defaultText.underline", "text.paragraphs[].style.defaultText.highlight", "text.paragraphs[].style.defaultText.color", "text.paragraphs[].style.defaultText.gradient", "text.paragraphs[].style.defaultText.glow", "text.paragraphs[].style.defaultText.innerShadow", "text.paragraphs[].style.defaultText.reflection", "text.paragraphs[].style.defaultText.shadow", "text.paragraphs[].style.defaultText.softEdge"),
            ["setFill"] = Set("fill"),
            ...
            ["setConnectorType"] = Set("connectorType", "bendAdjustment"),
            ...
            ["setThemeAccent1AlphaMod"] = Set("accentTransforms.accent1.alphaMod"),
            ["setThemeAccent1AlphaOff"] = Set("accentTransforms.accent1.alphaOff"),
            ["setThemeAccent1SatMod"] = Set("accentTransforms.accent1.satMod"),
            ["setThemeAccent1SatOff"] = Set("accentTransforms.accent1.satOff"),
            ["setThemeAccent1RedMod"] = Set("accentTransforms.accent1.redMod"),
            ["setThemeAccent1RedOff"] = Set("accentTransforms.accent1.redOff"),
            ["setThemeAccent1GreenMod"] = Set("accentTransforms.accent1.greenMod"),
            ["setThemeAccent1GreenOff"] = Set("accentTransforms.accent1.greenOff"),
            ["setThemeAccent1BlueMod"] = Set("accentTransforms.accent1.blueMod"),
            ["setThemeAccent1BlueOff"] = Set("accentTransforms.accent1.blueOff"),
            ["setThemeAccent1HueMod"] = Set("accentTransforms.accent1.hueMod"),
            ["setThemeAccent1HueOff"] = Set("accentTransforms.accent1.hueOff"),
            ["setThemeAccent1Gray"] = Set("accentTransforms.accent1.gray"),
            ["setThemeAccent2Tint"] = Set("accentTransforms.accent2.tint"),
            ["setThemeAccent2Shade"] = Set("accentTransforms.accent2.shade"),
            ["setThemeAccent2LumMod"] = Set("accentTransforms.accent2.lumMod"),
            ["setThemeAccent2LumOff"] = Set("accentTransforms.accent2.lumOff"),
            ["setThemeAccent2AlphaMod"] = Set("accentTransforms.accent2.alphaMod"),
            ["setThemeAccent2AlphaOff"] = Set("accentTransforms.accent2.alphaOff"),
            ["setThemeAccent2SatMod"] = Set("accentTransforms.accent2.satMod"),
            ["setThemeAccent2SatOff"] = Set("accentTransforms.accent2.satOff"),
            ["setThemeAccent2RedMod"] = Set("accentTransforms.accent2.redMod"),
            ["setThemeAccent2RedOff"] = Set("accentTransforms.accent2.redOff"),
            ["setThemeAccent2GreenMod"] = Set("accentTransforms.accent2.greenMod"),
            ["setThemeAccent2GreenOff"] = Set("accentTransforms.accent2.greenOff"),
            ["setThemeAccent2BlueMod"] = Set("accentTransforms.accent2.blueMod"),
            ["setThemeAccent2BlueOff"] = Set("accentTransforms.accent2.blueOff"),
            ["setThemeAccent2HueMod"] = Set("accentTransforms.accent2.hueMod"),
            ["setThemeAccent2HueOff"] = Set("accentTransforms.accent2.hueOff"),
            ["setThemeAccent3Tint"] = Set("accentTransforms.accent3.tint"),
            ["setThemeAccent3Shade"] = Set("accentTransforms.accent3.shade"),
            ["setThemeAccent3LumMod"] = Set("accentTransforms.accent3.lumMod"),
            ["setThemeAccent3LumOff"] = Set("accentTransforms.accent3.lumOff"),
            ["setThemeAccent3AlphaMod"] = Set("accentTransforms.accent3.alphaMod"),
            ["setThemeAccent3AlphaOff"] = Set("accentTransforms.accent3.alphaOff"),
            ["setThemeAccent3SatMod"] = Set("accentTransforms.accent3.satMod"),
            ["setThemeAccent3SatOff"] = Set("accentTransforms.accent3.satOff"),
            ["setThemeAccent3RedMod"] = Set("accentTransforms.accent3.redMod"),
            ["setThemeAccent3RedOff"] = Set("accentTransforms.accent3.redOff"),
            ["setThemeAccent3GreenMod"] = Set("accentTransforms.accent3.greenMod"),
            ["setThemeAccent3GreenOff"] = Set("accentTransforms.accent3.greenOff"),
            ["setThemeAccent3BlueMod"] = Set("accentTransforms.accent3.blueMod"),
            ["setThemeAccent3BlueOff"] = Set("accentTransforms.accent3.blueOff"),
            ["setThemeAccent3HueMod"] = Set("accentTransforms.accent3.hueMod"),
            ["setThemeAccent3HueOff"] = Set("accentTransforms.accent3.hueOff"),
            ["setThemeAccent4Tint"] = Set("accentTransforms.accent4.tint"),
            ["setThemeAccent4Shade"] = Set("accentTransforms.accent4.shade"),
            ["setThemeAccent4LumMod"] = Set("accentTransforms.accent4.lumMod"),
            ["setThemeAccent4LumOff"] = Set("accentTransforms.accent4.lumOff"),
            ["setThemeAccent4AlphaMod"] = Set("accentTransforms.accent4.alphaMod"),
            ["setThemeAccent4AlphaOff"] = Set("accentTransforms.accent4.alphaOff"),
            ["setThemeAccent4SatMod"] = Set("accentTransforms.accent4.satMod"),
            ["setThemeAccent4SatOff"] = Set("accentTransforms.accent4.satOff"),
            ["setThemeAccent4RedMod"] = Set("accentTransforms.accent4.redMod"),
            ["setThemeAccent4GreenMod"] = Set("accentTransforms.accent4.greenMod"),
            ["setThemeAccent4BlueOff"] = Set("accentTransforms.accent4.blueOff"),
            ["setThemeAccent4HueMod"] = Set("accentTransforms.accent4.hueMod"),
            ["setThemeAccent4HueOff"] = Set("accentTransforms.accent4.hueOff"),
            ["setThemeAccent4GreenOff"] = Set("accentTransforms.accent4.greenOff"),
            ["setThemeAccent4BlueMod"] = Set("accentTransforms.accent4.blueMod"),
            ...
            ["setThemeAccent6LumMod"] = Set("accentTransforms.accent6.lumMod"),
            ["setThemeAccent6LumOff"] = Set("accentTransforms.accent6.lumOff"),
            ["setThemeAccent6AlphaMod"] = Set("accentTransforms.accent6.alphaMod"),
            ["setThemeAccent6AlphaOff"] = Set("accentTransforms.accent6.alphaOff"),
            ["setThemeAccent6SatMod"] = Set("accentTransforms.accent6.satMod"),
            ["setThemeAccent6SatOff"] = Set("accentTransforms.accent6.satOff"),
            ["setThemeAccent6RedMod"] = Set("accentTransforms.accent6.redMod"),
            ["setThemeAccent6RedOff"] = Set("accentTransforms.accent6.redOff"),
            ["setThemeAccent6GreenMod"] = Set("accentTransforms.accent6.greenMod"),
            ["setThemeAccent6GreenOff"] = Set("accentTransforms.accent6.greenOff"),
            ["setThemeAccent6BlueMod"] = Set("accentTransforms.accent6.blueMod"),
            ["setThemeAccent6BlueOff"] = Set("accentTransforms.accent6.blueOff"),
            ["setThemeAccent6HueMod"] = Set("accentTransforms.accent6.hueMod"),
            ["setThemeAccent6HueOff"] = Set("accentTransforms.accent6.hueOff"),
            ...
            ["setThemeAccent5AlphaMod"] = Set("accentTransforms.accent5.alphaMod"),
            ["setThemeAccent5AlphaOff"] = Set("accentTransforms.accent5.alphaOff"),
            ["setThemeAccent5SatMod"] = Set("accentTransforms.accent5.satMod"),
            ["setThemeAccent5SatOff"] = Set("accentTransforms.accent5.satOff"),
            ["setThemeAccent5RedMod"] = Set("accentTransforms.accent5.redMod"),
            ["setThemeAccent5GreenMod"] = Set("accentTransforms.accent5.greenMod"),
            ["setThemeAccent5GreenOff"] = Set("accentTransforms.accent5.greenOff"),
            ["setThemeAccent5BlueMod"] = Set("accentTransforms.accent5.blueMod"),
            ["setThemeAccent5BlueOff"] = Set("accentTransforms.accent5.blueOff"),
            ["setThemeAccent5HueMod"] = Set("accentTransforms.accent5.hueMod"),
            ["setThemeAccent5HueOff"] = Set("accentTransforms.accent5.hueOff"),
            ["setThemeAccent5RedOff"] = Set("accentTransforms.accent5.redOff"),
        ...
        List<PpjDiagnostic> diagnostics)
    {
        ...
        if (design.TryGetProperty("theme", out theme) &&
            ...
            !HasCapability(theme, "setThemeMinorFontComplexScript", "fontScheme.minorComplexScript"))
        {
            diagnostics.Add(new(
        ...
        if (design.TryGetProperty("theme", out theme) &&
            ...
            !HasCapability(theme, "setThemeAccent6Color", "accentColors.accent6"))
        {
            diagnostics.Add(new(
        ...
        if (design.TryGetProperty("theme", out theme) &&
            ...
            !HasCapability(theme, "setThemeAccent1AlphaMod", "accentTransforms.accent1.alphaMod") &&
            !HasCapability(theme, "setThemeAccent1AlphaOff", "accentTransforms.accent1.alphaOff") &&
            !HasCapability(theme, "setThemeAccent1SatMod", "accentTransforms.accent1.satMod") &&
            !HasCapability(theme, "setThemeAccent1SatOff", "accentTransforms.accent1.satOff") &&
            !HasCapability(theme, "setThemeAccent1RedMod", "accentTransforms.accent1.redMod") &&
            !HasCapability(theme, "setThemeAccent1RedOff", "accentTransforms.accent1.redOff") &&
            !HasCapability(theme, "setThemeAccent1GreenMod", "accentTransforms.accent1.greenMod") &&
            !HasCapability(theme, "setThemeAccent1GreenOff", "accentTransforms.accent1.greenOff") &&
            !HasCapability(theme, "setThemeAccent1BlueMod", "accentTransforms.accent1.blueMod") &&
            !HasCapability(theme, "setThemeAccent1BlueOff", "accentTransforms.accent1.blueOff") &&
            !HasCapability(theme, "setThemeAccent1HueMod", "accentTransforms.accent1.hueMod") &&
            !HasCapability(theme, "setThemeAccent1HueOff", "accentTransforms.accent1.hueOff") &&
            !HasCapability(theme, "setThemeAccent1Gray", "accentTransforms.accent1.gray") &&
            !HasCapability(theme, "setThemeAccent2Tint", "accentTransforms.accent2.tint") &&
            !HasCapability(theme, "setThemeAccent2Shade", "accentTransforms.accent2.shade") &&
            !HasCapability(theme, "setThemeAccent2LumMod", "accentTransforms.accent2.lumMod") &&
            !HasCapability(theme, "setThemeAccent2LumOff", "accentTransforms.accent2.lumOff") &&
            !HasCapability(theme, "setThemeAccent2AlphaMod", "accentTransforms.accent2.alphaMod") &&
            !HasCapability(theme, "setThemeAccent2AlphaOff", "accentTransforms.accent2.alphaOff") &&
            !HasCapability(theme, "setThemeAccent2SatMod", "accentTransforms.accent2.satMod") &&
            !HasCapability(theme, "setThemeAccent2SatOff", "accentTransforms.accent2.satOff") &&
            !HasCapability(theme, "setThemeAccent2RedMod", "accentTransforms.accent2.redMod") &&
            !HasCapability(theme, "setThemeAccent2RedOff", "accentTransforms.accent2.redOff") &&
            !HasCapability(theme, "setThemeAccent2GreenMod", "accentTransforms.accent2.greenMod") &&
            !HasCapability(theme, "setThemeAccent2GreenOff", "accentTransforms.accent2.greenOff") &&
            !HasCapability(theme, "setThemeAccent2BlueMod", "accentTransforms.accent2.blueMod") &&
            !HasCapability(theme, "setThemeAccent2BlueOff", "accentTransforms.accent2.blueOff") &&
            !HasCapability(theme, "setThemeAccent2HueMod", "accentTransforms.accent2.hueMod") &&
            !HasCapability(theme, "setThemeAccent2HueOff", "accentTransforms.accent2.hueOff") &&
            !HasCapability(theme, "setThemeAccent3Tint", "accentTransforms.accent3.tint") &&
            !HasCapability(theme, "setThemeAccent3Shade", "accentTransforms.accent3.shade") &&
            !HasCapability(theme, "setThemeAccent3LumMod", "accentTransforms.accent3.lumMod") &&
            !HasCapability(theme, "setThemeAccent3LumOff", "accentTransforms.accent3.lumOff") &&
            !HasCapability(theme, "setThemeAccent3AlphaMod", "accentTransforms.accent3.alphaMod") &&
            !HasCapability(theme, "setThemeAccent3AlphaOff", "accentTransforms.accent3.alphaOff") &&
            !HasCapability(theme, "setThemeAccent3SatMod", "accentTransforms.accent3.satMod") &&
            !HasCapability(theme, "setThemeAccent3SatOff", "accentTransforms.accent3.satOff") &&
            !HasCapability(theme, "setThemeAccent3RedMod", "accentTransforms.accent3.redMod") &&
            !HasCapability(theme, "setThemeAccent3RedOff", "accentTransforms.accent3.redOff") &&
            !HasCapability(theme, "setThemeAccent3GreenMod", "accentTransforms.accent3.greenMod") &&
            !HasCapability(theme, "setThemeAccent3GreenOff", "accentTransforms.accent3.greenOff") &&
            !HasCapability(theme, "setThemeAccent3BlueMod", "accentTransforms.accent3.blueMod") &&
            !HasCapability(theme, "setThemeAccent3BlueOff", "accentTransforms.accent3.blueOff") &&
            !HasCapability(theme, "setThemeAccent3HueMod", "accentTransforms.accent3.hueMod") &&
            !HasCapability(theme, "setThemeAccent3HueOff", "accentTransforms.accent3.hueOff") &&
            !HasCapability(theme, "setThemeAccent4Tint", "accentTransforms.accent4.tint") &&
            !HasCapability(theme, "setThemeAccent4Shade", "accentTransforms.accent4.shade") &&
            !HasCapability(theme, "setThemeAccent4LumMod", "accentTransforms.accent4.lumMod") &&
            !HasCapability(theme, "setThemeAccent4LumOff", "accentTransforms.accent4.lumOff") &&
            !HasCapability(theme, "setThemeAccent4AlphaMod", "accentTransforms.accent4.alphaMod") &&
            !HasCapability(theme, "setThemeAccent4AlphaOff", "accentTransforms.accent4.alphaOff") &&
            !HasCapability(theme, "setThemeAccent4SatMod", "accentTransforms.accent4.satMod") &&
            !HasCapability(theme, "setThemeAccent4SatOff", "accentTransforms.accent4.satOff") &&
            !HasCapability(theme, "setThemeAccent4RedMod", "accentTransforms.accent4.redMod") &&
            !HasCapability(theme, "setThemeAccent4GreenMod", "accentTransforms.accent4.greenMod") &&
            !HasCapability(theme, "setThemeAccent4BlueOff", "accentTransforms.accent4.blueOff") &&
            !HasCapability(theme, "setThemeAccent4HueMod", "accentTransforms.accent4.hueMod") &&
            !HasCapability(theme, "setThemeAccent4HueOff", "accentTransforms.accent4.hueOff") &&
            !HasCapability(theme, "setThemeAccent4GreenOff", "accentTransforms.accent4.greenOff") &&
            !HasCapability(theme, "setThemeAccent4BlueMod", "accentTransforms.accent4.blueMod") &&
            ...
            !HasCapability(theme, "setThemeAccent6LumMod", "accentTransforms.accent6.lumMod") &&
            !HasCapability(theme, "setThemeAccent6LumOff", "accentTransforms.accent6.lumOff") &&
            !HasCapability(theme, "setThemeAccent6AlphaMod", "accentTransforms.accent6.alphaMod") &&
            !HasCapability(theme, "setThemeAccent6AlphaOff", "accentTransforms.accent6.alphaOff") &&
            !HasCapability(theme, "setThemeAccent6SatMod", "accentTransforms.accent6.satMod") &&
            !HasCapability(theme, "setThemeAccent6SatOff", "accentTransforms.accent6.satOff") &&
            !HasCapability(theme, "setThemeAccent6RedMod", "accentTransforms.accent6.redMod") &&
            !HasCapability(theme, "setThemeAccent6RedOff", "accentTransforms.accent6.redOff") &&
            !HasCapability(theme, "setThemeAccent6GreenMod", "accentTransforms.accent6.greenMod") &&
            !HasCapability(theme, "setThemeAccent6GreenOff", "accentTransforms.accent6.greenOff") &&
            !HasCapability(theme, "setThemeAccent6BlueMod", "accentTransforms.accent6.blueMod") &&
            !HasCapability(theme, "setThemeAccent6BlueOff", "accentTransforms.accent6.blueOff") &&
            !HasCapability(theme, "setThemeAccent6HueMod", "accentTransforms.accent6.hueMod") &&
            !HasCapability(theme, "setThemeAccent6HueOff", "accentTransforms.accent6.hueOff") &&
            ...
            !HasCapability(theme, "setThemeAccent5AlphaMod", "accentTransforms.accent5.alphaMod") &&
            !HasCapability(theme, "setThemeAccent5AlphaOff", "accentTransforms.accent5.alphaOff") &&
            !HasCapability(theme, "setThemeAccent5SatMod", "accentTransforms.accent5.satMod") &&
            !HasCapability(theme, "setThemeAccent5SatOff", "accentTransforms.accent5.satOff") &&
            !HasCapability(theme, "setThemeAccent5RedMod", "accentTransforms.accent5.redMod") &&
            !HasCapability(theme, "setThemeAccent5RedOff", "accentTransforms.accent5.redOff") &&
            !HasCapability(theme, "setThemeAccent5GreenMod", "accentTransforms.accent5.greenMod") &&
            !HasCapability(theme, "setThemeAccent5GreenOff", "accentTransforms.accent5.greenOff") &&
            !HasCapability(theme, "setThemeAccent5BlueMod", "accentTransforms.accent5.blueMod") &&
            !HasCapability(theme, "setThemeAccent5BlueOff", "accentTransforms.accent5.blueOff") &&
            !HasCapability(theme, "setThemeAccent5HueMod", "accentTransforms.accent5.hueMod") &&
            !HasCapability(theme, "setThemeAccent5HueOff", "accentTransforms.accent5.hueOff"))
        {
            diagnostics.Add(new(
    ...
    private static void ValidateChart(PpjChartElementModel chart, string path, List<PpjDiagnostic> diagnostics)
    {
        ...
        if (chart.Raw.TryGetProperty("style", out style) &&
            ...
            chart.ChartType is not ("bar" or "column" or "line" or "area" or "scatter" or "combo"))
            diagnostics.Add(new(
                "ppj.chart.varyColorsType",
                "style.varyColors applies only to line, bar, column, area, scatter, and categorical combo charts.",
