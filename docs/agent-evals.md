...
The connected-SmartArt refusal has one explicit audit contract: it records the
source hash, no output, `officeKit.actualProvider`/`actualVersion` and
