...
| `document.addParagraph` | api | Append a styled paragraph with optional run spans and bounded direct paragraph formatting, including presence-aware contextual spacing and line-number suppression. |
...
Append a styled paragraph with optional run spans and bounded direct paragraph formatting, including presence-aware contextual spacing and line-number suppression.
