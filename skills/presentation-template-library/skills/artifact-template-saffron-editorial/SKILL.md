...
Use this style when the brief matches **trend magazine; promotion presentation**. It is designed for
public audiences, communities, brand teams. Its visual premise is Long-form argument and bold photography alternate around one saffron signal. The style is a
...
**big idea → audience truth → creative system → waves or experiences → measured outcome → next move**. This style is not a good fit for **technical protocol**;
...
- Use **#E9E6DF** as the main field, **#111111** for primary type, **#E4B91E** for the decisive signal, **#D64055** for secondary evidence, and **#77726B** for rules or context.
...
- The recurring structure is **margin, variable page silhouettes, documentary imagery**. Vary the silhouette between
  cover, evidence, data, process, comparison, and decision pages rather than
  repeating a component grid.
- Use generous editorial margins and one strong edge signal. Let the margin create pacing while the body carries the actual campaign evidence.
...
The expected density is **dense**: spaciousness must create emphasis, not hide missing content. Alternate page
...
- **Page skeleton.** Treat the deck as a magazine: a warm gray/black text field, a single saffron signal, and alternating long-form argument pages with full-bleed documentary features. Use margin rules to hold the reading path.
- **Type rhythm.** Use a confident display face for editorial titles and a plain reading face for body and evidence. Saffron should mark a phrase, chapter, or figure, not color the whole page.
- **Evidence carriers.** Use argument spreads, annotated bars, timelines, quote pulls, and a few data pages. Keep a chart or table secondary to the editorial claim it proves.
- **Images and layers.** Premium real photography is welcome for a feature or chapter. Check rights, crop, and contrast; never overlay long text on complex detail without a darkened field.
- **Pacing.** Let a dense paragraph page earn a spacious feature page, then return to a measured result or action. Avoid repeating one photo/text split throughout the deck.
- **Selection rule.** Choose this style for editorial campaigns, cultural reports, and brand narratives that need a premium magazine cadence.

## Signature moves and variation limits

- Let **margin** recur as a quiet identity cue on selected pages; it must
