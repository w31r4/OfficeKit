...
{
    [Fact]
    public void PpjSourceBoundPictureShape3dSceneBackdropUpDyLeafEditsAndReprojects()
    {
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest { SourceUri = "deck.assets/source/picture-backdrop-up-dy.pptx" },
        });
        ...
        Assert.Equal(5, target["value"]!.GetValue<long>());
        target["value"] = 6;
        ...
        Assert.Contains("<a:up dx=\"4\" dy=\"6\" dz=\"6\"", xml, StringComparison.Ordinal);
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest { SourceUri = "deck.assets/edited/picture-backdrop-up-dy.pptx" },
        });
        ...
        var reprojectedTarget = Assert.Single(reprojectedImage["nativeRef"]!["leaves"]!.AsArray().Select(leaf => leaf!.AsObject())
            .Where(leaf => leaf["kind"]!.GetValue<string>() == "shape3dSceneBackdropUpDyEmu"));
        Assert.Equal(6, reprojectedTarget["value"]!.GetValue<long>());
    }
}
