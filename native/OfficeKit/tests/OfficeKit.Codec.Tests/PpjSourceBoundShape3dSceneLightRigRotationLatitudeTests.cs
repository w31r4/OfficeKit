...
{
    [Fact]
    public void PpjSourceBoundShape3dSceneLightRigRotationLatitudeLeafEditsAndReprojects()
    {
        var authored = Invoke(ExportRequest());
        Assert.True(authored.Ok, Diagnostics(authored));
        var source = AddShape3dSceneLightRigRotationLatitude(RemoveEmbeddedPpj(authored.File.ToByteArray()), "0");
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            {
                SourceUri = "deck.assets/source/shape-3d-scene-light-rig-rotation-latitude.pptx",
            },
        });
        ...
        Assert.Contains("<a:rot lat=\"1800000\" lon=\"0\" rev=\"6000000\"", editedXml, StringComparison.Ordinal);
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/shape-3d-scene-light-rig-rotation-latitude.pptx",
            },
        });
    ...
    private static byte[] AddShape3dSceneLightRigRotationLatitude(byte[] source, string latitude)
    {
