...
{
    [Fact]
    public void PpjSourceBoundThemeColorRoleHyperlinkRgbaEditsOnlyHyperlinkAndReprojects()
    {
        ...
        authoredTheme.HyperlinkRgb = "50515240";
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            {
                SourceUri = "deck.assets/source/theme-color-role-hyperlink.pptx",
            },
        });
        ...
        Assert.Equal("#50515240", projectedColorRoles["hyperlink"]!.GetValue<string>());
        ...
        editedProgram["design"]!["theme"]!["colorRoles"]!["hyperlink"] = "#ABCDEF40";
        ...
        using (var package = PresentationDocument.Open(stream, false))
        {
            ...
            Assert.Equal("ABCDEF", scheme.Hyperlink!.RgbColorModelHex!.Val!.Value);
            Assert.Equal(25098, scheme.Hyperlink.RgbColorModelHex.GetFirstChild<A.Alpha>()!.Val!.Value);
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/theme-color-role-hyperlink.pptx",
            },
        });
        Assert.True(reprojected.Ok, Diagnostics(reprojected));
        var reprojectedProgram = JsonNode.Parse(reprojected.PresentationProgram.ProgramJson.ToByteArray())!.AsObject();
        Assert.Equal("#ABCDEF40", reprojectedProgram["design"]!["theme"]!["colorRoles"]!["hyperlink"]!.GetValue<string>());

        var alphaPresenceProgram = JsonNode.Parse(projectedProgram.ToJsonString())!.AsObject();
        alphaPresenceProgram["design"]!["theme"]!["colorRoles"]!["hyperlink"] = "#ABCDEF";
        ...
        unauthorizedProgram["design"]!["theme"]!["colorRoles"]!.AsObject().Remove("hyperlink");
        ...
        unownedProgram["design"]!["theme"]!["colorRoles"]!["followedHyperlink"] = "#202122";
        ...
        tamperedProgram["design"]!["theme"]!["nativeRef"]!["capabilities"]!.AsArray()
            .Single(capability => capability!["operation"]!.GetValue<string>() == "setThemeColorRoleHyperlink")!["fields"] = new JsonArray("colorRoles.followedHyperlink");
