...
export const HELP_CATALOG = [
  ...
  { artifactKind: "presentation", kind: "api", name: "slide.shapes.add", summary: "Add a shape/textbox with preset or bounded DrawingML custom geometry using ordered adjustment/guide formulas, or create a direct connector only with explicit from/to target and connection-site indexes." },
...
const PRESENTATION_HELP_SCHEMAS = {
  ...
  "slide.shapes.add": helpSchema({
    ...
    geometry: { type: "string", description: "rect, ellipse, roundRect, textbox, custom, or connector. Custom requires customPaths; connector requires from, to, fromIdx, and toIdx." },
