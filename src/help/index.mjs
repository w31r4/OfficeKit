...
export const HELP_CATALOG = [
  ...
  { artifactKind: "document", kind: "api", name: "DocumentModel.create", summary: "Create a document with paragraph/character styles, formatted paragraphs/runs including bounded solid paragraph borders, canonical inline and one-paragraph table-cell plain-text, checkbox, drop-down, combo-box, and ISO/Gregorian date content controls, one-paragraph block plain-text controls, canonical inline SEQ/REF/PAGEREF fields, sections, headers/footers, canonical VML text watermarks, lists, TableGrid fixed-geometry tables, links, bounded whole-block bookmarks, 1-through-16-paragraph plain-text footnotes/endnotes, canonical bibliography-backed citations plus one source-free switch-free BIBLIOGRAPHY output placeholder, simple fields, a canonical complex TOC placeholder, bounded whole-paragraph tracked insertions/deletions, classic comments, bounded modern root/direct-reply threads, and PNG/JPEG images. Nested/irregular modern threads, rich comment bodies, multi-paragraph/rich/inline-within-cell/nested/data-bound/locked/placeholder table-cell SDTs, other nested/data-bound/locked/placeholder SDTs, irregular lists, localized dates, custom checkbox symbols, image/DrawingML/irregular VML watermarks, other complex field graphs, arbitrary table-style graphs, complex bookmark/note/revision graphs, and advanced settings remain unsupported or source-bound." },
  { artifactKind: "document", kind: "api", name: "document.addParagraph", summary: "Append a styled paragraph with optional run spans and bounded direct paragraph formatting, including solid paragraph borders, presence-aware contextual spacing, and line-number suppression." },
  ...
  { artifactKind: "document", kind: "api", name: "document.addTable", summary: "Append a Word-style table with physical cell values, optional logical merge geometry, fixed-layout width/margin/border styling, an optional native repeating-header prefix, and individual rows kept together across pages." },
