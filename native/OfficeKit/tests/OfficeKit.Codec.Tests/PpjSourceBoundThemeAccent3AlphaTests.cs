...
{
    [Fact]
    public void PpjSourceBoundThemeAccent3RgbaEditsOnlyAccent3AndReprojects()
    {
        var authoredRequest = ExportRequest();
        var authoredTheme = new PresentationThemeArtifact();
        authoredTheme.AccentRgb.Add(new[] { "112233", "223344", "33445580", "445566", "556677", "667788" });
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            {
                SourceUri = "deck.assets/source/theme-accent3.pptx",
            },
        });
        ...
        Assert.Equal("#33445580", projectedColors["accent3"]!.GetValue<string>());
        ...
        Assert.Contains(nativeRef["capabilities"]!.AsArray(), capability =>
            capability!["operation"]!.GetValue<string>() == "setThemeAccent3Color" &&
            capability["fields"]!.AsArray().Any(field => field!.GetValue<string>() == "accentColors.accent3"));
        ...
        editedProgram["design"]!["theme"]!["accentColors"]!["accent3"] = "#ABCDEF40";
        ...
        using (var package = PresentationDocument.Open(stream, false))
        {
            ...
            Assert.Equal("ABCDEF", scheme.Accent3Color!.RgbColorModelHex!.Val!.Value);
            Assert.Equal(25098, scheme.Accent3Color.RgbColorModelHex.GetFirstChild<A.Alpha>()!.Val!.Value);
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/theme-accent3.pptx",
            },
        });
        Assert.True(reprojected.Ok, Diagnostics(reprojected));
        var reprojectedProgram = JsonNode.Parse(reprojected.PresentationProgram.ProgramJson.ToByteArray())!.AsObject();
        Assert.Equal("#ABCDEF40", reprojectedProgram["design"]!["theme"]!["accentColors"]!["accent3"]!.GetValue<string>());

        var alphaPresenceProgram = JsonNode.Parse(projectedProgram.ToJsonString())!.AsObject();
        alphaPresenceProgram["design"]!["theme"]!["accentColors"]!["accent3"] = "#ABCDEF";
        ...
        tamperedProgram["design"]!["theme"]!["nativeRef"]!["capabilities"]!.AsArray()
            .Single(capability => capability!["operation"]!.GetValue<string>() == "setThemeAccent3Color")!["fields"] = new JsonArray("accentColors.accent1");
