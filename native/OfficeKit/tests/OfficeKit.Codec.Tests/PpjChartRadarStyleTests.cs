...
{
    [Fact]
    public void PpjRadarStyleAuthorProjectAndEditOnlyChartPart()
    {
        ...
        {
            ["categories"] = new JsonArray("A", "B", "C", "D"),
            ["series"] = new JsonArray(new JsonObject
            {
                ["id"] = "radar-series",
                ["name"] = "Reach",
                ["values"] = new JsonArray(10, 20, 15, 25),
            }),
        };
        ...
        Assert.Equal("filled", authoredChart.Descendants(chartNs + "radarStyle").Single().Attribute("val")!.Value);
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest { SourceUri = "radar-style/source.pptx" },
        });
        ...
        Assert.Equal("filled", projectedChart["style"]!["radarStyle"]!.GetValue<string>());
        ...
        projectedChart["style"]!["radarStyle"] = "marker";
        ...
        Assert.Equal("marker", editedChart.Descendants(chartNs + "radarStyle").Single().Attribute("val")!.Value);
        var reprojected = Invoke(new CodecRequest
        {
            ...
            Family = ArtifactFamily.Presentation,
            File = edited.File,
            PresentationProgram = new PresentationProgramRequest { SourceUri = "radar-style/edited.pptx" },
        });
        ...
        var outputChart = output["pages"]!.AsArray()
            ...
            .Select(item => item!.AsObject())
            .Single(item => item["type"]!.GetValue<string>() == "chart");
        Assert.Equal("marker", outputChart["style"]!["radarStyle"]!.GetValue<string>());
    }
}
