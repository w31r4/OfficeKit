...
export const HELP_CATALOG = [
  ...
  { artifactKind: "presentation", kind: "api", name: "slide.shapes.add", summary: "Add a shape/textbox with preset or bounded literal custom geometry, position, optional center-based rotation/flips, fill, line, text, DrawingML text-body layout, and optional non-visible p:cNvPr alternative text." },
  { artifactKind: "presentation", kind: "api", name: "shape.setAccessibilityMetadata", summary: "Set or clear an ordinary shape's non-visible PowerPoint alternative-text title/description through p:nvSpPr/p:cNvPr. It never changes visible text, layout, drawing order, or relationships; irregular imported non-visual properties fail closed." },
...
const PRESENTATION_HELP_SCHEMAS = {
  ...
  "slide.shapes.add": helpSchema({
    ...
    accessibility: { type: "object", description: "Optional non-visible PowerPoint shape alternative text: { title?: string, description?: string }. Each present value is 1 through 1024 XML-safe characters and maps to p:nvSpPr/p:cNvPr/@title or @descr. It does not change visible shape text or layout." },
  ...
  "shape.setAccessibilityMetadata": helpSchema({
    title: { type: "string | null", description: "Non-visible shape alternative-text title. A 1 through 1024 character XML-safe string writes p:cNvPr/@title; null clears it." },
    description: { type: "string | null", description: "Non-visible shape alternative-text description. A 1 through 1024 character XML-safe string writes p:cNvPr/@descr; null clears it." },
