...
export async function createDataValidationWorkbook(outputPath) {
  ...
  return {
    ...
    preview,
    audit: {
      schema: "office-kit.spreadsheet-data-validation-workflow.v1",
      provider: { requested: "office-kit", actual: "office-kit", fallbackUsed: false },
      validation: {
...
if (entry === import.meta.url) {
  const outputPath = path.resolve(process.argv[2] || "officekit-data-validation-workflow.xlsx");
