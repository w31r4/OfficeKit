...
{
    [Fact]
    public void PpjSourceBoundShape3dSceneLightRigRotationRevolutionLeafEditsAndReprojects()
    {
        var authored = Invoke(ExportRequest());
        Assert.True(authored.Ok, Diagnostics(authored));
        var source = AddShape3dSceneLightRigRotationRevolution(RemoveEmbeddedPpj(authored.File.ToByteArray()), "0");
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            {
                SourceUri = "deck.assets/source/shape-3d-scene-light-rig-rotation-revolution.pptx",
            },
        });
        ...
        Assert.Contains("<a:rot lat=\"0\" lon=\"0\" rev=\"1800000\"", editedXml, StringComparison.Ordinal);
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/shape-3d-scene-light-rig-rotation-revolution.pptx",
            },
        });
    ...
    private static byte[] AddShape3dSceneLightRigRotationRevolution(byte[] source, string revolution)
    {
