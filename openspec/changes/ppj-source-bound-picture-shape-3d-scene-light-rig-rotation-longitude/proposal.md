...
The native leaf `shape3dSceneLightRigRotationLongitude60000` already covers
strict imported shapes, but the same complete light-rig rotation on a picture
is still opaque. Its longitude is one bounded token that can be edited while
...
- Project and source-bound-edit only a strict
  `p:pic/p:spPr/a:scene3d/a:lightRig/a:rot/@lon` token.
...
- `ppj-source-bound-picture-shape-3d-scene-light-rig-rotation-longitude`:
  Bounded projection and source-bound editing of a picture light-rig longitude.
