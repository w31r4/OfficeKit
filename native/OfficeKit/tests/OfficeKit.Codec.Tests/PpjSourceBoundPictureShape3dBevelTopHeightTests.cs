...
{
    [Fact]
    public void PpjSourceBoundPictureShape3dBevelTopHeightLeafEditsAndReprojects()
    {
        ...
        var source = AddPictureShape3dBevelTopHeight(RemoveEmbeddedPpj(authored.File.ToByteArray()), 800);
        var projected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/source/picture-shape-3d-bevel-top-height.pptx",
            },
        });
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/picture-shape-3d-bevel-top-height.pptx",
            },
        });
        ...
        Assert.Equal(1_600, reprojectedImage["nativeRef"]!["leaves"]!.AsArray()
            .Select(leaf => leaf!.AsObject())
            .Single(leaf => leaf["kind"]!.GetValue<string>() == "shape3dBevelTopHeightEmu")["value"]!.GetValue<long>());
    }

    private static byte[] AddPictureShape3dBevelTopHeight(byte[] source, long height)
    {
