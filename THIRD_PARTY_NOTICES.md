...
| webfetch-core | Runtime-lazy Openverse and Wikimedia provider adapters plus license normalization for Presentation image discovery; OfficeKit does not use its downloader, cache, federation defaults, CLI, or MCP surface | MIT |
