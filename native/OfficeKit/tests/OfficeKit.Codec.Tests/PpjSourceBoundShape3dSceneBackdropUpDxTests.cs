...
{
    [Fact]
    public void PpjSourceBoundShape3dSceneBackdropUpDxLeafEditsAndReprojects()
    {
        var authored = Invoke(ExportRequest());
        Assert.True(authored.Ok, Diagnostics(authored));
        var source = AddShape3dSceneBackdropUpDx(RemoveEmbeddedPpj(authored.File.ToByteArray()), "0");
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            {
                SourceUri = "deck.assets/source/shape-3d-scene-backdrop-up-dx.pptx",
            },
        });
        ...
        Assert.Contains("<a:up dx=\"500\" dy=\"1\" dz=\"0\"", editedXml, StringComparison.Ordinal);
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/shape-3d-scene-backdrop-up-dx.pptx",
            },
        });
    ...
    private static byte[] AddShape3dSceneBackdropUpDx(byte[] source, string upDx)
    {
        ...
        using (var package = PresentationDocument.Open(stream, true))
        {
            ...
            up.SetAttribute(new OpenXmlAttribute("dx", string.Empty, upDx));
