...
- [x] 1.1 Add section/custom-show nativeRef state and `setPages` vocabulary.
- [x] 1.2 Project capabilities only from editable native source bindings.

## 2. Source-bound lowering

- [x] 2.1 Lower fixed-topology section name and partition edits.
- [x] 2.2 Lower fixed-topology custom-show name and ordered membership edits.
