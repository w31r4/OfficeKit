...
{
    [Fact]
    public void PpjSourceBoundThemeAccent5RgbaEditsOnlyAccent5AndReprojects()
    {
        var authoredRequest = ExportRequest();
        var authoredTheme = new PresentationThemeArtifact();
        authoredTheme.AccentRgb.Add(new[] { "112233", "223344", "334455", "445566", "55667780", "667788" });
        ...
        Assert.Equal("#334455", projectedColors["accent3"]!.GetValue<string>());
        Assert.Equal("#445566", projectedColors["accent4"]!.GetValue<string>());
        Assert.Equal("#55667780", projectedColors["accent5"]!.GetValue<string>());
        ...
        editedProgram["design"]!["theme"]!["accentColors"]!["accent5"] = "#ABCDEF40";
        ...
        using (var package = PresentationDocument.Open(stream, false))
        {
            ...
            Assert.Equal(25098, scheme.Accent5Color.RgbColorModelHex.GetFirstChild<A.Alpha>()!.Val!.Value);
        ...
        Assert.Equal("#ABCDEF40", reprojectedProgram["design"]!["theme"]!["accentColors"]!["accent5"]!.GetValue<string>());

        var alphaPresenceProgram = JsonNode.Parse(projectedProgram.ToJsonString())!.AsObject();
        alphaPresenceProgram["design"]!["theme"]!["accentColors"]!["accent5"] = "#ABCDEF";
        ...
        tamperedProgram["design"]!["theme"]!["nativeRef"]!["capabilities"]!.AsArray()
            .Single(capability => capability!["operation"]!.GetValue<string>() == "setThemeAccent5Color")!["fields"] = new JsonArray("accentColors.accent1");
