...
export const HELP_CATALOG = [
  ...
  { artifactKind: "presentation", kind: "api", name: "slide.continuationCapability", summary: "Report the current authoring profile for this slide. Source-free slides use full-authoring. A newly duplicated imported slide is pending-clone and must be exported and reimported before further edits. A reopened imported or source-derived slide uses bounded-overlay: one clean SlidePart mutation class per export may append top-layer textbox, rect, roundRect, ellipse, or embedded rectangular image elements while preserving the existing raw shape tree; export/reimport before combining that overlay with native-leaf or other SlidePart edits." },
...
const PRESENTATION_HELP_SCHEMAS = {
  ...
  "slide.shapes.connect": helpSchema({
    ...
    head: { type: "object", description: "Optional start line end { type: none|triangle|stealth|diamond|oval|arrow, width?: sm|med|lg, length?: sm|med|lg }." },
    tail: { type: "object", description: "Optional end line end using the same bounded type/size union." },
