...
{
    [Fact]
    public void PpjSourceBoundThemeAccent5GreenOffEditsOnlyGreenOffAndReprojects()
    {
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            {
                SourceUri = "deck.assets/source/theme-accent5-greenOff.pptx",
            },
        });
        ...
        Assert.Contains(nativeRef["capabilities"]!.AsArray(), capability =>
            capability!["operation"]!.GetValue<string>() == "setThemeAccent5GreenOff" &&
            capability["fields"]!.AsArray().Any(field => field!.GetValue<string>() == "accentTransforms.accent5.greenOff"));
        ...
        editedProgram["design"]!["theme"]!["accentTransforms"]!["accent5"]!["greenOff"] = 0.4;
        ...
        using (var package = PresentationDocument.Open(stream, false))
        {
            ...
            Assert.Equal(40_000, Assert.Single(accent5.Elements<A.GreenOffset>()).Val!.Value);
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/theme-accent5-greenOff.pptx",
            },
        });
        Assert.True(reprojected.Ok, Diagnostics(reprojected));
        var reprojectedProgram = JsonNode.Parse(reprojected.PresentationProgram.ProgramJson.ToByteArray())!.AsObject();
        Assert.Equal(0.4, reprojectedProgram["design"]!["theme"]!["accentTransforms"]!["accent5"]!["greenOff"]!.GetValue<double>());

        var unauthorizedProgram = JsonNode.Parse(projectedProgram.ToJsonString())!.AsObject();
        unauthorizedProgram["design"]!["theme"]!["accentTransforms"]!["accent5"]!["greenOff"] = 0.8;
        unauthorizedProgram["design"]!["theme"]!["nativeRef"]!["capabilities"]!.AsArray()
            .Single(capability => capability!["operation"]!.GetValue<string>() == "setThemeAccent5GreenOff")!["fields"] = new JsonArray("accentTransforms.accent5.tint");
        ...
        deletionProgram["design"]!["theme"]!["accentTransforms"]!["accent5"]!.AsObject().Remove("greenOff");
        ...
        siblingProgram["design"]!["theme"]!["accentTransforms"]!["accent5"]!["tint"] = 0.1;
        ...
        outOfRangeProgram["design"]!["theme"]!["accentTransforms"]!["accent5"]!["greenOff"] = 1.1;
