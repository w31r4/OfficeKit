...
{
    [Fact]
    public void PpjSourceBoundThemeAccent4ColorEditsOnlyAccent4AndReprojects()
    {
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            {
                SourceUri = "deck.assets/source/theme-accent4.pptx",
            },
        });
        ...
        Assert.Equal("#445566", projectedColors["accent4"]!.GetValue<string>());
        ...
        Assert.Contains(nativeRef["capabilities"]!.AsArray(), capability =>
            capability!["operation"]!.GetValue<string>() == "setThemeAccent4Color" &&
            capability["fields"]!.AsArray().Any(field => field!.GetValue<string>() == "accentColors.accent4"));
        ...
        editedProgram["design"]!["theme"]!["accentColors"]!["accent4"] = "#ABCDEF";
        ...
        using (var package = PresentationDocument.Open(stream, false))
        {
            ...
            Assert.Equal("ABCDEF", scheme.Accent4Color!.RgbColorModelHex!.Val!.Value);
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/theme-accent4.pptx",
            },
        });
        Assert.True(reprojected.Ok, Diagnostics(reprojected));
        var reprojectedProgram = JsonNode.Parse(reprojected.PresentationProgram.ProgramJson.ToByteArray())!.AsObject();
        Assert.Equal("#ABCDEF", reprojectedProgram["design"]!["theme"]!["accentColors"]!["accent4"]!.GetValue<string>());
        ...
        tamperedProgram["design"]!["theme"]!["nativeRef"]!["capabilities"]!.AsArray()
            .Single(capability => capability!["operation"]!.GetValue<string>() == "setThemeAccent4Color")!["fields"] = new JsonArray("accentColors.accent2");
