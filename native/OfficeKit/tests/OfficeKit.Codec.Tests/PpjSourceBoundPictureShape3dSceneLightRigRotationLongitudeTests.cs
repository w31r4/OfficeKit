...
{
    [Fact]
    public void PpjSourceBoundPictureShape3dSceneLightRigRotationLongitudeLeafEditsAndReprojects()
    {
        ...
        var source = AddPictureShape3dSceneLightRigRotationLongitude(RemoveEmbeddedPpj(authored.File.ToByteArray()), "0");
        var projected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/source/picture-shape-3d-scene-light-rig-rotation-longitude.pptx",
            },
        });
        ...
        var target = Assert.Single(projectedImage["nativeRef"]!["leaves"]!.AsArray()
            ...
            .Where(leaf => leaf["kind"]!.GetValue<string>() == "shape3dSceneLightRigRotationLongitude60000"));
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/picture-shape-3d-scene-light-rig-rotation-longitude.pptx",
            },
        });
    ...
    private static byte[] AddPictureShape3dSceneLightRigRotationLongitude(byte[] source, string longitude)
    {
