...
{
    [Fact]
    public void PpjSourceBoundThemeAccent4HueOffEditsOnlyHueOffAndReprojects()
    {
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            {
                SourceUri = "deck.assets/source/theme-accent4-hueOff.pptx",
            },
        });
        ...
        Assert.Contains(nativeRef["capabilities"]!.AsArray(), capability =>
            capability!["operation"]!.GetValue<string>() == "setThemeAccent4HueOff" &&
            capability["fields"]!.AsArray().Any(field => field!.GetValue<string>() == "accentTransforms.accent4.hueOff"));
        ...
        editedProgram["design"]!["theme"]!["accentTransforms"]!["accent4"]!["hueOff"] = -120.0;
        ...
        using (var package = PresentationDocument.Open(stream, false))
        {
            ...
            Assert.Equal(-7_200_000, Assert.Single(accent4.Elements<A.HueOffset>()).Val!.Value);
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/theme-accent4-hueOff.pptx",
            },
        });
        Assert.True(reprojected.Ok, Diagnostics(reprojected));
        var reprojectedProgram = JsonNode.Parse(reprojected.PresentationProgram.ProgramJson.ToByteArray())!.AsObject();
        Assert.Equal(-120.0, reprojectedProgram["design"]!["theme"]!["accentTransforms"]!["accent4"]!["hueOff"]!.GetValue<double>());

        var unauthorizedProgram = JsonNode.Parse(projectedProgram.ToJsonString())!.AsObject();
        unauthorizedProgram["design"]!["theme"]!["accentTransforms"]!["accent4"]!["hueOff"] = -90.0;
        unauthorizedProgram["design"]!["theme"]!["nativeRef"]!["capabilities"]!.AsArray()
            .Single(capability => capability!["operation"]!.GetValue<string>() == "setThemeAccent4HueOff")!["fields"] = new JsonArray("accentTransforms.accent4.tint");
        ...
        deletionProgram["design"]!["theme"]!["accentTransforms"]!["accent4"]!.AsObject().Remove("hueOff");
        ...
        outOfRangeProgram["design"]!["theme"]!["accentTransforms"]!["accent4"]!["hueOff"] = 361.0;
