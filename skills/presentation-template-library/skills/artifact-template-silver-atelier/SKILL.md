...
Use this style when the brief matches **premium portfolio; promotion presentation**. It is designed for
public audiences, communities, brand teams. Its visual premise is Documentary detail and narrow metallic accents create restrained value. The style is a
...
**big idea → audience truth → creative system → waves or experiences → measured outcome → next move**. This style is not a good fit for **incident review**;
...
- Use **#F2F3F3** as the main field, **#171717** for primary type, **#9A6B45** for the decisive signal, **#C4A35A** for secondary evidence, and **#C9CDCF** for rules or context.
...
- The recurring structure is **atelier, variable page silhouettes, documentary imagery**. Vary the silhouette between
  cover, evidence, data, process, comparison, and decision pages rather than
  repeating a component grid.
- Use close-cropped detail and narrow metallic accents to suggest craft and value. Keep the composition tactile but never let texture obscure a claim.
...
The expected density is **sparse**: spaciousness must create emphasis, not hide missing content. Alternate page
...
- **Page skeleton.** Use cool white data pages with black rules and black/copper photographic narrative pages. Over imagery, place one mist-white horizontal band or a short label; keep appendix evidence on a clean white surface.
- **Type rhythm.** Pair serif judgment titles with a sans data layer; appendix tables may use a denser reading face but should not leak into the main narrative. Keep metallic accents narrow and deliberate.
- **Evidence carriers.** Use stacked bars, waterfall/reconciliation views, timelines, financial statements, and adjustment tables. A pie or badge is valid only for the specific composition or secondary measure it explains.
- **Images and layers.** Narrative slides require premium documentary photography of place, materials, craft, or people. Data slides should not carry large photos; preserve the separation between story and ledger.
- **Pacing.** Alternate spacious photographic statements with dense evidence and a clear close. Copper is one decision or value signal; grayscale carries the rest.
- **Selection rule.** Choose this style for luxury, craft, premium brand, and value narratives with a serious appendix.

## Signature moves and variation limits

- Let **atelier** recur as a quiet identity cue on selected pages; it must
