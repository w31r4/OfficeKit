...
// templates plus thirty-two presentation style Skills once inside the package. Keep
...
for (const required of [
  ...
  "src/spreadsheet/chart-error-bars.mjs",
  ...
  "skills/presentations/skills/presentations/references/fonts.md",
  "skills/presentations/skills/presentations/references/shapes.md",
  "skills/presentations/skills/presentations/references/text.md",
  "skills/presentations/skills/presentations/references/charts-and-tables.md",
  "skills/presentations/skills/presentations/references/media-and-layers.md",
  "skills/presentations/skills/presentations/references/motion.md",
  "skills/presentations/skills/presentations/references/components-and-templates.md",
  "skills/presentations/skills/presentations/references/imported-native-ref.md",
  "skills/presentations/skills/presentations/references/review-and-delivery.md",
  "skills/presentations/skills/presentations/references/scenarios/README.md",
  "skills/presentations/skills/presentations/references/scenarios/analysis-decision.md",
  "skills/presentations/skills/presentations/references/scenarios/business-proposal.md",
  "skills/presentations/skills/presentations/references/scenarios/management-report.md",
  "skills/presentations/skills/presentations/references/scenarios/academic-research.md",
  "skills/presentations/skills/presentations/references/scenarios/education-training.md",
  "skills/presentations/skills/presentations/references/scenarios/technical-engineering.md",
  "skills/presentations/skills/presentations/references/scenarios/brand-creative.md",
  ...
  "skills/presentations/skills/presentation-skill-maintainer/SKILL.md",
  "skills/presentations/skills/presentation-skill-maintainer/agents/openai.yaml",
  "skills/presentations/skills/presentation-skill-maintainer/assets/icon.svg",
  "skills/presentations/skills/presentation-skill-maintainer/scripts/maintain-presentation-skill.mjs",
  ...
  "skills/presentation-template-library/skills/artifact-template-amber-committee-memo/SKILL.md",
  "skills/presentation-template-library/skills/artifact-template-amber-committee-memo/agents/agent.yaml",
...
assert.equal(packagedPresentationSidecars.length, 32, "npm package must ship exactly thirty-two schema-v3 presentation style Skills");
...
assert.equal(packagedPresentationCalibrationPngs.length, 162, "the presentation library must ship every declared preview and calibration example");
