...
const expected = new Map([
  ["office-kit", { version: "2.0.0", license: "AGPL-3.0-or-later" }],
  ["documents", { version: "0.2.0", license: "AGPL-3.0-or-later" }],
  ["spreadsheets", { version: "0.2.0", license: "AGPL-3.0-or-later" }],
  ["presentations", { version: "2.0.0", license: "AGPL-3.0-or-later" }],
  ["pdf", { version: "0.2.0", license: "AGPL-3.0-or-later" }],
  ["template-creator", { version: "2.0.0", license: "AGPL-3.0-or-later" }],
  ["presentation-template-creator", { version: "2.0.0", license: "AGPL-3.0-or-later" }],
  ["presentation-template-library", { version: "2.0.0", license: "AGPL-3.0-or-later" }],
  ["default-template-library", { version: "2.0.0", license: "MIT" }],
]);
assert.deepEqual(
