# Proposal: add source-bound paragraph default-text reflection end-opacity ownership to PPJ

Expose a bounded `paragraph.style.defaultText.reflection.endOpacity` owner
...
can change that end opacity without rewriting the surrounding slide.
