...
{
    [Fact]
    public void PpjSourceBoundCustomGeometryPathCubicEndXEditsAndReprojects()
    {
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            {
                SourceUri = "deck.assets/source/custom-geometry-path-cubic-end-x.pptx",
            },
        });
        ...
        var cubicLeaves = projectedShape["nativeRef"]!["leaves"]!.AsArray()
            ...
            .Where(leaf => leaf["kind"]!.GetValue<string>() == "customGeometryPathCubicEndX")
            .ToArray();
        var target = Assert.Single(cubicLeaves);
        Assert.Equal(700, target["value"]!.GetValue<long>());
        target["value"] = 650;
        ...
        Assert.Contains("x=\"500\" y=\"600\"", editedXml, StringComparison.Ordinal);
        Assert.Contains("x=\"650\" y=\"800\"", editedXml, StringComparison.Ordinal);
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/custom-geometry-path-cubic-end-x.pptx",
            },
        });
