...
{
    [Fact]
    public void PpjSourceBoundThemeAccent2GreenModEditsOnlyGreenModAndReprojects()
    {
        ...
        {
            Role = "accent2",
            GreenModulationThousandth = 25_000,
        });
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            {
                SourceUri = "deck.assets/source/theme-accent2-greenMod.pptx",
            },
        });
        ...
        Assert.Equal(0.25, projectedTransform["greenMod"]!.GetValue<double>());
        var nativeRef = Assert.IsType<JsonObject>(projectedTheme["nativeRef"]);
        Assert.Contains(nativeRef["capabilities"]!.AsArray(), capability =>
            capability!["operation"]!.GetValue<string>() == "setThemeAccent2GreenMod" &&
            capability["fields"]!.AsArray().Any(field => field!.GetValue<string>() == "accentTransforms.accent2.greenMod"));
        ...
        editedProgram["design"]!["theme"]!["accentTransforms"]!["accent2"]!["greenMod"] = 0.4;
        ...
        using (var package = PresentationDocument.Open(stream, false))
        {
            ...
            Assert.Equal(40_000, Assert.Single(accent2.Elements<A.GreenModulation>()).Val!.Value);
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/theme-accent2-greenMod.pptx",
            },
        });
        Assert.True(reprojected.Ok, Diagnostics(reprojected));
        var reprojectedProgram = JsonNode.Parse(reprojected.PresentationProgram.ProgramJson.ToByteArray())!.AsObject();
        Assert.Equal(0.4, reprojectedProgram["design"]!["theme"]!["accentTransforms"]!["accent2"]!["greenMod"]!.GetValue<double>());

        var unauthorizedProgram = JsonNode.Parse(projectedProgram.ToJsonString())!.AsObject();
        unauthorizedProgram["design"]!["theme"]!["accentTransforms"]!["accent2"]!["greenMod"] = 0.8;
        unauthorizedProgram["design"]!["theme"]!["nativeRef"]!["capabilities"]!.AsArray()
            .Single(capability => capability!["operation"]!.GetValue<string>() == "setThemeAccent2GreenMod")!["fields"] = new JsonArray("accentTransforms.accent2.tint");
        ...
        deletionProgram["design"]!["theme"]!["accentTransforms"]!["accent2"]!.AsObject().Remove("greenMod");
        ...
        outOfRangeProgram["design"]!["theme"]!["accentTransforms"]!["accent2"]!["greenMod"] = 1.1;
