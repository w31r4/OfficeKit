...
assert.equal(oleObject.deletionCapability.sourceBound, true);
assert.equal(oleObject.deletionCapability.supported, true);
assert.equal(oleObject.inspectRecord().deletionCapability.supported, true);
