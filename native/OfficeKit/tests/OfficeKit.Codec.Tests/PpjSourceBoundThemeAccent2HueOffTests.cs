...
{
    [Fact]
    public void PpjSourceBoundThemeAccent2HueOffEditsOnlyHueOffAndReprojects()
    {
        ...
        {
            Role = "accent2",
            HueOffsetAngleThousandth = 12_600_000,
        });
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            {
                SourceUri = "deck.assets/source/theme-accent2-hueOff.pptx",
            },
        });
        ...
        Assert.Equal(210.0, projectedTransform["hueOff"]!.GetValue<double>());
        var nativeRef = Assert.IsType<JsonObject>(projectedTheme["nativeRef"]);
        Assert.Contains(nativeRef["capabilities"]!.AsArray(), capability =>
            capability!["operation"]!.GetValue<string>() == "setThemeAccent2HueOff" &&
            capability["fields"]!.AsArray().Any(field => field!.GetValue<string>() == "accentTransforms.accent2.hueOff"));
        ...
        editedProgram["design"]!["theme"]!["accentTransforms"]!["accent2"]!["hueOff"] = -120.0;
        ...
        using (var package = PresentationDocument.Open(stream, false))
        {
            ...
            Assert.Equal(-7_200_000, Assert.Single(accent2.Elements<A.HueOffset>()).Val!.Value);
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/theme-accent2-hueOff.pptx",
            },
        });
        Assert.True(reprojected.Ok, Diagnostics(reprojected));
        var reprojectedProgram = JsonNode.Parse(reprojected.PresentationProgram.ProgramJson.ToByteArray())!.AsObject();
        Assert.Equal(-120.0, reprojectedProgram["design"]!["theme"]!["accentTransforms"]!["accent2"]!["hueOff"]!.GetValue<double>());

        var unauthorizedProgram = JsonNode.Parse(projectedProgram.ToJsonString())!.AsObject();
        unauthorizedProgram["design"]!["theme"]!["accentTransforms"]!["accent2"]!["hueOff"] = -90.0;
        unauthorizedProgram["design"]!["theme"]!["nativeRef"]!["capabilities"]!.AsArray()
            .Single(capability => capability!["operation"]!.GetValue<string>() == "setThemeAccent2HueOff")!["fields"] = new JsonArray("accentTransforms.accent2.tint");
        ...
        deletionProgram["design"]!["theme"]!["accentTransforms"]!["accent2"]!.AsObject().Remove("hueOff");
        ...
        outOfRangeProgram["design"]!["theme"]!["accentTransforms"]!["accent2"]!["hueOff"] = 361.0;
