...
internal static partial class PpjSourceBoundPresentationCompiler
{
        ...
        MutationState mutations)
    {
        ...
        RequireEqualExcept(before, after, path, "name", "fontScheme", "accentColors", "accentTransforms", "colorRoles", "nativeRef");
        ...
        if (PropertyChanged(before, after, "fontScheme"))
        {
            ...
            if (minorEastAsiaChanged)
            {
                if (!afterFontScheme.TryGetProperty("minorEastAsia", out var minorEastAsia) ||
                    minorEastAsia.ValueKind != JsonValueKind.String ||
                    string.IsNullOrWhiteSpace(minorEastAsia.GetString()))
                    throw Unsupported(path + ".fontScheme.minorEastAsia", "source-bound minor East Asian theme font deletion or an empty name is not supported");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".fontScheme.minorEastAsia", "the source did not issue a minor East Asian font capability");
                RequireCapabilityField(requested.Design.ThemeNativeRef, "setThemeMinorFontEastAsia", "fontScheme.minorEastAsia", path + ".fontScheme.minorEastAsia");
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
            ...
            if (minorComplexScriptChanged)
            {
                if (!afterFontScheme.TryGetProperty("minorComplexScript", out var minorComplexScript) ||
                    minorComplexScript.ValueKind != JsonValueKind.String ||
                    string.IsNullOrWhiteSpace(minorComplexScript.GetString()))
                    throw Unsupported(path + ".fontScheme.minorComplexScript", "source-bound minor complex-script theme font deletion or an empty name is not supported");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".fontScheme.minorComplexScript", "the source did not issue a minor complex-script font capability");
                RequireCapabilityField(requested.Design.ThemeNativeRef, "setThemeMinorFontComplexScript", "fontScheme.minorComplexScript", path + ".fontScheme.minorComplexScript");
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
        ...
        if (PropertyChanged(before, after, "accentColors"))
        {
            ...
            var accent1Changed = PropertyChanged(beforeAccentColors, afterAccentColors, "accent1");
            var accent2Changed = PropertyChanged(beforeAccentColors, afterAccentColors, "accent2");
            ...
            if (accent1Changed)
            {
                if (!afterAccentColors.TryGetProperty("accent1", out var afterAccent1) ||
                    ...
                    throw Unsupported(path + ".accentColors.accent1", "source-bound accent1 color must be a six- or eight-digit RGB/RGBA value");
                if (requested.Design.ThemeNativeRef is null)
                ...
                var requestedAccent1 = afterAccent1.GetString()!.Trim().TrimStart('#').ToUpperInvariant();
                _ = PptxColor.NormalizeThemeRgb(requestedAccent1, out _);
                artifact.Presentation.AuthoredTheme.AccentRgb[0] = requestedAccent1;
                mutations.SemanticChanges = true;
                changed = true;
            }
            if (accent2Changed)
            {
                if (!afterAccentColors.TryGetProperty("accent2", out var afterAccent2) ||
                    afterAccent2.ValueKind != JsonValueKind.String)
                    throw Unsupported(path + ".accentColors.accent2", "source-bound accent2 color must be a six- or eight-digit RGB/RGBA value");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentColors.accent2", "the source did not issue an accent2-color capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent2Color",
                    "accentColors.accent2",
                    path + ".accentColors.accent2");
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                if (artifact.Presentation.AuthoredTheme.AccentRgb.Count != 6)
                    throw Unsupported(path + ".accentColors", "source-bound accent colors require six imported slots");
                var requestedAccent2 = afterAccent2.GetString()!.Trim().TrimStart('#').ToUpperInvariant();
                _ = PptxColor.NormalizeThemeRgb(requestedAccent2, out _);
                artifact.Presentation.AuthoredTheme.AccentRgb[1] = requestedAccent2;
                mutations.SemanticChanges = true;
                changed = true;
            }
            if (accent3Changed)
            {
                ...
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent3Color",
                    "accentColors.accent3",
                    path + ".accentColors.accent3");
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                if (artifact.Presentation.AuthoredTheme.AccentRgb.Count != 6)
                    throw Unsupported(path + ".accentColors", "source-bound accent colors require six imported slots");
            ...
            if (accent4Changed)
            {
                if (!afterAccentColors.TryGetProperty("accent4", out var afterAccent4) ||
                    afterAccent4.ValueKind != JsonValueKind.String)
                    throw Unsupported(path + ".accentColors.accent4", "source-bound accent4 color must be a six- or eight-digit RGB/RGBA value");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentColors.accent4", "the source did not issue an accent4-color capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent4Color",
                    "accentColors.accent4",
                    path + ".accentColors.accent4");
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                if (artifact.Presentation.AuthoredTheme.AccentRgb.Count != 6)
                    throw Unsupported(path + ".accentColors", "source-bound accent colors require six imported slots");
                var requestedAccent4 = afterAccent4.GetString()!.Trim().TrimStart('#').ToUpperInvariant();
                _ = PptxColor.NormalizeThemeRgb(requestedAccent4, out _);
                artifact.Presentation.AuthoredTheme.AccentRgb[3] = requestedAccent4;
                mutations.SemanticChanges = true;
                changed = true;
            }
            if (accent5Changed)
            {
                if (!afterAccentColors.TryGetProperty("accent5", out var afterAccent5) ||
                    afterAccent5.ValueKind != JsonValueKind.String)
                    throw Unsupported(path + ".accentColors.accent5", "source-bound accent5 color must be a six- or eight-digit RGB/RGBA value");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentColors.accent5", "the source did not issue an accent5-color capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent5Color",
                    "accentColors.accent5",
                    path + ".accentColors.accent5");
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                if (artifact.Presentation.AuthoredTheme.AccentRgb.Count != 6)
                    throw Unsupported(path + ".accentColors", "source-bound accent colors require six imported slots");
                var requestedAccent5 = afterAccent5.GetString()!.Trim().TrimStart('#').ToUpperInvariant();
                _ = PptxColor.NormalizeThemeRgb(requestedAccent5, out _);
                artifact.Presentation.AuthoredTheme.AccentRgb[4] = requestedAccent5;
                mutations.SemanticChanges = true;
                changed = true;
            }
            if (accent6Changed)
            {
                if (!afterAccentColors.TryGetProperty("accent6", out var afterAccent6) ||
                    ...
                    throw Unsupported(path + ".accentColors.accent6", "source-bound accent6 color must be a six- or eight-digit RGB/RGBA value");
                if (requested.Design.ThemeNativeRef is null)
                ...
                if (artifact.Presentation.AuthoredTheme.AccentRgb.Count != 6)
                    throw Unsupported(path + ".accentColors", "source-bound accent colors require six imported slots");
                var requestedAccent6 = afterAccent6.GetString()!.Trim().TrimStart('#').ToUpperInvariant();
                _ = PptxColor.NormalizeThemeRgb(requestedAccent6, out _);
                artifact.Presentation.AuthoredTheme.AccentRgb[5] = requestedAccent6;
                mutations.SemanticChanges = true;
                changed = true;
            }
        }
        if (PropertyChanged(before, after, "accentTransforms"))
        {
            if (changed)
                throw new CodecException(
                    "ppj.sourceBound.themeAccentTransforms",
                    "Source-bound PPJ can change only one theme field per compile.",
                    path + ".accentTransforms");
            if (!before.TryGetProperty("accentTransforms", out var beforeAccentTransforms) ||
                !after.TryGetProperty("accentTransforms", out var afterAccentTransforms) ||
                beforeAccentTransforms.ValueKind != JsonValueKind.Object ||
            ...
            if (beforeAccentTransforms.TryGetProperty("accent2", out var beforeAccent2) &&
                afterAccentTransforms.TryGetProperty("accent2", out var afterAccent2) &&
                PropertyChanged(beforeAccent2, afterAccent2, "tint"))
            {
                     ...
                     PropertyChanged(beforeAccent2Shade, afterAccent2Shade, "shade"))
            {
                var changedTransformNames = beforeAccent2Shade.EnumerateObject().Select(property => property.Name)
                    ...
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent2Shade, afterAccent2Shade, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("shade", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent2", "source-bound accent2 requires exactly one changed shade field");
                if (!afterAccent2Shade.TryGetProperty("shade", out var shade) ||
                    ...
                    throw Unsupported(path + ".accentTransforms.accent2.shade", "source-bound accent2 shade must be a finite fraction from 0 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent2.shade", "the source did not issue an accent2-shade capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent2Shade",
                    "accentTransforms.accent2.shade",
                    path + ".accentTransforms.accent2.shade");
                ...
                changed = true;
                     ...
                     PropertyChanged(beforeAccent2LumMod, afterAccent2LumMod, "lumMod"))
            {
            ...
            else if (beforeAccentTransforms.TryGetProperty("accent2", out var beforeAccent2LumOff) &&
                     afterAccentTransforms.TryGetProperty("accent2", out var afterAccent2LumOff) &&
                     PropertyChanged(beforeAccent2LumOff, afterAccent2LumOff, "lumOff"))
            {
                var changedTransformNames = beforeAccent2LumOff.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent2LumOff.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent2LumOff, afterAccent2LumOff, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("lumOff", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent2", "source-bound accent2 requires exactly one changed lumOff field");
                if (!afterAccent2LumOff.TryGetProperty("lumOff", out var lumOff) ||
                    lumOff.ValueKind != JsonValueKind.Number ||
                    !lumOff.TryGetDouble(out var lumOffFraction) ||
                    !double.IsFinite(lumOffFraction) || lumOffFraction < -1 || lumOffFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent2.lumOff", "source-bound accent2 lumOff must be a finite fraction from -1 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent2.lumOff", "the source did not issue an accent2-lumOff capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent2LumOff",
                    "accentTransforms.accent2.lumOff",
                    path + ".accentTransforms.accent2.lumOff");
                var transformValue = checked((int)Math.Round(lumOffFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent2", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasLuminanceOffsetThousandth ||
                    authoredTransform.HasTintThousandth || authoredTransform.HasShadeThousandth ||
                    authoredTransform.HasLuminanceModulationThousandth ||
                    authoredTransform.HasAlphaModulationThousandth || authoredTransform.HasAlphaOffsetThousandth ||
                    authoredTransform.HasSaturationModulationThousandth || authoredTransform.HasSaturationOffsetThousandth ||
                    authoredTransform.HasRedModulationThousandth || authoredTransform.HasRedOffsetThousandth ||
                    authoredTransform.HasGreenModulationThousandth || authoredTransform.HasGreenOffsetThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent2.lumOff", "source-bound accent2 lumOff requires one imported direct lumOff");
                authoredTransform.LuminanceOffsetThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent2", out var beforeAccent2AlphaMod) &&
                     afterAccentTransforms.TryGetProperty("accent2", out var afterAccent2AlphaMod) &&
                     PropertyChanged(beforeAccent2AlphaMod, afterAccent2AlphaMod, "alphaMod"))
            {
                var changedTransformNames = beforeAccent2AlphaMod.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent2AlphaMod.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent2AlphaMod, afterAccent2AlphaMod, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("alphaMod", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent2", "source-bound accent2 requires exactly one changed alphaMod field");
                if (!afterAccent2AlphaMod.TryGetProperty("alphaMod", out var alphaMod) ||
                    ...
                    throw Unsupported(path + ".accentTransforms.accent2.alphaMod", "source-bound accent2 alphaMod must be a finite fraction from 0 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent2.alphaMod", "the source did not issue an accent2-alphaMod capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent2AlphaMod",
                    "accentTransforms.accent2.alphaMod",
                    path + ".accentTransforms.accent2.alphaMod");
                ...
                if (authoredTransform is null || !authoredTransform.HasAlphaModulationThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent2.alphaMod", "source-bound accent2 alphaMod requires one imported direct alphaMod");
                authoredTransform.AlphaModulationThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent2", out var beforeAccent2AlphaOff) &&
                     afterAccentTransforms.TryGetProperty("accent2", out var afterAccent2AlphaOff) &&
                     PropertyChanged(beforeAccent2AlphaOff, afterAccent2AlphaOff, "alphaOff"))
            {
                var changedTransformNames = beforeAccent2AlphaOff.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent2AlphaOff.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent2AlphaOff, afterAccent2AlphaOff, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("alphaOff", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent2", "source-bound accent2 requires exactly one changed alphaOff field");
                if (!afterAccent2AlphaOff.TryGetProperty("alphaOff", out var alphaOff) ||
                    alphaOff.ValueKind != JsonValueKind.Number ||
                    !alphaOff.TryGetDouble(out var alphaOffFraction) ||
                    !double.IsFinite(alphaOffFraction) || alphaOffFraction < -1 || alphaOffFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent2.alphaOff", "source-bound accent2 alphaOff must be a finite fraction from -1 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent2.alphaOff", "the source did not issue an accent2-alphaOff capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent2AlphaOff",
                    "accentTransforms.accent2.alphaOff",
                    path + ".accentTransforms.accent2.alphaOff");
                var transformValue = checked((int)Math.Round(alphaOffFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent2", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasAlphaOffsetThousandth ||
                    authoredTransform.HasTintThousandth || authoredTransform.HasShadeThousandth ||
                    authoredTransform.HasLuminanceModulationThousandth || authoredTransform.HasLuminanceOffsetThousandth ||
                    authoredTransform.HasAlphaModulationThousandth ||
                    authoredTransform.HasSaturationModulationThousandth || authoredTransform.HasSaturationOffsetThousandth ||
                    authoredTransform.HasRedModulationThousandth || authoredTransform.HasRedOffsetThousandth ||
                    authoredTransform.HasGreenModulationThousandth || authoredTransform.HasGreenOffsetThousandth ||
                    authoredTransform.HasBlueModulationThousandth || authoredTransform.HasBlueOffsetThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent2.alphaOff", "source-bound accent2 alphaOff requires one imported direct alphaOff");
                authoredTransform.AlphaOffsetThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent2", out var beforeAccent2SatMod) &&
                     afterAccentTransforms.TryGetProperty("accent2", out var afterAccent2SatMod) &&
                     PropertyChanged(beforeAccent2SatMod, afterAccent2SatMod, "satMod"))
            {
                var changedTransformNames = beforeAccent2SatMod.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent2SatMod.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent2SatMod, afterAccent2SatMod, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("satMod", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent2", "source-bound accent2 requires exactly one changed satMod field");
                if (!afterAccent2SatMod.TryGetProperty("satMod", out var satMod) ||
                    satMod.ValueKind != JsonValueKind.Number ||
                    !satMod.TryGetDouble(out var satModFraction) ||
                    !double.IsFinite(satModFraction) || satModFraction < 0 || satModFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent2.satMod", "source-bound accent2 satMod must be a finite fraction from 0 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent2.satMod", "the source did not issue an accent2-satMod capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent2SatMod",
                    "accentTransforms.accent2.satMod",
                    path + ".accentTransforms.accent2.satMod");
                var transformValue = checked((uint)Math.Round(satModFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent2", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasSaturationModulationThousandth ||
                    authoredTransform.HasTintThousandth || authoredTransform.HasShadeThousandth ||
                    authoredTransform.HasLuminanceModulationThousandth || authoredTransform.HasLuminanceOffsetThousandth ||
                    authoredTransform.HasAlphaModulationThousandth || authoredTransform.HasAlphaOffsetThousandth ||
                    authoredTransform.HasSaturationOffsetThousandth ||
                    authoredTransform.HasRedModulationThousandth || authoredTransform.HasRedOffsetThousandth ||
                    authoredTransform.HasGreenModulationThousandth || authoredTransform.HasGreenOffsetThousandth ||
                    authoredTransform.HasBlueModulationThousandth || authoredTransform.HasBlueOffsetThousandth ||
                    authoredTransform.HasHueModulationThousandth || authoredTransform.HasHueOffsetAngleThousandth ||
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent2.satMod", "source-bound accent2 satMod requires one imported direct satMod");
                authoredTransform.SaturationModulationThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent2", out var beforeAccent2SatOff) &&
                     afterAccentTransforms.TryGetProperty("accent2", out var afterAccent2SatOff) &&
                     PropertyChanged(beforeAccent2SatOff, afterAccent2SatOff, "satOff"))
            {
                var changedTransformNames = beforeAccent2SatOff.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent2SatOff.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent2SatOff, afterAccent2SatOff, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("satOff", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent2", "source-bound accent2 requires exactly one changed satOff field");
                if (!afterAccent2SatOff.TryGetProperty("satOff", out var satOff) ||
                    ...
                    throw Unsupported(path + ".accentTransforms.accent2.satOff", "source-bound accent2 satOff must be a finite fraction from -1 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent2.satOff", "the source did not issue an accent2-satOff capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent2SatOff",
                    "accentTransforms.accent2.satOff",
                    path + ".accentTransforms.accent2.satOff");
                ...
                if (authoredTransform is null || !authoredTransform.HasSaturationOffsetThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent2.satOff", "source-bound accent2 satOff requires one imported direct satOff");
                authoredTransform.SaturationOffsetThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent2", out var beforeAccent2RedMod) &&
                     afterAccentTransforms.TryGetProperty("accent2", out var afterAccent2RedMod) &&
                     PropertyChanged(beforeAccent2RedMod, afterAccent2RedMod, "redMod"))
            {
                var changedTransformNames = beforeAccent2RedMod.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent2RedMod.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent2RedMod, afterAccent2RedMod, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("redMod", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent2", "source-bound accent2 requires exactly one changed redMod field");
                if (!afterAccent2RedMod.TryGetProperty("redMod", out var redMod) ||
                    redMod.ValueKind != JsonValueKind.Number ||
                    !redMod.TryGetDouble(out var redModFraction) ||
                    !double.IsFinite(redModFraction) || redModFraction < 0 || redModFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent2.redMod", "source-bound accent2 redMod must be a finite fraction from 0 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent2.redMod", "the source did not issue an accent2-redMod capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent2RedMod",
                    "accentTransforms.accent2.redMod",
                    path + ".accentTransforms.accent2.redMod");
                var transformValue = checked((uint)Math.Round(redModFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent2", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasRedModulationThousandth ||
                    authoredTransform.HasTintThousandth || authoredTransform.HasShadeThousandth ||
                    authoredTransform.HasLuminanceModulationThousandth || authoredTransform.HasLuminanceOffsetThousandth ||
                    authoredTransform.HasAlphaModulationThousandth || authoredTransform.HasAlphaOffsetThousandth ||
                    authoredTransform.HasSaturationModulationThousandth || authoredTransform.HasSaturationOffsetThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent2.redMod", "source-bound accent2 redMod requires one imported direct redMod");
                authoredTransform.RedModulationThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent2", out var beforeAccent2RedOff) &&
                     afterAccentTransforms.TryGetProperty("accent2", out var afterAccent2RedOff) &&
                     PropertyChanged(beforeAccent2RedOff, afterAccent2RedOff, "redOff"))
            {
                var changedTransformNames = beforeAccent2RedOff.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent2RedOff.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent2RedOff, afterAccent2RedOff, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("redOff", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent2", "source-bound accent2 requires exactly one changed redOff field");
                if (!afterAccent2RedOff.TryGetProperty("redOff", out var redOff) ||
                    redOff.ValueKind != JsonValueKind.Number ||
                    !redOff.TryGetDouble(out var redOffFraction) ||
                    !double.IsFinite(redOffFraction) || redOffFraction < -1 || redOffFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent2.redOff", "source-bound accent2 redOff must be a finite fraction from -1 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent2.redOff", "the source did not issue an accent2-redOff capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent2RedOff",
                    "accentTransforms.accent2.redOff",
                    path + ".accentTransforms.accent2.redOff");
                var transformValue = checked((int)Math.Round(redOffFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent2", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasRedOffsetThousandth ||
                    authoredTransform.HasTintThousandth || authoredTransform.HasShadeThousandth ||
                    authoredTransform.HasLuminanceModulationThousandth || authoredTransform.HasLuminanceOffsetThousandth ||
                    authoredTransform.HasAlphaModulationThousandth || authoredTransform.HasAlphaOffsetThousandth ||
                    authoredTransform.HasSaturationModulationThousandth || authoredTransform.HasSaturationOffsetThousandth ||
                    authoredTransform.HasRedModulationThousandth ||
                    authoredTransform.HasGreenModulationThousandth || authoredTransform.HasGreenOffsetThousandth ||
                    authoredTransform.HasBlueModulationThousandth || authoredTransform.HasBlueOffsetThousandth ||
                    authoredTransform.HasHueModulationThousandth || authoredTransform.HasHueOffsetAngleThousandth ||
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent2.redOff", "source-bound accent2 redOff requires one imported direct redOff");
                authoredTransform.RedOffsetThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent2", out var beforeAccent2GreenMod) &&
                     afterAccentTransforms.TryGetProperty("accent2", out var afterAccent2GreenMod) &&
                     PropertyChanged(beforeAccent2GreenMod, afterAccent2GreenMod, "greenMod"))
            {
                var changedTransformNames = beforeAccent2GreenMod.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent2GreenMod.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent2GreenMod, afterAccent2GreenMod, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("greenMod", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent2", "source-bound accent2 requires exactly one changed greenMod field");
                if (!afterAccent2GreenMod.TryGetProperty("greenMod", out var greenMod) ||
                    greenMod.ValueKind != JsonValueKind.Number ||
                    !greenMod.TryGetDouble(out var greenModFraction) ||
                    !double.IsFinite(greenModFraction) || greenModFraction < 0 || greenModFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent2.greenMod", "source-bound accent2 greenMod must be a finite fraction from 0 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent2.greenMod", "the source did not issue an accent2-greenMod capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent2GreenMod",
                    "accentTransforms.accent2.greenMod",
                    path + ".accentTransforms.accent2.greenMod");
                var transformValue = checked((uint)Math.Round(greenModFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent2", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasGreenModulationThousandth ||
                    authoredTransform.HasTintThousandth || authoredTransform.HasShadeThousandth ||
                    authoredTransform.HasLuminanceModulationThousandth || authoredTransform.HasLuminanceOffsetThousandth ||
                    authoredTransform.HasAlphaModulationThousandth || authoredTransform.HasAlphaOffsetThousandth ||
                    authoredTransform.HasSaturationModulationThousandth || authoredTransform.HasSaturationOffsetThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent2.greenMod", "source-bound accent2 greenMod requires one imported direct greenMod");
                authoredTransform.GreenModulationThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent2", out var beforeAccent2GreenOff) &&
                     afterAccentTransforms.TryGetProperty("accent2", out var afterAccent2GreenOff) &&
                     PropertyChanged(beforeAccent2GreenOff, afterAccent2GreenOff, "greenOff"))
            {
                var changedTransformNames = beforeAccent2GreenOff.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent2GreenOff.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent2GreenOff, afterAccent2GreenOff, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("greenOff", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent2", "source-bound accent2 requires exactly one changed greenOff field");
                if (!afterAccent2GreenOff.TryGetProperty("greenOff", out var greenOff) ||
                    ...
                    throw Unsupported(path + ".accentTransforms.accent2.greenOff", "source-bound accent2 greenOff must be a finite fraction from -1 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent2.greenOff", "the source did not issue an accent2-greenOff capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent2GreenOff",
                    "accentTransforms.accent2.greenOff",
                    path + ".accentTransforms.accent2.greenOff");
                ...
                if (authoredTransform is null || !authoredTransform.HasGreenOffsetThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent2.greenOff", "source-bound accent2 greenOff requires one imported direct greenOff");
                authoredTransform.GreenOffsetThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent2", out var beforeAccent2BlueMod) &&
                     afterAccentTransforms.TryGetProperty("accent2", out var afterAccent2BlueMod) &&
                     PropertyChanged(beforeAccent2BlueMod, afterAccent2BlueMod, "blueMod"))
            {
                var changedTransformNames = beforeAccent2BlueMod.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent2BlueMod.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent2BlueMod, afterAccent2BlueMod, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("blueMod", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent2", "source-bound accent2 requires exactly one changed blueMod field");
                if (!afterAccent2BlueMod.TryGetProperty("blueMod", out var blueMod) ||
                    ...
                    throw Unsupported(path + ".accentTransforms.accent2.blueMod", "source-bound accent2 blueMod must be a finite fraction from 0 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent2.blueMod", "the source did not issue an accent2-blueMod capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent2BlueMod",
                    "accentTransforms.accent2.blueMod",
                    path + ".accentTransforms.accent2.blueMod");
                ...
                if (authoredTransform is null || !authoredTransform.HasBlueModulationThousandth ||
                    ...
                    authoredTransform.HasRedModulationThousandth || authoredTransform.HasRedOffsetThousandth ||
                    authoredTransform.HasGreenModulationThousandth || authoredTransform.HasGreenOffsetThousandth ||
                    authoredTransform.HasBlueOffsetThousandth ||
                    authoredTransform.HasHueModulationThousandth || authoredTransform.HasHueOffsetAngleThousandth ||
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent2.blueMod", "source-bound accent2 blueMod requires one imported direct blueMod");
                authoredTransform.BlueModulationThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent2", out var beforeAccent2BlueOff) &&
                     afterAccentTransforms.TryGetProperty("accent2", out var afterAccent2BlueOff) &&
                     PropertyChanged(beforeAccent2BlueOff, afterAccent2BlueOff, "blueOff"))
            {
                var changedTransformNames = beforeAccent2BlueOff.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent2BlueOff.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent2BlueOff, afterAccent2BlueOff, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("blueOff", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent2", "source-bound accent2 requires exactly one changed blueOff field");
                if (!afterAccent2BlueOff.TryGetProperty("blueOff", out var blueOff) ||
                    blueOff.ValueKind != JsonValueKind.Number ||
                    !blueOff.TryGetDouble(out var blueOffFraction) ||
                    !double.IsFinite(blueOffFraction) || blueOffFraction < -1 || blueOffFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent2.blueOff", "source-bound accent2 blueOff must be a finite fraction from -1 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent2.blueOff", "the source did not issue an accent2-blueOff capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent2BlueOff",
                    "accentTransforms.accent2.blueOff",
                    path + ".accentTransforms.accent2.blueOff");
                var transformValue = checked((int)Math.Round(blueOffFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent2", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasBlueOffsetThousandth ||
                    authoredTransform.HasTintThousandth || authoredTransform.HasShadeThousandth ||
                    authoredTransform.HasLuminanceModulationThousandth || authoredTransform.HasLuminanceOffsetThousandth ||
                    authoredTransform.HasAlphaModulationThousandth || authoredTransform.HasAlphaOffsetThousandth ||
                    authoredTransform.HasSaturationModulationThousandth || authoredTransform.HasSaturationOffsetThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent2.blueOff", "source-bound accent2 blueOff requires one imported direct blueOff");
            ...
            else if (beforeAccentTransforms.TryGetProperty("accent2", out var beforeAccent2HueOff) &&
                     afterAccentTransforms.TryGetProperty("accent2", out var afterAccent2HueOff) &&
                     PropertyChanged(beforeAccent2HueOff, afterAccent2HueOff, "hueOff"))
            {
                var changedTransformNames = beforeAccent2HueOff.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent2HueOff.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent2HueOff, afterAccent2HueOff, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("hueOff", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent2", "source-bound accent2 requires exactly one changed hueOff field");
                if (!afterAccent2HueOff.TryGetProperty("hueOff", out var hueOff) ||
                    ...
                    throw Unsupported(path + ".accentTransforms.accent2.hueOff", "source-bound accent2 hueOff must be a finite degree offset from -360 through 360");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent2.hueOff", "the source did not issue an accent2-hueOff capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent2HueOff",
                    "accentTransforms.accent2.hueOff",
                    path + ".accentTransforms.accent2.hueOff");
                ...
                if (authoredTransform is null || !authoredTransform.HasHueOffsetAngleThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent2.hueOff", "source-bound accent2 hueOff requires one imported direct hueOff");
                authoredTransform.HueOffsetAngleThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent3", out var beforeAccent3) &&
                afterAccentTransforms.TryGetProperty("accent3", out var afterAccent3) &&
                PropertyChanged(beforeAccent3, afterAccent3, "tint"))
            {
                var changedTransformNames = beforeAccent3.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent3.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent3, afterAccent3, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("tint", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent3", "source-bound accent3 requires exactly one changed tint field");
                if (!afterAccent3.TryGetProperty("tint", out var tint) ||
                    tint.ValueKind != JsonValueKind.Number ||
                    !tint.TryGetDouble(out var tintFraction) ||
                    !double.IsFinite(tintFraction) || tintFraction < 0 || tintFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent3.tint", "source-bound accent3 tint must be a finite fraction from 0 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent3.tint", "the source did not issue an accent3-tint capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent3Tint",
                    "accentTransforms.accent3.tint",
                    path + ".accentTransforms.accent3.tint");
                var transformValue = checked((uint)Math.Round(tintFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                ...
                if (authoredTransform is null || !authoredTransform.HasTintThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent3.tint", "source-bound accent3 tint requires one imported direct tint");
                authoredTransform.TintThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            ...
            else if (beforeAccentTransforms.TryGetProperty("accent3", out var beforeAccent3LumMod) &&
                     afterAccentTransforms.TryGetProperty("accent3", out var afterAccent3LumMod) &&
                     PropertyChanged(beforeAccent3LumMod, afterAccent3LumMod, "lumMod"))
            {
                var changedTransformNames = beforeAccent3LumMod.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent3LumMod.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent3LumMod, afterAccent3LumMod, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("lumMod", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent3", "source-bound accent3 requires exactly one changed lumMod field");
                if (!afterAccent3LumMod.TryGetProperty("lumMod", out var lumMod) ||
                    lumMod.ValueKind != JsonValueKind.Number ||
                    !lumMod.TryGetDouble(out var lumModFraction) ||
                    !double.IsFinite(lumModFraction) || lumModFraction < 0 || lumModFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent3.lumMod", "source-bound accent3 lumMod must be a finite fraction from 0 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent3.lumMod", "the source did not issue an accent3-lumMod capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent3LumMod",
                    "accentTransforms.accent3.lumMod",
                    path + ".accentTransforms.accent3.lumMod");
                var transformValue = checked((uint)Math.Round(lumModFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent3", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasLuminanceModulationThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent3.lumMod", "source-bound accent3 lumMod requires one imported direct lumMod");
                authoredTransform.LuminanceModulationThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent3", out var beforeAccent3LumOff) &&
                     afterAccentTransforms.TryGetProperty("accent3", out var afterAccent3LumOff) &&
                     PropertyChanged(beforeAccent3LumOff, afterAccent3LumOff, "lumOff"))
            {
                var changedTransformNames = beforeAccent3LumOff.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent3LumOff.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent3LumOff, afterAccent3LumOff, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("lumOff", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent3", "source-bound accent3 requires exactly one changed lumOff field");
                if (!afterAccent3LumOff.TryGetProperty("lumOff", out var lumOff) ||
                    lumOff.ValueKind != JsonValueKind.Number ||
                    !lumOff.TryGetDouble(out var lumOffFraction) ||
                    !double.IsFinite(lumOffFraction) || lumOffFraction < -1 || lumOffFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent3.lumOff", "source-bound accent3 lumOff must be a finite fraction from -1 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent3.lumOff", "the source did not issue an accent3-lumOff capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent3LumOff",
                    "accentTransforms.accent3.lumOff",
                    path + ".accentTransforms.accent3.lumOff");
                var transformValue = checked((int)Math.Round(lumOffFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent3", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasLuminanceOffsetThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent3.lumOff", "source-bound accent3 lumOff requires one imported direct lumOff");
                authoredTransform.LuminanceOffsetThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            ...
            else if (beforeAccentTransforms.TryGetProperty("accent3", out var beforeAccent3AlphaOff) &&
                     afterAccentTransforms.TryGetProperty("accent3", out var afterAccent3AlphaOff) &&
                     PropertyChanged(beforeAccent3AlphaOff, afterAccent3AlphaOff, "alphaOff"))
            {
                var changedTransformNames = beforeAccent3AlphaOff.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent3AlphaOff.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent3AlphaOff, afterAccent3AlphaOff, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("alphaOff", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent3", "source-bound accent3 requires exactly one changed alphaOff field");
                if (!afterAccent3AlphaOff.TryGetProperty("alphaOff", out var alphaOff) ||
                    alphaOff.ValueKind != JsonValueKind.Number ||
                    !alphaOff.TryGetDouble(out var alphaOffFraction) ||
                    !double.IsFinite(alphaOffFraction) || alphaOffFraction < -1 || alphaOffFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent3.alphaOff", "source-bound accent3 alphaOff must be a finite fraction from -1 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent3.alphaOff", "the source did not issue an accent3-alphaOff capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent3AlphaOff",
                    "accentTransforms.accent3.alphaOff",
                    path + ".accentTransforms.accent3.alphaOff");
                var transformValue = checked((int)Math.Round(alphaOffFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent3", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasAlphaOffsetThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent3.alphaOff", "source-bound accent3 alphaOff requires one imported direct alphaOff");
                authoredTransform.AlphaOffsetThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent3", out var beforeAccent3SatMod) &&
                     afterAccentTransforms.TryGetProperty("accent3", out var afterAccent3SatMod) &&
                     PropertyChanged(beforeAccent3SatMod, afterAccent3SatMod, "satMod"))
            {
                var changedTransformNames = beforeAccent3SatMod.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent3SatMod.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent3SatMod, afterAccent3SatMod, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("satMod", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent3", "source-bound accent3 requires exactly one changed satMod field");
                if (!afterAccent3SatMod.TryGetProperty("satMod", out var satMod) ||
                    satMod.ValueKind != JsonValueKind.Number ||
                    !satMod.TryGetDouble(out var satModFraction) ||
                    !double.IsFinite(satModFraction) || satModFraction < 0 || satModFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent3.satMod", "source-bound accent3 satMod must be a finite fraction from 0 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent3.satMod", "the source did not issue an accent3-satMod capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent3SatMod",
                    "accentTransforms.accent3.satMod",
                    path + ".accentTransforms.accent3.satMod");
                var transformValue = checked((uint)Math.Round(satModFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent3", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasSaturationModulationThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent3.satMod", "source-bound accent3 satMod requires one imported direct satMod");
                authoredTransform.SaturationModulationThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            ...
            else if (beforeAccentTransforms.TryGetProperty("accent3", out var beforeAccent3RedMod) &&
                     afterAccentTransforms.TryGetProperty("accent3", out var afterAccent3RedMod) &&
                     PropertyChanged(beforeAccent3RedMod, afterAccent3RedMod, "redMod"))
            {
                var changedTransformNames = beforeAccent3RedMod.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent3RedMod.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent3RedMod, afterAccent3RedMod, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("redMod", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent3", "source-bound accent3 requires exactly one changed redMod field");
                if (!afterAccent3RedMod.TryGetProperty("redMod", out var redMod) ||
                    redMod.ValueKind != JsonValueKind.Number ||
                    !redMod.TryGetDouble(out var redModFraction) ||
                    !double.IsFinite(redModFraction) || redModFraction < 0 || redModFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent3.redMod", "source-bound accent3 redMod must be a finite fraction from 0 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent3.redMod", "the source did not issue an accent3-redMod capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent3RedMod",
                    "accentTransforms.accent3.redMod",
                    path + ".accentTransforms.accent3.redMod");
                var transformValue = checked((uint)Math.Round(redModFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent3", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasRedModulationThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent3.redMod", "source-bound accent3 redMod requires one imported direct redMod");
                authoredTransform.RedModulationThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent3", out var beforeAccent3RedOff) &&
                     afterAccentTransforms.TryGetProperty("accent3", out var afterAccent3RedOff) &&
                     PropertyChanged(beforeAccent3RedOff, afterAccent3RedOff, "redOff"))
            {
                var changedTransformNames = beforeAccent3RedOff.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent3RedOff.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent3RedOff, afterAccent3RedOff, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("redOff", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent3", "source-bound accent3 requires exactly one changed redOff field");
                if (!afterAccent3RedOff.TryGetProperty("redOff", out var redOff) ||
                    redOff.ValueKind != JsonValueKind.Number ||
                    !redOff.TryGetDouble(out var redOffFraction) ||
                    !double.IsFinite(redOffFraction) || redOffFraction < -1 || redOffFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent3.redOff", "source-bound accent3 redOff must be a finite fraction from -1 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent3.redOff", "the source did not issue an accent3-redOff capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent3RedOff",
                    "accentTransforms.accent3.redOff",
                    path + ".accentTransforms.accent3.redOff");
                var transformValue = checked((int)Math.Round(redOffFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent3", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasRedOffsetThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent3.redOff", "source-bound accent3 redOff requires one imported direct redOff");
                authoredTransform.RedOffsetThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent3", out var beforeAccent3GreenMod) &&
                     afterAccentTransforms.TryGetProperty("accent3", out var afterAccent3GreenMod) &&
                     PropertyChanged(beforeAccent3GreenMod, afterAccent3GreenMod, "greenMod"))
            {
                var changedTransformNames = beforeAccent3GreenMod.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent3GreenMod.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent3GreenMod, afterAccent3GreenMod, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("greenMod", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent3", "source-bound accent3 requires exactly one changed greenMod field");
                if (!afterAccent3GreenMod.TryGetProperty("greenMod", out var greenMod) ||
                    greenMod.ValueKind != JsonValueKind.Number ||
                    !greenMod.TryGetDouble(out var greenModFraction) ||
                    !double.IsFinite(greenModFraction) || greenModFraction < 0 || greenModFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent3.greenMod", "source-bound accent3 greenMod must be a finite fraction from 0 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent3.greenMod", "the source did not issue an accent3-greenMod capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent3GreenMod",
                    "accentTransforms.accent3.greenMod",
                    path + ".accentTransforms.accent3.greenMod");
                var transformValue = checked((uint)Math.Round(greenModFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent3", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasGreenModulationThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent3.greenMod", "source-bound accent3 greenMod requires one imported direct greenMod");
                authoredTransform.GreenModulationThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent3", out var beforeAccent3GreenOff) &&
                     afterAccentTransforms.TryGetProperty("accent3", out var afterAccent3GreenOff) &&
                     PropertyChanged(beforeAccent3GreenOff, afterAccent3GreenOff, "greenOff"))
            {
                var changedTransformNames = beforeAccent3GreenOff.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent3GreenOff.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent3GreenOff, afterAccent3GreenOff, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("greenOff", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent3", "source-bound accent3 requires exactly one changed greenOff field");
                if (!afterAccent3GreenOff.TryGetProperty("greenOff", out var greenOff) ||
                    greenOff.ValueKind != JsonValueKind.Number ||
                    !greenOff.TryGetDouble(out var greenOffFraction) ||
                    !double.IsFinite(greenOffFraction) || greenOffFraction < -1 || greenOffFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent3.greenOff", "source-bound accent3 greenOff must be a finite fraction from -1 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent3.greenOff", "the source did not issue an accent3-greenOff capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent3GreenOff",
                    "accentTransforms.accent3.greenOff",
                    path + ".accentTransforms.accent3.greenOff");
                var transformValue = checked((int)Math.Round(greenOffFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent3", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasGreenOffsetThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent3.greenOff", "source-bound accent3 greenOff requires one imported direct greenOff");
                authoredTransform.GreenOffsetThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent3", out var beforeAccent3BlueMod) &&
                     afterAccentTransforms.TryGetProperty("accent3", out var afterAccent3BlueMod) &&
                     PropertyChanged(beforeAccent3BlueMod, afterAccent3BlueMod, "blueMod"))
            {
                var changedTransformNames = beforeAccent3BlueMod.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent3BlueMod.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent3BlueMod, afterAccent3BlueMod, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("blueMod", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent3", "source-bound accent3 requires exactly one changed blueMod field");
                if (!afterAccent3BlueMod.TryGetProperty("blueMod", out var blueMod) ||
                    blueMod.ValueKind != JsonValueKind.Number ||
                    !blueMod.TryGetDouble(out var blueModFraction) ||
                    !double.IsFinite(blueModFraction) || blueModFraction < 0 || blueModFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent3.blueMod", "source-bound accent3 blueMod must be a finite fraction from 0 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent3.blueMod", "the source did not issue an accent3-blueMod capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent3BlueMod",
                    "accentTransforms.accent3.blueMod",
                    path + ".accentTransforms.accent3.blueMod");
                var transformValue = checked((uint)Math.Round(blueModFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent3", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasBlueModulationThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent3.blueMod", "source-bound accent3 blueMod requires one imported direct blueMod");
                authoredTransform.BlueModulationThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent3", out var beforeAccent3BlueOff) &&
                     afterAccentTransforms.TryGetProperty("accent3", out var afterAccent3BlueOff) &&
                     PropertyChanged(beforeAccent3BlueOff, afterAccent3BlueOff, "blueOff"))
            {
                var changedTransformNames = beforeAccent3BlueOff.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent3BlueOff.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent3BlueOff, afterAccent3BlueOff, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("blueOff", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent3", "source-bound accent3 requires exactly one changed blueOff field");
                if (!afterAccent3BlueOff.TryGetProperty("blueOff", out var blueOff) ||
                    blueOff.ValueKind != JsonValueKind.Number ||
                    !blueOff.TryGetDouble(out var blueOffFraction) ||
                    !double.IsFinite(blueOffFraction) || blueOffFraction < -1 || blueOffFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent3.blueOff", "source-bound accent3 blueOff must be a finite fraction from -1 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent3.blueOff", "the source did not issue an accent3-blueOff capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent3BlueOff",
                    "accentTransforms.accent3.blueOff",
                    path + ".accentTransforms.accent3.blueOff");
                var transformValue = checked((int)Math.Round(blueOffFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent3", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasBlueOffsetThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent3.blueOff", "source-bound accent3 blueOff requires one imported direct blueOff");
                authoredTransform.BlueOffsetThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent3", out var beforeAccent3HueMod) &&
                     afterAccentTransforms.TryGetProperty("accent3", out var afterAccent3HueMod) &&
                     PropertyChanged(beforeAccent3HueMod, afterAccent3HueMod, "hueMod"))
            {
                var changedTransformNames = beforeAccent3HueMod.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent3HueMod.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent3HueMod, afterAccent3HueMod, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("hueMod", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent3", "source-bound accent3 requires exactly one changed hueMod field");
                if (!afterAccent3HueMod.TryGetProperty("hueMod", out var hueMod) ||
                    hueMod.ValueKind != JsonValueKind.Number ||
                    !hueMod.TryGetDouble(out var hueModFraction) ||
                    !double.IsFinite(hueModFraction) || hueModFraction < 0 || hueModFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent3.hueMod", "source-bound accent3 hueMod must be a finite fraction from 0 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent3.hueMod", "the source did not issue an accent3-hueMod capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent3HueMod",
                    "accentTransforms.accent3.hueMod",
                    path + ".accentTransforms.accent3.hueMod");
                var transformValue = checked((uint)Math.Round(hueModFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent3", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasHueModulationThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent3.hueMod", "source-bound accent3 hueMod requires one imported direct hueMod");
                authoredTransform.HueModulationThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent3", out var beforeAccent3HueOff) &&
                     afterAccentTransforms.TryGetProperty("accent3", out var afterAccent3HueOff) &&
                     PropertyChanged(beforeAccent3HueOff, afterAccent3HueOff, "hueOff"))
            {
                var changedTransformNames = beforeAccent3HueOff.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent3HueOff.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent3HueOff, afterAccent3HueOff, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("hueOff", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent3", "source-bound accent3 requires exactly one changed hueOff field");
                if (!afterAccent3HueOff.TryGetProperty("hueOff", out var hueOff) ||
                    hueOff.ValueKind != JsonValueKind.Number ||
                    !hueOff.TryGetDouble(out var hueOffDegrees) ||
                    !double.IsFinite(hueOffDegrees) || hueOffDegrees < -360 || hueOffDegrees > 360)
                    throw Unsupported(path + ".accentTransforms.accent3.hueOff", "source-bound accent3 hueOff must be a finite degree offset from -360 through 360");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent3.hueOff", "the source did not issue an accent3-hueOff capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent3HueOff",
                    "accentTransforms.accent3.hueOff",
                    path + ".accentTransforms.accent3.hueOff");
                var transformValue = checked((int)Math.Round(hueOffDegrees * 60_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent3", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasHueOffsetAngleThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent3.hueOff", "source-bound accent3 hueOff requires one imported direct hueOff");
                authoredTransform.HueOffsetAngleThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent4", out var beforeAccent4HueOff) &&
                     afterAccentTransforms.TryGetProperty("accent4", out var afterAccent4HueOff) &&
                     PropertyChanged(beforeAccent4HueOff, afterAccent4HueOff, "hueOff"))
            {
                var changedTransformNames = beforeAccent4HueOff.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent4HueOff.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent4HueOff, afterAccent4HueOff, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("hueOff", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent4", "source-bound accent4 requires exactly one changed hueOff field");
                if (!afterAccent4HueOff.TryGetProperty("hueOff", out var hueOff) ||
                    hueOff.ValueKind != JsonValueKind.Number ||
                    !hueOff.TryGetDouble(out var hueOffDegrees) ||
                    !double.IsFinite(hueOffDegrees) || hueOffDegrees < -360 || hueOffDegrees > 360)
                    throw Unsupported(path + ".accentTransforms.accent4.hueOff", "source-bound accent4 hueOff must be a finite degree offset from -360 through 360");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent4.hueOff", "the source did not issue an accent4-hueOff capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent4HueOff",
                    "accentTransforms.accent4.hueOff",
                    path + ".accentTransforms.accent4.hueOff");
                var transformValue = checked((int)Math.Round(hueOffDegrees * 60_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                ...
                if (authoredTransform is null || !authoredTransform.HasHueOffsetAngleThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent4.hueOff", "source-bound accent4 hueOff requires one imported direct hueOff");
                authoredTransform.HueOffsetAngleThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent5", out var beforeAccent5) &&
                afterAccentTransforms.TryGetProperty("accent5", out var afterAccent5) &&
                PropertyChanged(beforeAccent5, afterAccent5, "tint"))
            {
                var changedTransformNames = beforeAccent5.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent5.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent5, afterAccent5, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("tint", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent5", "source-bound accent5 requires exactly one changed tint field");
                if (!afterAccent5.TryGetProperty("tint", out var tint) ||
                    tint.ValueKind != JsonValueKind.Number ||
                    !tint.TryGetDouble(out var tintFraction) ||
                    !double.IsFinite(tintFraction) || tintFraction < 0 || tintFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent5.tint", "source-bound accent5 tint must be a finite fraction from 0 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent5.tint", "the source did not issue an accent5-tint capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent5Tint",
                    "accentTransforms.accent5.tint",
                    path + ".accentTransforms.accent5.tint");
                var transformValue = checked((uint)Math.Round(tintFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                ...
                if (authoredTransform is null || !authoredTransform.HasTintThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent5.tint", "source-bound accent5 tint requires one imported direct tint");
                authoredTransform.TintThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent6", out var beforeAccent6) &&
                afterAccentTransforms.TryGetProperty("accent6", out var afterAccent6) &&
                PropertyChanged(beforeAccent6, afterAccent6, "tint"))
            {
                var changedTransformNames = beforeAccent6.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent6.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent6, afterAccent6, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("tint", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent6", "source-bound accent6 requires exactly one changed tint field");
                if (!afterAccent6.TryGetProperty("tint", out var tint) ||
                    tint.ValueKind != JsonValueKind.Number ||
                    !tint.TryGetDouble(out var tintFraction) ||
                    !double.IsFinite(tintFraction) || tintFraction < 0 || tintFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent6.tint", "source-bound accent6 tint must be a finite fraction from 0 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent6.tint", "the source did not issue an accent6-tint capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent6Tint",
                    "accentTransforms.accent6.tint",
                    path + ".accentTransforms.accent6.tint");
                var transformValue = checked((uint)Math.Round(tintFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                ...
                if (authoredTransform is null || !authoredTransform.HasTintThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent6.tint", "source-bound accent6 tint requires one imported direct tint");
                authoredTransform.TintThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent6", out var beforeAccent6Shade) &&
                afterAccentTransforms.TryGetProperty("accent6", out var afterAccent6Shade) &&
                PropertyChanged(beforeAccent6Shade, afterAccent6Shade, "shade"))
            {
                var changedTransformNames = beforeAccent6Shade.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent6Shade.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent6Shade, afterAccent6Shade, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("shade", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent6", "source-bound accent6 requires exactly one changed shade field");
                if (!afterAccent6Shade.TryGetProperty("shade", out var shade) ||
                    shade.ValueKind != JsonValueKind.Number ||
                    !shade.TryGetDouble(out var shadeFraction) ||
                    !double.IsFinite(shadeFraction) || shadeFraction < 0 || shadeFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent6.shade", "source-bound accent6 shade must be a finite fraction from 0 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent6.shade", "the source did not issue an accent6-shade capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent6Shade",
                    "accentTransforms.accent6.shade",
                    path + ".accentTransforms.accent6.shade");
                var transformValue = checked((uint)Math.Round(shadeFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent6", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasShadeThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent6.shade", "source-bound accent6 shade requires one imported direct shade");
                authoredTransform.ShadeThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent6", out var beforeAccent6LumMod) &&
                     afterAccentTransforms.TryGetProperty("accent6", out var afterAccent6LumMod) &&
                     PropertyChanged(beforeAccent6LumMod, afterAccent6LumMod, "lumMod"))
            {
                var changedTransformNames = beforeAccent6LumMod.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent6LumMod.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent6LumMod, afterAccent6LumMod, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("lumMod", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent6", "source-bound accent6 requires exactly one changed lumMod field");
                if (!afterAccent6LumMod.TryGetProperty("lumMod", out var lumMod) ||
                    lumMod.ValueKind != JsonValueKind.Number ||
                    !lumMod.TryGetDouble(out var lumModFraction) ||
                    !double.IsFinite(lumModFraction) || lumModFraction < 0 || lumModFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent6.lumMod", "source-bound accent6 lumMod must be a finite fraction from 0 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent6.lumMod", "the source did not issue an accent6-lumMod capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent6LumMod",
                    "accentTransforms.accent6.lumMod",
                    path + ".accentTransforms.accent6.lumMod");
                var transformValue = checked((uint)Math.Round(lumModFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent6", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasLuminanceModulationThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent6.lumMod", "source-bound accent6 lumMod requires one imported direct lumMod");
                authoredTransform.LuminanceModulationThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent6", out var beforeAccent6LumOff) &&
                     afterAccentTransforms.TryGetProperty("accent6", out var afterAccent6LumOff) &&
                     PropertyChanged(beforeAccent6LumOff, afterAccent6LumOff, "lumOff"))
            {
                var changedTransformNames = beforeAccent6LumOff.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent6LumOff.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent6LumOff, afterAccent6LumOff, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("lumOff", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent6", "source-bound accent6 requires exactly one changed lumOff field");
                if (!afterAccent6LumOff.TryGetProperty("lumOff", out var lumOff) ||
                    lumOff.ValueKind != JsonValueKind.Number ||
                    !lumOff.TryGetDouble(out var lumOffFraction) ||
                    !double.IsFinite(lumOffFraction) || lumOffFraction < -1 || lumOffFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent6.lumOff", "source-bound accent6 lumOff must be a finite fraction from -1 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent6.lumOff", "the source did not issue an accent6-lumOff capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent6LumOff",
                    "accentTransforms.accent6.lumOff",
                    path + ".accentTransforms.accent6.lumOff");
                var transformValue = checked((int)Math.Round(lumOffFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent6", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasLuminanceOffsetThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent6.lumOff", "source-bound accent6 lumOff requires one imported direct lumOff");
                authoredTransform.LuminanceOffsetThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent6", out var beforeAccent6AlphaMod) &&
                     afterAccentTransforms.TryGetProperty("accent6", out var afterAccent6AlphaMod) &&
                     PropertyChanged(beforeAccent6AlphaMod, afterAccent6AlphaMod, "alphaMod"))
            {
                var changedTransformNames = beforeAccent6AlphaMod.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent6AlphaMod.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent6AlphaMod, afterAccent6AlphaMod, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("alphaMod", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent6", "source-bound accent6 requires exactly one changed alphaMod field");
                if (!afterAccent6AlphaMod.TryGetProperty("alphaMod", out var alphaMod) ||
                    alphaMod.ValueKind != JsonValueKind.Number ||
                    !alphaMod.TryGetDouble(out var alphaModFraction) ||
                    !double.IsFinite(alphaModFraction) || alphaModFraction < 0 || alphaModFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent6.alphaMod", "source-bound accent6 alphaMod must be a finite fraction from 0 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent6.alphaMod", "the source did not issue an accent6-alphaMod capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent6AlphaMod",
                    "accentTransforms.accent6.alphaMod",
                    path + ".accentTransforms.accent6.alphaMod");
                var transformValue = checked((uint)Math.Round(alphaModFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent6", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasAlphaModulationThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent6.alphaMod", "source-bound accent6 alphaMod requires one imported direct alphaMod");
                authoredTransform.AlphaModulationThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent6", out var beforeAccent6AlphaOff) &&
                     afterAccentTransforms.TryGetProperty("accent6", out var afterAccent6AlphaOff) &&
                     PropertyChanged(beforeAccent6AlphaOff, afterAccent6AlphaOff, "alphaOff"))
            {
                var changedTransformNames = beforeAccent6AlphaOff.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent6AlphaOff.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent6AlphaOff, afterAccent6AlphaOff, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("alphaOff", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent6", "source-bound accent6 requires exactly one changed alphaOff field");
                if (!afterAccent6AlphaOff.TryGetProperty("alphaOff", out var alphaOff) ||
                    alphaOff.ValueKind != JsonValueKind.Number ||
                    !alphaOff.TryGetDouble(out var alphaOffFraction) ||
                    !double.IsFinite(alphaOffFraction) || alphaOffFraction < -1 || alphaOffFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent6.alphaOff", "source-bound accent6 alphaOff must be a finite fraction from -1 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent6.alphaOff", "the source did not issue an accent6-alphaOff capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent6AlphaOff",
                    "accentTransforms.accent6.alphaOff",
                    path + ".accentTransforms.accent6.alphaOff");
                var transformValue = checked((int)Math.Round(alphaOffFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent6", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasAlphaOffsetThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent6.alphaOff", "source-bound accent6 alphaOff requires one imported direct alphaOff");
                authoredTransform.AlphaOffsetThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent6", out var beforeAccent6SatMod) &&
                     afterAccentTransforms.TryGetProperty("accent6", out var afterAccent6SatMod) &&
                     PropertyChanged(beforeAccent6SatMod, afterAccent6SatMod, "satMod"))
            {
                var changedTransformNames = beforeAccent6SatMod.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent6SatMod.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent6SatMod, afterAccent6SatMod, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("satMod", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent6", "source-bound accent6 requires exactly one changed satMod field");
                if (!afterAccent6SatMod.TryGetProperty("satMod", out var satMod) ||
                    satMod.ValueKind != JsonValueKind.Number ||
                    !satMod.TryGetDouble(out var satModFraction) ||
                    !double.IsFinite(satModFraction) || satModFraction < 0 || satModFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent6.satMod", "source-bound accent6 satMod must be a finite fraction from 0 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent6.satMod", "the source did not issue an accent6-satMod capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent6SatMod",
                    "accentTransforms.accent6.satMod",
                    path + ".accentTransforms.accent6.satMod");
                var transformValue = checked((uint)Math.Round(satModFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent6", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasSaturationModulationThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent6.satMod", "source-bound accent6 satMod requires one imported direct satMod");
                authoredTransform.SaturationModulationThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent6", out var beforeAccent6SatOff) &&
                     afterAccentTransforms.TryGetProperty("accent6", out var afterAccent6SatOff) &&
                     PropertyChanged(beforeAccent6SatOff, afterAccent6SatOff, "satOff"))
            {
                var changedTransformNames = beforeAccent6SatOff.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent6SatOff.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent6SatOff, afterAccent6SatOff, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("satOff", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent6", "source-bound accent6 requires exactly one changed satOff field");
                if (!afterAccent6SatOff.TryGetProperty("satOff", out var satOff) ||
                    satOff.ValueKind != JsonValueKind.Number ||
                    !satOff.TryGetDouble(out var satOffFraction) ||
                    !double.IsFinite(satOffFraction) || satOffFraction < -1 || satOffFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent6.satOff", "source-bound accent6 satOff must be a finite fraction from -1 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent6.satOff", "the source did not issue an accent6-satOff capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent6SatOff",
                    "accentTransforms.accent6.satOff",
                    path + ".accentTransforms.accent6.satOff");
                var transformValue = checked((int)Math.Round(satOffFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent6", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasSaturationOffsetThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent6.satOff", "source-bound accent6 satOff requires one imported direct satOff");
                authoredTransform.SaturationOffsetThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent6", out var beforeAccent6RedMod) &&
                     afterAccentTransforms.TryGetProperty("accent6", out var afterAccent6RedMod) &&
                     PropertyChanged(beforeAccent6RedMod, afterAccent6RedMod, "redMod"))
            {
                var changedTransformNames = beforeAccent6RedMod.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent6RedMod.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent6RedMod, afterAccent6RedMod, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("redMod", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent6", "source-bound accent6 requires exactly one changed redMod field");
                if (!afterAccent6RedMod.TryGetProperty("redMod", out var redMod) ||
                    redMod.ValueKind != JsonValueKind.Number ||
                    !redMod.TryGetDouble(out var redModFraction) ||
                    !double.IsFinite(redModFraction) || redModFraction < 0 || redModFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent6.redMod", "source-bound accent6 redMod must be a finite fraction from 0 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent6.redMod", "the source did not issue an accent6-redMod capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent6RedMod",
                    "accentTransforms.accent6.redMod",
                    path + ".accentTransforms.accent6.redMod");
                var transformValue = checked((uint)Math.Round(redModFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent6", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasRedModulationThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent6.redMod", "source-bound accent6 redMod requires one imported direct redMod");
                authoredTransform.RedModulationThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent6", out var beforeAccent6RedOff) &&
                     afterAccentTransforms.TryGetProperty("accent6", out var afterAccent6RedOff) &&
                     PropertyChanged(beforeAccent6RedOff, afterAccent6RedOff, "redOff"))
            {
                var changedTransformNames = beforeAccent6RedOff.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent6RedOff.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent6RedOff, afterAccent6RedOff, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("redOff", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent6", "source-bound accent6 requires exactly one changed redOff field");
                if (!afterAccent6RedOff.TryGetProperty("redOff", out var redOff) ||
                    redOff.ValueKind != JsonValueKind.Number ||
                    !redOff.TryGetDouble(out var redOffFraction) ||
                    !double.IsFinite(redOffFraction) || redOffFraction < -1 || redOffFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent6.redOff", "source-bound accent6 redOff must be a finite fraction from -1 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent6.redOff", "the source did not issue an accent6-redOff capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent6RedOff",
                    "accentTransforms.accent6.redOff",
                    path + ".accentTransforms.accent6.redOff");
                var transformValue = checked((int)Math.Round(redOffFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent6", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasRedOffsetThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent6.redOff", "source-bound accent6 redOff requires one imported direct redOff");
                authoredTransform.RedOffsetThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent6", out var beforeAccent6GreenMod) &&
                     afterAccentTransforms.TryGetProperty("accent6", out var afterAccent6GreenMod) &&
                     PropertyChanged(beforeAccent6GreenMod, afterAccent6GreenMod, "greenMod"))
            {
                var changedTransformNames = beforeAccent6GreenMod.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent6GreenMod.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent6GreenMod, afterAccent6GreenMod, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("greenMod", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent6", "source-bound accent6 requires exactly one changed greenMod field");
                if (!afterAccent6GreenMod.TryGetProperty("greenMod", out var greenMod) ||
                    greenMod.ValueKind != JsonValueKind.Number ||
                    !greenMod.TryGetDouble(out var greenModFraction) ||
                    !double.IsFinite(greenModFraction) || greenModFraction < 0 || greenModFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent6.greenMod", "source-bound accent6 greenMod must be a finite fraction from 0 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent6.greenMod", "the source did not issue an accent6-greenMod capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent6GreenMod",
                    "accentTransforms.accent6.greenMod",
                    path + ".accentTransforms.accent6.greenMod");
                var transformValue = checked((uint)Math.Round(greenModFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent6", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasGreenModulationThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent6.greenMod", "source-bound accent6 greenMod requires one imported direct greenMod");
                authoredTransform.GreenModulationThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            ...
            else if (beforeAccentTransforms.TryGetProperty("accent6", out var beforeAccent6BlueMod) &&
                     afterAccentTransforms.TryGetProperty("accent6", out var afterAccent6BlueMod) &&
                     PropertyChanged(beforeAccent6BlueMod, afterAccent6BlueMod, "blueMod"))
            {
                var changedTransformNames = beforeAccent6BlueMod.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent6BlueMod.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent6BlueMod, afterAccent6BlueMod, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("blueMod", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent6", "source-bound accent6 requires exactly one changed blueMod field");
                if (!afterAccent6BlueMod.TryGetProperty("blueMod", out var blueMod) ||
                    blueMod.ValueKind != JsonValueKind.Number ||
                    !blueMod.TryGetDouble(out var blueModFraction) ||
                    !double.IsFinite(blueModFraction) || blueModFraction < 0 || blueModFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent6.blueMod", "source-bound accent6 blueMod must be a finite fraction from 0 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent6.blueMod", "the source did not issue an accent6-blueMod capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent6BlueMod",
                    "accentTransforms.accent6.blueMod",
                    path + ".accentTransforms.accent6.blueMod");
                var transformValue = checked((uint)Math.Round(blueModFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent6", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasBlueModulationThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent6.blueMod", "source-bound accent6 blueMod requires one imported direct blueMod");
                authoredTransform.BlueModulationThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent6", out var beforeAccent6BlueOff) &&
                     afterAccentTransforms.TryGetProperty("accent6", out var afterAccent6BlueOff) &&
                     PropertyChanged(beforeAccent6BlueOff, afterAccent6BlueOff, "blueOff"))
            {
                var changedTransformNames = beforeAccent6BlueOff.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent6BlueOff.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent6BlueOff, afterAccent6BlueOff, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("blueOff", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent6", "source-bound accent6 requires exactly one changed blueOff field");
                if (!afterAccent6BlueOff.TryGetProperty("blueOff", out var blueOff) ||
                    blueOff.ValueKind != JsonValueKind.Number ||
                    !blueOff.TryGetDouble(out var blueOffFraction) ||
                    !double.IsFinite(blueOffFraction) || blueOffFraction < -1 || blueOffFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent6.blueOff", "source-bound accent6 blueOff must be a finite fraction from -1 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent6.blueOff", "the source did not issue an accent6-blueOff capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent6BlueOff",
                    "accentTransforms.accent6.blueOff",
                    path + ".accentTransforms.accent6.blueOff");
                var transformValue = checked((int)Math.Round(blueOffFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent6", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasBlueOffsetThousandth ||
                    ...
                    authoredTransform.HasRedOffsetThousandth ||
                    authoredTransform.HasGreenModulationThousandth ||
                    authoredTransform.HasBlueModulationThousandth || authoredTransform.HasGreenOffsetThousandth ||
                    authoredTransform.HasHueModulationThousandth || authoredTransform.HasHueOffsetAngleThousandth ||
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent6.blueOff", "source-bound accent6 blueOff requires one imported direct blueOff");
                authoredTransform.BlueOffsetThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent6", out var beforeAccent6HueMod) &&
                     afterAccentTransforms.TryGetProperty("accent6", out var afterAccent6HueMod) &&
                     PropertyChanged(beforeAccent6HueMod, afterAccent6HueMod, "hueMod"))
            {
                var changedTransformNames = beforeAccent6HueMod.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent6HueMod.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent6HueMod, afterAccent6HueMod, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("hueMod", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent6", "source-bound accent6 requires exactly one changed hueMod field");
                if (!afterAccent6HueMod.TryGetProperty("hueMod", out var hueMod) ||
                    hueMod.ValueKind != JsonValueKind.Number ||
                    !hueMod.TryGetDouble(out var hueModFraction) ||
                    !double.IsFinite(hueModFraction) || hueModFraction < 0 || hueModFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent6.hueMod", "source-bound accent6 hueMod must be a finite fraction from 0 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent6.hueMod", "the source did not issue an accent6-hueMod capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent6HueMod",
                    "accentTransforms.accent6.hueMod",
                    path + ".accentTransforms.accent6.hueMod");
                var transformValue = checked((uint)Math.Round(hueModFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent6", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasHueModulationThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent6.hueMod", "source-bound accent6 hueMod requires one imported direct hueMod");
                authoredTransform.HueModulationThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent6", out var beforeAccent6HueOff) &&
                     afterAccentTransforms.TryGetProperty("accent6", out var afterAccent6HueOff) &&
                     PropertyChanged(beforeAccent6HueOff, afterAccent6HueOff, "hueOff"))
            {
                var changedTransformNames = beforeAccent6HueOff.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent6HueOff.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent6HueOff, afterAccent6HueOff, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("hueOff", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent6", "source-bound accent6 requires exactly one changed hueOff field");
                if (!afterAccent6HueOff.TryGetProperty("hueOff", out var hueOff) ||
                    hueOff.ValueKind != JsonValueKind.Number ||
                    !hueOff.TryGetDouble(out var hueOffDegrees) ||
                    !double.IsFinite(hueOffDegrees) || hueOffDegrees < -360 || hueOffDegrees > 360)
                    throw Unsupported(path + ".accentTransforms.accent6.hueOff", "source-bound accent6 hueOff must be a finite degree offset from -360 through 360");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent6.hueOff", "the source did not issue an accent6-hueOff capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent6HueOff",
                    "accentTransforms.accent6.hueOff",
                    path + ".accentTransforms.accent6.hueOff");
                var transformValue = checked((int)Math.Round(hueOffDegrees * 60_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent6", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasHueOffsetAngleThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent6.hueOff", "source-bound accent6 hueOff requires one imported direct hueOff");
                authoredTransform.HueOffsetAngleThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            ...
            {
                var changedTransformNames = beforeAccent4.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent4.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent4, afterAccent4, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("tint", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent4", "source-bound accent4 requires exactly one changed tint field");
                if (!afterAccent4.TryGetProperty("tint", out var tint) ||
                    tint.ValueKind != JsonValueKind.Number ||
                    !tint.TryGetDouble(out var tintFraction) ||
                    !double.IsFinite(tintFraction) || tintFraction < 0 || tintFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent4.tint", "source-bound accent4 tint must be a finite fraction from 0 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent4.tint", "the source did not issue an accent4-tint capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent4Tint",
                    "accentTransforms.accent4.tint",
                    path + ".accentTransforms.accent4.tint");
                var transformValue = checked((uint)Math.Round(tintFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent4", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasTintThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent4.tint", "source-bound accent4 tint requires one imported direct tint");
                authoredTransform.TintThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent5", out var beforeAccent5Shade) &&
                afterAccentTransforms.TryGetProperty("accent5", out var afterAccent5Shade) &&
                PropertyChanged(beforeAccent5Shade, afterAccent5Shade, "shade"))
            {
                var changedTransformNames = beforeAccent5Shade.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent5Shade.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent5Shade, afterAccent5Shade, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("shade", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent5", "source-bound accent5 requires exactly one changed shade field");
                if (!afterAccent5Shade.TryGetProperty("shade", out var shade) ||
                    shade.ValueKind != JsonValueKind.Number ||
                    !shade.TryGetDouble(out var shadeFraction) ||
                    !double.IsFinite(shadeFraction) || shadeFraction < 0 || shadeFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent5.shade", "source-bound accent5 shade must be a finite fraction from 0 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent5.shade", "the source did not issue an accent5-shade capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent5Shade",
                    "accentTransforms.accent5.shade",
                    path + ".accentTransforms.accent5.shade");
                var transformValue = checked((uint)Math.Round(shadeFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent5", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasShadeThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent5.shade", "source-bound accent5 shade requires one imported direct shade");
                authoredTransform.ShadeThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent4", out var beforeAccent4Shade) &&
                afterAccentTransforms.TryGetProperty("accent4", out var afterAccent4Shade) &&
                PropertyChanged(beforeAccent4Shade, afterAccent4Shade, "shade"))
            {
                var changedTransformNames = beforeAccent4Shade.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent4Shade.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent4Shade, afterAccent4Shade, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("shade", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent4", "source-bound accent4 requires exactly one changed shade field");
                if (!afterAccent4Shade.TryGetProperty("shade", out var shade) ||
                    shade.ValueKind != JsonValueKind.Number ||
                    !shade.TryGetDouble(out var shadeFraction) ||
                    !double.IsFinite(shadeFraction) || shadeFraction < 0 || shadeFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent4.shade", "source-bound accent4 shade must be a finite fraction from 0 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent4.shade", "the source did not issue an accent4-shade capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent4Shade",
                    "accentTransforms.accent4.shade",
                    path + ".accentTransforms.accent4.shade");
                var transformValue = checked((uint)Math.Round(shadeFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent4", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasShadeThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent4.shade", "source-bound accent4 shade requires one imported direct shade");
                authoredTransform.ShadeThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent5", out var beforeAccent5LumMod) &&
                     afterAccentTransforms.TryGetProperty("accent5", out var afterAccent5LumMod) &&
                     PropertyChanged(beforeAccent5LumMod, afterAccent5LumMod, "lumMod"))
            {
                var changedTransformNames = beforeAccent5LumMod.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent5LumMod.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent5LumMod, afterAccent5LumMod, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("lumMod", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent5", "source-bound accent5 requires exactly one changed lumMod field");
                if (!afterAccent5LumMod.TryGetProperty("lumMod", out var lumMod) ||
                    lumMod.ValueKind != JsonValueKind.Number ||
                    !lumMod.TryGetDouble(out var lumModFraction) ||
                    !double.IsFinite(lumModFraction) || lumModFraction < 0 || lumModFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent5.lumMod", "source-bound accent5 lumMod must be a finite fraction from 0 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent5.lumMod", "the source did not issue an accent5-lumMod capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent5LumMod",
                    "accentTransforms.accent5.lumMod",
                    path + ".accentTransforms.accent5.lumMod");
                var transformValue = checked((uint)Math.Round(lumModFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent5", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasLuminanceModulationThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent5.lumMod", "source-bound accent5 lumMod requires one imported direct lumMod");
                authoredTransform.LuminanceModulationThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent4", out var beforeAccent4LumMod) &&
                     afterAccentTransforms.TryGetProperty("accent4", out var afterAccent4LumMod) &&
                     PropertyChanged(beforeAccent4LumMod, afterAccent4LumMod, "lumMod"))
            {
                var changedTransformNames = beforeAccent4LumMod.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent4LumMod.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent4LumMod, afterAccent4LumMod, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("lumMod", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent4", "source-bound accent4 requires exactly one changed lumMod field");
                if (!afterAccent4LumMod.TryGetProperty("lumMod", out var lumMod) ||
                    lumMod.ValueKind != JsonValueKind.Number ||
                    !lumMod.TryGetDouble(out var lumModFraction) ||
                    !double.IsFinite(lumModFraction) || lumModFraction < 0 || lumModFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent4.lumMod", "source-bound accent4 lumMod must be a finite fraction from 0 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent4.lumMod", "the source did not issue an accent4-lumMod capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent4LumMod",
                    "accentTransforms.accent4.lumMod",
                    path + ".accentTransforms.accent4.lumMod");
                var transformValue = checked((uint)Math.Round(lumModFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent4", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasLuminanceModulationThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent4.lumMod", "source-bound accent4 lumMod requires one imported direct lumMod");
                authoredTransform.LuminanceModulationThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent5", out var beforeAccent5LumOff) &&
                     afterAccentTransforms.TryGetProperty("accent5", out var afterAccent5LumOff) &&
                     PropertyChanged(beforeAccent5LumOff, afterAccent5LumOff, "lumOff"))
            {
                var changedTransformNames = beforeAccent5LumOff.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent5LumOff.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent5LumOff, afterAccent5LumOff, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("lumOff", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent5", "source-bound accent5 requires exactly one changed lumOff field");
                if (!afterAccent5LumOff.TryGetProperty("lumOff", out var lumOff) ||
                    lumOff.ValueKind != JsonValueKind.Number ||
                    !lumOff.TryGetDouble(out var lumOffFraction) ||
                    !double.IsFinite(lumOffFraction) || lumOffFraction < -1 || lumOffFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent5.lumOff", "source-bound accent5 lumOff must be a finite fraction from -1 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent5.lumOff", "the source did not issue an accent5-lumOff capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent5LumOff",
                    "accentTransforms.accent5.lumOff",
                    path + ".accentTransforms.accent5.lumOff");
                var transformValue = checked((int)Math.Round(lumOffFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent5", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasLuminanceOffsetThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent5.lumOff", "source-bound accent5 lumOff requires one imported direct lumOff");
                authoredTransform.LuminanceOffsetThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent5", out var beforeAccent5AlphaMod) &&
                     afterAccentTransforms.TryGetProperty("accent5", out var afterAccent5AlphaMod) &&
                     PropertyChanged(beforeAccent5AlphaMod, afterAccent5AlphaMod, "alphaMod"))
            {
                var changedTransformNames = beforeAccent5AlphaMod.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent5AlphaMod.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent5AlphaMod, afterAccent5AlphaMod, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("alphaMod", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent5", "source-bound accent5 requires exactly one changed alphaMod field");
                if (!afterAccent5AlphaMod.TryGetProperty("alphaMod", out var alphaMod) ||
                    alphaMod.ValueKind != JsonValueKind.Number ||
                    !alphaMod.TryGetDouble(out var alphaModFraction) ||
                    !double.IsFinite(alphaModFraction) || alphaModFraction < 0 || alphaModFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent5.alphaMod", "source-bound accent5 alphaMod must be a finite fraction from 0 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent5.alphaMod", "the source did not issue an accent5-alphaMod capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent5AlphaMod",
                    "accentTransforms.accent5.alphaMod",
                    path + ".accentTransforms.accent5.alphaMod");
                var transformValue = checked((uint)Math.Round(alphaModFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent5", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasAlphaModulationThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent5.alphaMod", "source-bound accent5 alphaMod requires one imported direct alphaMod");
                authoredTransform.AlphaModulationThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent5", out var beforeAccent5AlphaOff) &&
                     afterAccentTransforms.TryGetProperty("accent5", out var afterAccent5AlphaOff) &&
                     PropertyChanged(beforeAccent5AlphaOff, afterAccent5AlphaOff, "alphaOff"))
            {
                var changedTransformNames = beforeAccent5AlphaOff.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent5AlphaOff.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent5AlphaOff, afterAccent5AlphaOff, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("alphaOff", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent5", "source-bound accent5 requires exactly one changed alphaOff field");
                if (!afterAccent5AlphaOff.TryGetProperty("alphaOff", out var alphaOff) ||
                    alphaOff.ValueKind != JsonValueKind.Number ||
                    !alphaOff.TryGetDouble(out var alphaOffFraction) ||
                    !double.IsFinite(alphaOffFraction) || alphaOffFraction < -1 || alphaOffFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent5.alphaOff", "source-bound accent5 alphaOff must be a finite fraction from -1 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent5.alphaOff", "the source did not issue an accent5-alphaOff capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent5AlphaOff",
                    "accentTransforms.accent5.alphaOff",
                    path + ".accentTransforms.accent5.alphaOff");
                var transformValue = checked((int)Math.Round(alphaOffFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent5", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasAlphaOffsetThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent5.alphaOff", "source-bound accent5 alphaOff requires one imported direct alphaOff");
                authoredTransform.AlphaOffsetThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent5", out var beforeAccent5SatMod) &&
                     afterAccentTransforms.TryGetProperty("accent5", out var afterAccent5SatMod) &&
                     PropertyChanged(beforeAccent5SatMod, afterAccent5SatMod, "satMod"))
            {
                var changedTransformNames = beforeAccent5SatMod.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent5SatMod.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent5SatMod, afterAccent5SatMod, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("satMod", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent5", "source-bound accent5 requires exactly one changed satMod field");
                if (!afterAccent5SatMod.TryGetProperty("satMod", out var satMod) ||
                    satMod.ValueKind != JsonValueKind.Number ||
                    !satMod.TryGetDouble(out var satModFraction) ||
                    !double.IsFinite(satModFraction) || satModFraction < 0 || satModFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent5.satMod", "source-bound accent5 satMod must be a finite fraction from 0 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent5.satMod", "the source did not issue an accent5-satMod capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent5SatMod",
                    "accentTransforms.accent5.satMod",
                    path + ".accentTransforms.accent5.satMod");
                var transformValue = checked((uint)Math.Round(satModFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent5", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasSaturationModulationThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent5.satMod", "source-bound accent5 satMod requires one imported direct satMod");
                authoredTransform.SaturationModulationThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent5", out var beforeAccent5SatOff) &&
                     afterAccentTransforms.TryGetProperty("accent5", out var afterAccent5SatOff) &&
                     PropertyChanged(beforeAccent5SatOff, afterAccent5SatOff, "satOff"))
            {
                var changedTransformNames = beforeAccent5SatOff.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent5SatOff.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent5SatOff, afterAccent5SatOff, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("satOff", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent5", "source-bound accent5 requires exactly one changed satOff field");
                if (!afterAccent5SatOff.TryGetProperty("satOff", out var satOff) ||
                    satOff.ValueKind != JsonValueKind.Number ||
                    !satOff.TryGetDouble(out var satOffFraction) ||
                    !double.IsFinite(satOffFraction) || satOffFraction < -1 || satOffFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent5.satOff", "source-bound accent5 satOff must be a finite fraction from -1 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent5.satOff", "the source did not issue an accent5-satOff capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent5SatOff",
                    "accentTransforms.accent5.satOff",
                    path + ".accentTransforms.accent5.satOff");
                var transformValue = checked((int)Math.Round(satOffFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent5", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasSaturationOffsetThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent5.satOff", "source-bound accent5 satOff requires one imported direct satOff");
                authoredTransform.SaturationOffsetThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent5", out var beforeAccent5RedMod) &&
                     afterAccentTransforms.TryGetProperty("accent5", out var afterAccent5RedMod) &&
                     PropertyChanged(beforeAccent5RedMod, afterAccent5RedMod, "redMod"))
            {
                var changedTransformNames = beforeAccent5RedMod.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent5RedMod.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent5RedMod, afterAccent5RedMod, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("redMod", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent5", "source-bound accent5 requires exactly one changed redMod field");
                if (!afterAccent5RedMod.TryGetProperty("redMod", out var redMod) ||
                    redMod.ValueKind != JsonValueKind.Number ||
                    !redMod.TryGetDouble(out var redModFraction) ||
                    !double.IsFinite(redModFraction) || redModFraction < 0 || redModFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent5.redMod", "source-bound accent5 redMod must be a finite fraction from 0 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent5.redMod", "the source did not issue an accent5-redMod capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent5RedMod",
                    "accentTransforms.accent5.redMod",
                    path + ".accentTransforms.accent5.redMod");
                var transformValue = checked((uint)Math.Round(redModFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent5", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasRedModulationThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent5.redMod", "source-bound accent5 redMod requires one imported direct redMod");
                authoredTransform.RedModulationThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent5", out var beforeAccent5RedOff) &&
                     afterAccentTransforms.TryGetProperty("accent5", out var afterAccent5RedOff) &&
                     PropertyChanged(beforeAccent5RedOff, afterAccent5RedOff, "redOff"))
            {
                var changedTransformNames = beforeAccent5RedOff.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent5RedOff.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent5RedOff, afterAccent5RedOff, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("redOff", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent5", "source-bound accent5 requires exactly one changed redOff field");
                if (!afterAccent5RedOff.TryGetProperty("redOff", out var redOff) ||
                    redOff.ValueKind != JsonValueKind.Number ||
                    !redOff.TryGetDouble(out var redOffFraction) ||
                    !double.IsFinite(redOffFraction) || redOffFraction < -1 || redOffFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent5.redOff", "source-bound accent5 redOff must be a finite fraction from -1 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent5.redOff", "the source did not issue an accent5-redOff capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent5RedOff",
                    "accentTransforms.accent5.redOff",
                    path + ".accentTransforms.accent5.redOff");
                var transformValue = checked((int)Math.Round(redOffFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent5", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasRedOffsetThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent5.redOff", "source-bound accent5 redOff requires one imported direct redOff");
                authoredTransform.RedOffsetThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent5", out var beforeAccent5GreenMod) &&
                     afterAccentTransforms.TryGetProperty("accent5", out var afterAccent5GreenMod) &&
                     PropertyChanged(beforeAccent5GreenMod, afterAccent5GreenMod, "greenMod"))
            {
                var changedTransformNames = beforeAccent5GreenMod.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent5GreenMod.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent5GreenMod, afterAccent5GreenMod, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("greenMod", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent5", "source-bound accent5 requires exactly one changed greenMod field");
                if (!afterAccent5GreenMod.TryGetProperty("greenMod", out var greenMod) ||
                    greenMod.ValueKind != JsonValueKind.Number ||
                    !greenMod.TryGetDouble(out var greenModFraction) ||
                    !double.IsFinite(greenModFraction) || greenModFraction < 0 || greenModFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent5.greenMod", "source-bound accent5 greenMod must be a finite fraction from 0 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent5.greenMod", "the source did not issue an accent5-greenMod capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent5GreenMod",
                    "accentTransforms.accent5.greenMod",
                    path + ".accentTransforms.accent5.greenMod");
                var transformValue = checked((uint)Math.Round(greenModFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent5", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasGreenModulationThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent5.greenMod", "source-bound accent5 greenMod requires one imported direct greenMod");
                authoredTransform.GreenModulationThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent5", out var beforeAccent5GreenOff) &&
                     afterAccentTransforms.TryGetProperty("accent5", out var afterAccent5GreenOff) &&
                     PropertyChanged(beforeAccent5GreenOff, afterAccent5GreenOff, "greenOff"))
            {
                var changedTransformNames = beforeAccent5GreenOff.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent5GreenOff.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent5GreenOff, afterAccent5GreenOff, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("greenOff", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent5", "source-bound accent5 requires exactly one changed greenOff field");
                if (!afterAccent5GreenOff.TryGetProperty("greenOff", out var greenOff) ||
                    greenOff.ValueKind != JsonValueKind.Number ||
                    !greenOff.TryGetDouble(out var greenOffFraction) ||
                    !double.IsFinite(greenOffFraction) || greenOffFraction < -1 || greenOffFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent5.greenOff", "source-bound accent5 greenOff must be a finite fraction from -1 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent5.greenOff", "the source did not issue an accent5-greenOff capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent5GreenOff",
                    "accentTransforms.accent5.greenOff",
                    path + ".accentTransforms.accent5.greenOff");
                var transformValue = checked((int)Math.Round(greenOffFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent5", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasGreenOffsetThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent5.greenOff", "source-bound accent5 greenOff requires one imported direct greenOff");
                authoredTransform.GreenOffsetThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent5", out var beforeAccent5BlueMod) &&
                     afterAccentTransforms.TryGetProperty("accent5", out var afterAccent5BlueMod) &&
                     PropertyChanged(beforeAccent5BlueMod, afterAccent5BlueMod, "blueMod"))
            {
                var changedTransformNames = beforeAccent5BlueMod.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent5BlueMod.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent5BlueMod, afterAccent5BlueMod, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("blueMod", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent5", "source-bound accent5 requires exactly one changed blueMod field");
                if (!afterAccent5BlueMod.TryGetProperty("blueMod", out var blueMod) ||
                    blueMod.ValueKind != JsonValueKind.Number ||
                    !blueMod.TryGetDouble(out var blueModFraction) ||
                    !double.IsFinite(blueModFraction) || blueModFraction < 0 || blueModFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent5.blueMod", "source-bound accent5 blueMod must be a finite fraction from 0 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent5.blueMod", "the source did not issue an accent5-blueMod capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent5BlueMod",
                    "accentTransforms.accent5.blueMod",
                    path + ".accentTransforms.accent5.blueMod");
                var transformValue = checked((uint)Math.Round(blueModFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent5", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasBlueModulationThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent5.blueMod", "source-bound accent5 blueMod requires one imported direct blueMod");
                authoredTransform.BlueModulationThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent5", out var beforeAccent5BlueOff) &&
                     afterAccentTransforms.TryGetProperty("accent5", out var afterAccent5BlueOff) &&
                     PropertyChanged(beforeAccent5BlueOff, afterAccent5BlueOff, "blueOff"))
            {
                var changedTransformNames = beforeAccent5BlueOff.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent5BlueOff.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent5BlueOff, afterAccent5BlueOff, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("blueOff", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent5", "source-bound accent5 requires exactly one changed blueOff field");
                if (!afterAccent5BlueOff.TryGetProperty("blueOff", out var blueOff) ||
                    blueOff.ValueKind != JsonValueKind.Number ||
                    !blueOff.TryGetDouble(out var blueOffFraction) ||
                    !double.IsFinite(blueOffFraction) || blueOffFraction < -1 || blueOffFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent5.blueOff", "source-bound accent5 blueOff must be a finite fraction from -1 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent5.blueOff", "the source did not issue an accent5-blueOff capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent5BlueOff",
                    "accentTransforms.accent5.blueOff",
                    path + ".accentTransforms.accent5.blueOff");
                var transformValue = checked((int)Math.Round(blueOffFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent5", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasBlueOffsetThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent5.blueOff", "source-bound accent5 blueOff requires one imported direct blueOff");
                authoredTransform.BlueOffsetThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            ...
            else if (beforeAccentTransforms.TryGetProperty("accent5", out var beforeAccent5HueOff) &&
                     afterAccentTransforms.TryGetProperty("accent5", out var afterAccent5HueOff) &&
                     PropertyChanged(beforeAccent5HueOff, afterAccent5HueOff, "hueOff"))
            {
                var changedTransformNames = beforeAccent5HueOff.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent5HueOff.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent5HueOff, afterAccent5HueOff, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("hueOff", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent5", "source-bound accent5 requires exactly one changed hueOff field");
                if (!afterAccent5HueOff.TryGetProperty("hueOff", out var hueOff) ||
                    hueOff.ValueKind != JsonValueKind.Number ||
                    !hueOff.TryGetDouble(out var hueOffDegrees) ||
                    !double.IsFinite(hueOffDegrees) || hueOffDegrees < -360 || hueOffDegrees > 360)
                    throw Unsupported(path + ".accentTransforms.accent5.hueOff", "source-bound accent5 hueOff must be a finite degree offset from -360 through 360");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent5.hueOff", "the source did not issue an accent5-hueOff capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent5HueOff",
                    "accentTransforms.accent5.hueOff",
                    path + ".accentTransforms.accent5.hueOff");
                var transformValue = checked((int)Math.Round(hueOffDegrees * 60_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent5", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasHueOffsetAngleThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent5.hueOff", "source-bound accent5 hueOff requires one imported direct hueOff");
                authoredTransform.HueOffsetAngleThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            ...
            {
                var changedTransformNames = beforeAccent4LumOff.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent4LumOff.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent4LumOff, afterAccent4LumOff, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("lumOff", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent4", "source-bound accent4 requires exactly one changed lumOff field");
                if (!afterAccent4LumOff.TryGetProperty("lumOff", out var lumOff) ||
                    lumOff.ValueKind != JsonValueKind.Number ||
                    !lumOff.TryGetDouble(out var lumOffFraction) ||
                    !double.IsFinite(lumOffFraction) || lumOffFraction < -1 || lumOffFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent4.lumOff", "source-bound accent4 lumOff must be a finite fraction from -1 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent4.lumOff", "the source did not issue an accent4-lumOff capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent4LumOff",
                    "accentTransforms.accent4.lumOff",
                    path + ".accentTransforms.accent4.lumOff");
                var transformValue = checked((int)Math.Round(lumOffFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent4", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasLuminanceOffsetThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent4.lumOff", "source-bound accent4 lumOff requires one imported direct lumOff");
                authoredTransform.LuminanceOffsetThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent4", out var beforeAccent4AlphaMod) &&
                     afterAccentTransforms.TryGetProperty("accent4", out var afterAccent4AlphaMod) &&
                     PropertyChanged(beforeAccent4AlphaMod, afterAccent4AlphaMod, "alphaMod"))
            {
                var changedTransformNames = beforeAccent4AlphaMod.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent4AlphaMod.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent4AlphaMod, afterAccent4AlphaMod, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("alphaMod", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent4", "source-bound accent4 requires exactly one changed alphaMod field");
                if (!afterAccent4AlphaMod.TryGetProperty("alphaMod", out var alphaMod) ||
                    alphaMod.ValueKind != JsonValueKind.Number ||
                    !alphaMod.TryGetDouble(out var alphaModFraction) ||
                    !double.IsFinite(alphaModFraction) || alphaModFraction < 0 || alphaModFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent4.alphaMod", "source-bound accent4 alphaMod must be a finite fraction from 0 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent4.alphaMod", "the source did not issue an accent4-alphaMod capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent4AlphaMod",
                    "accentTransforms.accent4.alphaMod",
                    path + ".accentTransforms.accent4.alphaMod");
                var transformValue = checked((uint)Math.Round(alphaModFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent4", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasAlphaModulationThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent4.alphaMod", "source-bound accent4 alphaMod requires one imported direct alphaMod");
                authoredTransform.AlphaModulationThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent4", out var beforeAccent4AlphaOff) &&
                     afterAccentTransforms.TryGetProperty("accent4", out var afterAccent4AlphaOff) &&
                     PropertyChanged(beforeAccent4AlphaOff, afterAccent4AlphaOff, "alphaOff"))
            {
                var changedTransformNames = beforeAccent4AlphaOff.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent4AlphaOff.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent4AlphaOff, afterAccent4AlphaOff, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("alphaOff", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent4", "source-bound accent4 requires exactly one changed alphaOff field");
                if (!afterAccent4AlphaOff.TryGetProperty("alphaOff", out var alphaOff) ||
                    alphaOff.ValueKind != JsonValueKind.Number ||
                    !alphaOff.TryGetDouble(out var alphaOffFraction) ||
                    !double.IsFinite(alphaOffFraction) || alphaOffFraction < -1 || alphaOffFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent4.alphaOff", "source-bound accent4 alphaOff must be a finite fraction from -1 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent4.alphaOff", "the source did not issue an accent4-alphaOff capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent4AlphaOff",
                    "accentTransforms.accent4.alphaOff",
                    path + ".accentTransforms.accent4.alphaOff");
                var transformValue = checked((int)Math.Round(alphaOffFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent4", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasAlphaOffsetThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent4.alphaOff", "source-bound accent4 alphaOff requires one imported direct alphaOff");
                authoredTransform.AlphaOffsetThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent4", out var beforeAccent4SatMod) &&
                     afterAccentTransforms.TryGetProperty("accent4", out var afterAccent4SatMod) &&
                     PropertyChanged(beforeAccent4SatMod, afterAccent4SatMod, "satMod"))
            {
                var changedTransformNames = beforeAccent4SatMod.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent4SatMod.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent4SatMod, afterAccent4SatMod, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("satMod", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent4", "source-bound accent4 requires exactly one changed satMod field");
                if (!afterAccent4SatMod.TryGetProperty("satMod", out var satMod) ||
                    satMod.ValueKind != JsonValueKind.Number ||
                    !satMod.TryGetDouble(out var satModFraction) ||
                    !double.IsFinite(satModFraction) || satModFraction < 0 || satModFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent4.satMod", "source-bound accent4 satMod must be a finite fraction from 0 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent4.satMod", "the source did not issue an accent4-satMod capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent4SatMod",
                    "accentTransforms.accent4.satMod",
                    path + ".accentTransforms.accent4.satMod");
                var transformValue = checked((uint)Math.Round(satModFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent4", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasSaturationModulationThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent4.satMod", "source-bound accent4 satMod requires one imported direct satMod");
                authoredTransform.SaturationModulationThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent4", out var beforeAccent4SatOff) &&
                     afterAccentTransforms.TryGetProperty("accent4", out var afterAccent4SatOff) &&
                     PropertyChanged(beforeAccent4SatOff, afterAccent4SatOff, "satOff"))
            {
                var changedTransformNames = beforeAccent4SatOff.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent4SatOff.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent4SatOff, afterAccent4SatOff, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("satOff", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent4", "source-bound accent4 requires exactly one changed satOff field");
                if (!afterAccent4SatOff.TryGetProperty("satOff", out var satOff) ||
                    satOff.ValueKind != JsonValueKind.Number ||
                    !satOff.TryGetDouble(out var satOffFraction) ||
                    !double.IsFinite(satOffFraction) || satOffFraction < -1 || satOffFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent4.satOff", "source-bound accent4 satOff must be a finite fraction from -1 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent4.satOff", "the source did not issue an accent4-satOff capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent4SatOff",
                    "accentTransforms.accent4.satOff",
                    path + ".accentTransforms.accent4.satOff");
                var transformValue = checked((int)Math.Round(satOffFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent4", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasSaturationOffsetThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent4.satOff", "source-bound accent4 satOff requires one imported direct satOff");
                authoredTransform.SaturationOffsetThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent4", out var beforeAccent4RedMod) &&
                     afterAccentTransforms.TryGetProperty("accent4", out var afterAccent4RedMod) &&
                     PropertyChanged(beforeAccent4RedMod, afterAccent4RedMod, "redMod"))
            {
                var changedTransformNames = beforeAccent4RedMod.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent4RedMod.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent4RedMod, afterAccent4RedMod, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("redMod", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent4", "source-bound accent4 requires exactly one changed redMod field");
                if (!afterAccent4RedMod.TryGetProperty("redMod", out var redMod) ||
                    redMod.ValueKind != JsonValueKind.Number ||
                    !redMod.TryGetDouble(out var redModFraction) ||
                    !double.IsFinite(redModFraction) || redModFraction < 0 || redModFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent4.redMod", "source-bound accent4 redMod must be a finite fraction from 0 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent4.redMod", "the source did not issue an accent4-redMod capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent4RedMod",
                    "accentTransforms.accent4.redMod",
                    path + ".accentTransforms.accent4.redMod");
                var transformValue = checked((uint)Math.Round(redModFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent4", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasRedModulationThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent4.redMod", "source-bound accent4 redMod requires one imported direct redMod");
                authoredTransform.RedModulationThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent4", out var beforeAccent4GreenMod) &&
                     afterAccentTransforms.TryGetProperty("accent4", out var afterAccent4GreenMod) &&
                     PropertyChanged(beforeAccent4GreenMod, afterAccent4GreenMod, "greenMod"))
            {
                var changedTransformNames = beforeAccent4GreenMod.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent4GreenMod.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent4GreenMod, afterAccent4GreenMod, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("greenMod", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent4", "source-bound accent4 requires exactly one changed greenMod field");
                if (!afterAccent4GreenMod.TryGetProperty("greenMod", out var greenMod) ||
                    greenMod.ValueKind != JsonValueKind.Number ||
                    !greenMod.TryGetDouble(out var greenModFraction) ||
                    !double.IsFinite(greenModFraction) || greenModFraction < 0 || greenModFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent4.greenMod", "source-bound accent4 greenMod must be a finite fraction from 0 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent4.greenMod", "the source did not issue an accent4-greenMod capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent4GreenMod",
                    "accentTransforms.accent4.greenMod",
                    path + ".accentTransforms.accent4.greenMod");
                var transformValue = checked((uint)Math.Round(greenModFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent4", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasGreenModulationThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent4.greenMod", "source-bound accent4 greenMod requires one imported direct greenMod");
                authoredTransform.GreenModulationThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            ...
            else if (beforeAccentTransforms.TryGetProperty("accent4", out var beforeAccent4HueMod) &&
                     afterAccentTransforms.TryGetProperty("accent4", out var afterAccent4HueMod) &&
                     PropertyChanged(beforeAccent4HueMod, afterAccent4HueMod, "hueMod"))
            {
                var changedTransformNames = beforeAccent4HueMod.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent4HueMod.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent4HueMod, afterAccent4HueMod, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("hueMod", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent4", "source-bound accent4 requires exactly one changed hueMod field");
                if (!afterAccent4HueMod.TryGetProperty("hueMod", out var hueMod) ||
                    hueMod.ValueKind != JsonValueKind.Number ||
                    !hueMod.TryGetDouble(out var hueModFraction) ||
                    !double.IsFinite(hueModFraction) || hueModFraction < 0 || hueModFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent4.hueMod", "source-bound accent4 hueMod must be a finite fraction from 0 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent4.hueMod", "the source did not issue an accent4-hueMod capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent4HueMod",
                    "accentTransforms.accent4.hueMod",
                    path + ".accentTransforms.accent4.hueMod");
                var transformValue = checked((uint)Math.Round(hueModFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent4", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasHueModulationThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent4.hueMod", "source-bound accent4 hueMod requires one imported direct hueMod");
                authoredTransform.HueModulationThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent4", out var beforeAccent4BlueOff) &&
                     afterAccentTransforms.TryGetProperty("accent4", out var afterAccent4BlueOff) &&
                     PropertyChanged(beforeAccent4BlueOff, afterAccent4BlueOff, "blueOff"))
            {
                var changedTransformNames = beforeAccent4BlueOff.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent4BlueOff.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent4BlueOff, afterAccent4BlueOff, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("blueOff", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent4", "source-bound accent4 requires exactly one changed blueOff field");
                if (!afterAccent4BlueOff.TryGetProperty("blueOff", out var blueOff) ||
                    blueOff.ValueKind != JsonValueKind.Number ||
                    !blueOff.TryGetDouble(out var blueOffFraction) ||
                    !double.IsFinite(blueOffFraction) || blueOffFraction < -1 || blueOffFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent4.blueOff", "source-bound accent4 blueOff must be a finite fraction from -1 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent4.blueOff", "the source did not issue an accent4-blueOff capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent4BlueOff",
                    "accentTransforms.accent4.blueOff",
                    path + ".accentTransforms.accent4.blueOff");
                var transformValue = checked((int)Math.Round(blueOffFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent4", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasBlueOffsetThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent4.blueOff", "source-bound accent4 blueOff requires one imported direct blueOff");
                authoredTransform.BlueOffsetThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            ...
            {
                var changedTransformNames = beforeAccent4GreenOff.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent4GreenOff.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent4GreenOff, afterAccent4GreenOff, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("greenOff", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent4", "source-bound accent4 requires exactly one changed greenOff field");
                if (!afterAccent4GreenOff.TryGetProperty("greenOff", out var greenOff) ||
                    greenOff.ValueKind != JsonValueKind.Number ||
                    !greenOff.TryGetDouble(out var greenOffFraction) ||
                    !double.IsFinite(greenOffFraction) || greenOffFraction < -1 || greenOffFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent4.greenOff", "source-bound accent4 greenOff must be a finite fraction from -1 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent4.greenOff", "the source did not issue an accent4-greenOff capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent4GreenOff",
                    "accentTransforms.accent4.greenOff",
                    path + ".accentTransforms.accent4.greenOff");
                var transformValue = checked((int)Math.Round(greenOffFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent4", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasGreenOffsetThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent4.greenOff", "source-bound accent4 greenOff requires one imported direct greenOff");
                authoredTransform.GreenOffsetThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            else if (beforeAccentTransforms.TryGetProperty("accent4", out var beforeAccent4RedOff) &&
                     afterAccentTransforms.TryGetProperty("accent4", out var afterAccent4RedOff) &&
                     PropertyChanged(beforeAccent4RedOff, afterAccent4RedOff, "redOff"))
            {
                var changedTransformNames = beforeAccent4RedOff.EnumerateObject().Select(property => property.Name)
                    .Concat(afterAccent4RedOff.EnumerateObject().Select(property => property.Name))
                    .Distinct(StringComparer.Ordinal)
                    .Where(name => PropertyChanged(beforeAccent4RedOff, afterAccent4RedOff, name))
                    .ToArray();
                if (changedTransformNames.Length != 1 || !changedTransformNames[0].Equals("redOff", StringComparison.Ordinal))
                    throw Unsupported(path + ".accentTransforms.accent4", "source-bound accent4 requires exactly one changed redOff field");
                if (!afterAccent4RedOff.TryGetProperty("redOff", out var redOff) ||
                    redOff.ValueKind != JsonValueKind.Number ||
                    !redOff.TryGetDouble(out var redOffFraction) ||
                    !double.IsFinite(redOffFraction) || redOffFraction < -1 || redOffFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent4.redOff", "source-bound accent4 redOff must be a finite fraction from -1 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent4.redOff", "the source did not issue an accent4-redOff capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent4RedOff",
                    "accentTransforms.accent4.redOff",
                    path + ".accentTransforms.accent4.redOff");
                var transformValue = checked((int)Math.Round(redOffFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent4", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasRedOffsetThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent4.redOff", "source-bound accent4 redOff requires one imported direct redOff");
                authoredTransform.RedOffsetThousandth = transformValue;
                mutations.SemanticChanges = true;
                changed = true;
            }
            ...
            var lumOffChanged = PropertyChanged(beforeAccent1, afterAccent1, "lumOff");
            var alphaModChanged = PropertyChanged(beforeAccent1, afterAccent1, "alphaMod");
            var alphaOffChanged = PropertyChanged(beforeAccent1, afterAccent1, "alphaOff");
            var satModChanged = PropertyChanged(beforeAccent1, afterAccent1, "satMod");
            var satOffChanged = PropertyChanged(beforeAccent1, afterAccent1, "satOff");
            var redModChanged = PropertyChanged(beforeAccent1, afterAccent1, "redMod");
            var redOffChanged = PropertyChanged(beforeAccent1, afterAccent1, "redOff");
            var greenModChanged = PropertyChanged(beforeAccent1, afterAccent1, "greenMod");
            var greenOffChanged = PropertyChanged(beforeAccent1, afterAccent1, "greenOff");
            ...
            if (tintChanged)
            {
                if (!afterAccent1.TryGetProperty("tint", out var tint) ||
                    ...
                    !tint.TryGetDouble(out var tintFraction) ||
                    !double.IsFinite(tintFraction) || tintFraction < 0 || tintFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent1.tint", "source-bound accent1 tint must be a finite fraction from 0 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent1.tint", "the source did not issue an accent1-tint capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent1Tint",
                    "accentTransforms.accent1.tint",
                    path + ".accentTransforms.accent1.tint");
                var transformValue = checked((uint)Math.Round(tintFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
            ...
            else if (shadeChanged)
            {
                if (!afterAccent1.TryGetProperty("shade", out var shade) ||
                    ...
                    !shade.TryGetDouble(out var shadeFraction) ||
                    !double.IsFinite(shadeFraction) || shadeFraction < 0 || shadeFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent1.shade", "source-bound accent1 shade must be a finite fraction from 0 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent1.shade", "the source did not issue an accent1-shade capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent1Shade",
                    "accentTransforms.accent1.shade",
                    path + ".accentTransforms.accent1.shade");
                var transformValue = checked((uint)Math.Round(shadeFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent1", StringComparison.Ordinal));
            ...
            else if (lumOffChanged)
            {
                if (!afterAccent1.TryGetProperty("lumOff", out var lumOff) ||
                    lumOff.ValueKind != JsonValueKind.Number ||
                    !lumOff.TryGetDouble(out var lumOffFraction) ||
                    !double.IsFinite(lumOffFraction) || lumOffFraction < -1 || lumOffFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent1.lumOff", "source-bound accent1 lumOff must be a finite fraction from -1 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent1.lumOff", "the source did not issue an accent1-lumOff capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent1LumOff",
                    "accentTransforms.accent1.lumOff",
                    path + ".accentTransforms.accent1.lumOff");
                var transformValue = checked((int)Math.Round(lumOffFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent1", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasLuminanceOffsetThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent1.lumOff", "source-bound accent1 lumOff requires one imported direct lumOff");
                authoredTransform.LuminanceOffsetThousandth = transformValue;
            }
            else if (alphaModChanged)
            {
                if (!afterAccent1.TryGetProperty("alphaMod", out var alphaMod) ||
                    alphaMod.ValueKind != JsonValueKind.Number ||
                    !alphaMod.TryGetDouble(out var alphaModFraction) ||
                    !double.IsFinite(alphaModFraction) || alphaModFraction < 0 || alphaModFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent1.alphaMod", "source-bound accent1 alphaMod must be a finite fraction from 0 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent1.alphaMod", "the source did not issue an accent1-alphaMod capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent1AlphaMod",
                    "accentTransforms.accent1.alphaMod",
                    path + ".accentTransforms.accent1.alphaMod");
                var transformValue = checked((uint)Math.Round(alphaModFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent1", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasAlphaModulationThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent1.alphaMod", "source-bound accent1 alphaMod requires one imported direct alphaMod");
                authoredTransform.AlphaModulationThousandth = transformValue;
            }
            else if (alphaOffChanged)
            {
                if (!afterAccent1.TryGetProperty("alphaOff", out var alphaOff) ||
                    alphaOff.ValueKind != JsonValueKind.Number ||
                    !alphaOff.TryGetDouble(out var alphaOffFraction) ||
                    !double.IsFinite(alphaOffFraction) || alphaOffFraction < -1 || alphaOffFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent1.alphaOff", "source-bound accent1 alphaOff must be a finite fraction from -1 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent1.alphaOff", "the source did not issue an accent1-alphaOff capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent1AlphaOff",
                    "accentTransforms.accent1.alphaOff",
                    path + ".accentTransforms.accent1.alphaOff");
                var transformValue = checked((int)Math.Round(alphaOffFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent1", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasAlphaOffsetThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent1.alphaOff", "source-bound accent1 alphaOff requires one imported direct alphaOff");
                authoredTransform.AlphaOffsetThousandth = transformValue;
            }
            else if (satModChanged)
            {
                if (!afterAccent1.TryGetProperty("satMod", out var satMod) ||
                    satMod.ValueKind != JsonValueKind.Number ||
                    !satMod.TryGetDouble(out var satModFraction) ||
                    !double.IsFinite(satModFraction) || satModFraction < 0 || satModFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent1.satMod", "source-bound accent1 satMod must be a finite fraction from 0 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent1.satMod", "the source did not issue an accent1-satMod capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent1SatMod",
                    "accentTransforms.accent1.satMod",
                    path + ".accentTransforms.accent1.satMod");
                var transformValue = checked((uint)Math.Round(satModFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent1", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasSaturationModulationThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent1.satMod", "source-bound accent1 satMod requires one imported direct satMod");
                authoredTransform.SaturationModulationThousandth = transformValue;
            }
            else if (satOffChanged)
            {
                if (!afterAccent1.TryGetProperty("satOff", out var satOff) ||
                    satOff.ValueKind != JsonValueKind.Number ||
                    !satOff.TryGetDouble(out var satOffFraction) ||
                    !double.IsFinite(satOffFraction) || satOffFraction < -1 || satOffFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent1.satOff", "source-bound accent1 satOff must be a finite fraction from -1 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent1.satOff", "the source did not issue an accent1-satOff capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent1SatOff",
                    "accentTransforms.accent1.satOff",
                    path + ".accentTransforms.accent1.satOff");
                var transformValue = checked((int)Math.Round(satOffFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent1", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasSaturationOffsetThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent1.satOff", "source-bound accent1 satOff requires one imported direct satOff");
                authoredTransform.SaturationOffsetThousandth = transformValue;
            }
            else if (redModChanged)
            {
                if (!afterAccent1.TryGetProperty("redMod", out var redMod) ||
                    redMod.ValueKind != JsonValueKind.Number ||
                    !redMod.TryGetDouble(out var redModFraction) ||
                    !double.IsFinite(redModFraction) || redModFraction < 0 || redModFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent1.redMod", "source-bound accent1 redMod must be a finite fraction from 0 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent1.redMod", "the source did not issue an accent1-redMod capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent1RedMod",
                    "accentTransforms.accent1.redMod",
                    path + ".accentTransforms.accent1.redMod");
                var transformValue = checked((uint)Math.Round(redModFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent1", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasRedModulationThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent1.redMod", "source-bound accent1 redMod requires one imported direct redMod");
                authoredTransform.RedModulationThousandth = transformValue;
            }
            else if (redOffChanged)
            {
                if (!afterAccent1.TryGetProperty("redOff", out var redOff) ||
                    redOff.ValueKind != JsonValueKind.Number ||
                    !redOff.TryGetDouble(out var redOffFraction) ||
                    !double.IsFinite(redOffFraction) || redOffFraction < -1 || redOffFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent1.redOff", "source-bound accent1 redOff must be a finite fraction from -1 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent1.redOff", "the source did not issue an accent1-redOff capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent1RedOff",
                    "accentTransforms.accent1.redOff",
                    path + ".accentTransforms.accent1.redOff");
                var transformValue = checked((int)Math.Round(redOffFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent1", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasRedOffsetThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent1.redOff", "source-bound accent1 redOff requires one imported direct redOff");
                authoredTransform.RedOffsetThousandth = transformValue;
            }
            else if (greenModChanged)
            {
                if (!afterAccent1.TryGetProperty("greenMod", out var greenMod) ||
                    greenMod.ValueKind != JsonValueKind.Number ||
                    !greenMod.TryGetDouble(out var greenModFraction) ||
                    !double.IsFinite(greenModFraction) || greenModFraction < 0 || greenModFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent1.greenMod", "source-bound accent1 greenMod must be a finite fraction from 0 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent1.greenMod", "the source did not issue an accent1-greenMod capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent1GreenMod",
                    "accentTransforms.accent1.greenMod",
                    path + ".accentTransforms.accent1.greenMod");
                var transformValue = checked((uint)Math.Round(greenModFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent1", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasGreenModulationThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent1.greenMod", "source-bound accent1 greenMod requires one imported direct greenMod");
                authoredTransform.GreenModulationThousandth = transformValue;
            }
            else if (greenOffChanged)
            {
                if (!afterAccent1.TryGetProperty("greenOff", out var greenOff) ||
                    greenOff.ValueKind != JsonValueKind.Number ||
                    !greenOff.TryGetDouble(out var greenOffFraction) ||
                    !double.IsFinite(greenOffFraction) || greenOffFraction < -1 || greenOffFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent1.greenOff", "source-bound accent1 greenOff must be a finite fraction from -1 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent1.greenOff", "the source did not issue an accent1-greenOff capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent1GreenOff",
                    "accentTransforms.accent1.greenOff",
                    path + ".accentTransforms.accent1.greenOff");
                var transformValue = checked((int)Math.Round(greenOffFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent1", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasGreenOffsetThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent1.greenOff", "source-bound accent1 greenOff requires one imported direct greenOff");
                authoredTransform.GreenOffsetThousandth = transformValue;
            }
            else if (blueModChanged)
            {
                if (!afterAccent1.TryGetProperty("blueMod", out var blueMod) ||
                    blueMod.ValueKind != JsonValueKind.Number ||
                    !blueMod.TryGetDouble(out var blueModFraction) ||
                    !double.IsFinite(blueModFraction) || blueModFraction < 0 || blueModFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent1.blueMod", "source-bound accent1 blueMod must be a finite fraction from 0 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent1.blueMod", "the source did not issue an accent1-blueMod capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent1BlueMod",
                    "accentTransforms.accent1.blueMod",
                    path + ".accentTransforms.accent1.blueMod");
                var transformValue = checked((uint)Math.Round(blueModFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent1", StringComparison.Ordinal));
                if (authoredTransform is null || !authoredTransform.HasBlueModulationThousandth ||
                    ...
                    authoredTransform.HasGray || authoredTransform.HasComp || authoredTransform.HasInv ||
                    authoredTransform.HasGamma || authoredTransform.HasInvGamma)
                    throw Unsupported(path + ".accentTransforms.accent1.blueMod", "source-bound accent1 blueMod requires one imported direct blueMod");
                authoredTransform.BlueModulationThousandth = transformValue;
            }
            else if (blueOffChanged)
            {
                if (!afterAccent1.TryGetProperty("blueOff", out var blueOff) ||
                    blueOff.ValueKind != JsonValueKind.Number ||
                    !blueOff.TryGetDouble(out var blueOffFraction) ||
                    !double.IsFinite(blueOffFraction) || blueOffFraction < -1 || blueOffFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent1.blueOff", "source-bound accent1 blueOff must be a finite fraction from -1 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent1.blueOff", "the source did not issue an accent1-blueOff capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent1BlueOff",
                    "accentTransforms.accent1.blueOff",
                    path + ".accentTransforms.accent1.blueOff");
                var transformValue = checked((int)Math.Round(blueOffFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent1", StringComparison.Ordinal));
            ...
            else if (hueModChanged)
            {
                if (!afterAccent1.TryGetProperty("hueMod", out var hueMod) ||
                    ...
                    !hueMod.TryGetDouble(out var hueModFraction) ||
                    !double.IsFinite(hueModFraction) || hueModFraction < 0 || hueModFraction > 1)
                    throw Unsupported(path + ".accentTransforms.accent1.hueMod", "source-bound accent1 hueMod must be a finite fraction from 0 through 1");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".accentTransforms.accent1.hueMod", "the source did not issue an accent1-hueMod capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeAccent1HueMod",
                    "accentTransforms.accent1.hueMod",
                    path + ".accentTransforms.accent1.hueMod");
                var transformValue = checked((uint)Math.Round(hueModFraction * 100_000d, MidpointRounding.AwayFromZero));
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var authoredTransform = artifact.Presentation.AuthoredTheme.AccentTransforms
                    .SingleOrDefault(transform => transform.Role.Equals("accent1", StringComparison.Ordinal));
        ...
        if (PropertyChanged(before, after, "colorRoles"))
        {
            ...
            if (dark1Changed)
            {
                if (!afterColorRoles.TryGetProperty("dark1", out var afterDark1) ||
                    ...
                    throw Unsupported(path + ".colorRoles.dark1", "source-bound dark1 color must be a six- or eight-digit RGB/RGBA value");
                if (requested.Design.ThemeNativeRef is null)
                ...
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var requestedDark1 = afterDark1.GetString()!.Trim().TrimStart('#').ToUpperInvariant();
                _ = PptxColor.NormalizeThemeRgb(requestedDark1, out _);
                artifact.Presentation.AuthoredTheme.Dark1Rgb = requestedDark1;
                mutations.SemanticChanges = true;
                changed = true;
            }
            ...
            if (PropertyChanged(beforeColorRoles, afterColorRoles, "dark2"))
            {
                if (changed)
                    throw new CodecException(
                        "ppj.sourceBound.themeColorRoles",
                        "Source-bound PPJ can change only one theme field per compile.",
                        path + ".colorRoles.dark2");
                if (!afterColorRoles.TryGetProperty("dark2", out var afterDark2) ||
                    afterDark2.ValueKind != JsonValueKind.String)
                    throw Unsupported(path + ".colorRoles.dark2", "source-bound dark2 color must be a six- or eight-digit RGB/RGBA value");
                if (requested.Design.ThemeNativeRef is null)
                    throw Unsupported(path + ".colorRoles.dark2", "the source did not issue a dark2-color capability");
                RequireCapabilityField(
                    requested.Design.ThemeNativeRef,
                    "setThemeColorRoleDark2",
                    "colorRoles.dark2",
                    path + ".colorRoles.dark2");
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var requestedDark2 = afterDark2.GetString()!.Trim().TrimStart('#').ToUpperInvariant();
                _ = PptxColor.NormalizeThemeRgb(requestedDark2, out _);
                artifact.Presentation.AuthoredTheme.Dark2Rgb = requestedDark2;
                mutations.SemanticChanges = true;
                changed = true;
            }
            if (PropertyChanged(beforeColorRoles, afterColorRoles, "light2"))
            {
                ...
                if (!afterColorRoles.TryGetProperty("light2", out var afterLight2) ||
                    ...
                    throw Unsupported(path + ".colorRoles.light2", "source-bound light2 color must be a six- or eight-digit RGB/RGBA value");
                if (requested.Design.ThemeNativeRef is null)
                ...
                RequireCapabilityField(
                    ...
                    path + ".colorRoles.light2");
                artifact.Presentation.AuthoredTheme ??= new PresentationThemeArtifact();
                var requestedLight2 = afterLight2.GetString()!.Trim().TrimStart('#').ToUpperInvariant();
                _ = PptxColor.NormalizeThemeRgb(requestedLight2, out _);
                artifact.Presentation.AuthoredTheme.Light2Rgb = requestedLight2;
                mutations.SemanticChanges = true;
                changed = true;
            }
            if (PropertyChanged(beforeColorRoles, afterColorRoles, "hyperlink"))
            {
                if (changed)
                    throw new CodecException(
                        "ppj.sourceBound.themeColorRoles",
        ...
        MutationState mutations)
    {
        ...
        for (var index = 0; index < requested.Pages.Count; index++)
        {
            ...
            var connectorBindings = IndexConnectorSourceBindings(before.Elements, slide.Elements);
            ...
            if (ApplyConnectorDependencies(before, after, connectorBindings, mutations, changedNodeIds, path))
            {
                changed = true;
                changedNodeIds.Add(after.Id);
            }
        ...
        string path)
    {
        ...
        if (PropertyChanged(before.Raw, after.Raw, "geometry"))
        {
            ...
            {
                foreach (var field in new[] { "paths", "textRectangle", "guides", "adjustments", "connectionSites", "adjustmentHandles" })
                ...
                PpjAuthoredPresentationCompiler.ApplyCustomGeometry(target, newGeometry, after.Id, allowShapeGraph: true);
            }
            else
            {
        ...
        string path)
    {
        ...
        if (PropertyChanged(oldStyle, newStyle, "varyColors"))
        {
            ...
            if (target.Type is not (SpreadsheetChartType.Line or SpreadsheetChartType.Bar or SpreadsheetChartType.Area or SpreadsheetChartType.Scatter or SpreadsheetChartType.Combo))
        ...
        JsonElement? grammarRoot = null)
    {
        ...
        if (source.TryGetProperty("softEdge", out var softEdge)) output.SoftEdge = PpjAuthoredPresentationCompiler.BuildChartTextSoftEdge(softEdge);
        if (source.TryGetProperty("reflection", out var reflection))
            output.Reflection = PpjAuthoredPresentationCompiler.BuildChartTextReflection(reflection,
                opacity => grammarRoot is { } root ? ResolveGrammarOpacityToken(root, opacity, path + ".reflection.opacity") : opacity.GetDouble());
        if (source.TryGetProperty("innerShadow", out var innerShadow))
            output.InnerShadow = PpjAuthoredPresentationCompiler.BuildChartTextInnerShadow(innerShadow,
                color => grammarRoot is { } root ? ResolveGrammarColorValue(root, color, path + ".innerShadow.color") : ParseSourceBoundColor(color, path + ".innerShadow.color"),
                opacity => grammarRoot is { } root ? ResolveGrammarOpacityToken(root, opacity, path + ".innerShadow.opacity") : opacity.GetDouble(),
        ...
        if (source.TryGetProperty("shadow", out var shadow))
            output.Shadow = PpjAuthoredPresentationCompiler.BuildChartTextShadow(shadow,
                ...
                opacity => grammarRoot is { } root ? ResolveGrammarOpacityToken(root, opacity, path + ".shadow.opacity") : opacity.GetDouble(),
                name => grammarRoot is { } root && TryDeclaredGrammarToken(root, name, out _));
        ...
        JsonElement previousSource)
    {
        ...
        if (PreviousTextBodyStyle(previousSource, "style") is { ValueKind: JsonValueKind.Object } previousDirection &&
            previousDirection.TryGetProperty("columnDirection", out _) &&
            (PreviousTextBodyStyle(source, "style") is not { ValueKind: JsonValueKind.Object } nextDirection || !nextDirection.TryGetProperty("columnDirection", out _)))
        {
            body.BodyProperties ??= new PresentationTextBodyProperties();
            body.BodyProperties.NoColumnDirection = true;
        }
        if (PreviousTextBodyStyle(previousSource, "style") is { ValueKind: JsonValueKind.Object } previousVertical &&
            previousVertical.TryGetProperty("verticalText", out _) &&
            (PreviousTextBodyStyle(source, "style") is not { ValueKind: JsonValueKind.Object } nextVertical || !nextVertical.TryGetProperty("verticalText", out _)))
        {
            body.BodyProperties ??= new PresentationTextBodyProperties();
        ...
        if (PreviousTextBodyStyle(previousSource, "style") is { ValueKind: JsonValueKind.Object } previousHorizontalOverflow &&
            previousHorizontalOverflow.TryGetProperty("horizontalOverflow", out _) &&
            (PreviousTextBodyStyle(source, "style") is not { ValueKind: JsonValueKind.Object } nextHorizontalOverflow || !nextHorizontalOverflow.TryGetProperty("horizontalOverflow", out _)))
        {
            body.BodyProperties ??= new PresentationTextBodyProperties();
            body.BodyProperties.NoHorizontalOverflowMode = true;
        }
        if (PreviousTextBodyStyle(previousSource, "style") is { ValueKind: JsonValueKind.Object } previousVerticalOverflow &&
            previousVerticalOverflow.TryGetProperty("verticalOverflow", out _) &&
            (PreviousTextBodyStyle(source, "style") is not { ValueKind: JsonValueKind.Object } nextVerticalOverflow || !nextVerticalOverflow.TryGetProperty("verticalOverflow", out _)))
        {
            body.BodyProperties ??= new PresentationTextBodyProperties();
        ...
        if (PreviousTextBodyStyle(previousSource, "style") is { ValueKind: JsonValueKind.Object } previousColumns &&
            previousColumns.TryGetProperty("columns", out _) &&
            (PreviousTextBodyStyle(source, "style") is not { ValueKind: JsonValueKind.Object } nextColumns || !nextColumns.TryGetProperty("columns", out _)))
        {
            body.BodyProperties ??= new PresentationTextBodyProperties();
        ...
        if (PreviousTextBodyStyle(previousSource, "style") is { ValueKind: JsonValueKind.Object } previousParagraphSpacing &&
            previousParagraphSpacing.TryGetProperty("spaceFirstLastParagraph", out _) &&
            (PreviousTextBodyStyle(source, "style") is not { ValueKind: JsonValueKind.Object } nextParagraphSpacing || !nextParagraphSpacing.TryGetProperty("spaceFirstLastParagraph", out _)))
        {
        ...
        if (PreviousTextBodyStyle(previousSource, "style") is { ValueKind: JsonValueKind.Object } previousWordArt &&
            previousWordArt.TryGetProperty("fromWordArt", out _) &&
            (PreviousTextBodyStyle(source, "style") is not { ValueKind: JsonValueKind.Object } nextWordArt || !nextWordArt.TryGetProperty("fromWordArt", out _)))
        {
            properties.ClearFromWordArt();
            properties.NoFromWordArt = true;
        }
        if (PreviousTextBodyStyle(previousSource, "style") is { ValueKind: JsonValueKind.Object } previousFlatText &&
            previousFlatText.TryGetProperty("flatTextZ", out _) &&
            (PreviousTextBodyStyle(source, "style") is not { ValueKind: JsonValueKind.Object } nextFlatText || !nextFlatText.TryGetProperty("flatTextZ", out _)))
        {
            properties.ClearFlatTextZ();
            properties.NoFlatTextZ = true;
        }
        if (PreviousTextBodyStyle(previousSource, "style") is { ValueKind: JsonValueKind.Object } previousWarp &&
            previousWarp.TryGetProperty("textWarpPreset", out _) &&
            (PreviousTextBodyStyle(source, "style") is not { ValueKind: JsonValueKind.Object } nextWarp || !nextWarp.TryGetProperty("textWarpPreset", out _)))
        {
            properties.ClearTextWarpPreset();
            properties.NoTextWarpPreset = true;
        }
    ...
    private static bool ApplyConnectorElement(PpjProgramModel program, PpjConnectorElementModel before, PpjConnectorElementModel after, PresentationConnector target, string path)
    {
        ...
        if (PropertyChanged(before.Raw, after.Raw, "startArrow"))
        {
            RequireCapabilityField(after.NativeRef, "setConnectorArrows", "startArrow", path + ".startArrow");
            target.StartArrow = ArrowValue(after.Raw, "startArrow");
            if (target.StartArrow.Length == 0) target.StartArrowWidth = target.StartArrowLength = string.Empty;
            changed = true;
        }
        if (PropertyChanged(before.Raw, after.Raw, "endArrow"))
        {
        ...
        JsonElement programRoot)
    {
        ...
        var tabStopsChanged = !JsonEqual(
            MaskTextValues(beforeRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true),
            MaskTextValues(afterRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true));
        var alignmentChanged = !JsonEqual(
            MaskTextValues(beforeRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true),
            MaskTextValues(afterRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true));
        var fontAlignmentChanged = !JsonEqual(
            MaskTextValues(beforeRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskRightIndent: true, maskDirection: true, maskLevel: true, maskTabStops: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskAlignment: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true),
            MaskTextValues(afterRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskRightIndent: true, maskDirection: true, maskLevel: true, maskTabStops: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskAlignment: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true));
        var hangingPunctuationChanged = !JsonEqual(
            MaskTextValues(beforeRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskLevel: true, maskTabStops: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskAlignment: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true),
            MaskTextValues(afterRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskLevel: true, maskTabStops: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskAlignment: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true));
        var latinLineBreakChanged = !JsonEqual(
            MaskTextValues(beforeRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskLevel: true, maskTabStops: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskAlignment: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true),
            MaskTextValues(afterRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskLevel: true, maskTabStops: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskAlignment: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true));
        var eastAsianLineBreakChanged = !JsonEqual(
            MaskTextValues(beforeRaw, maskDefaultTabSize: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskLevel: true, maskTabStops: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskAlignment: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true),
            MaskTextValues(afterRaw, maskDefaultTabSize: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskLevel: true, maskTabStops: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskAlignment: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true));
        var defaultTabSizeChanged = !JsonEqual(
            MaskTextValues(beforeRaw, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskLevel: true, maskTabStops: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskAlignment: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true),
            MaskTextValues(afterRaw, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskLevel: true, maskTabStops: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskAlignment: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true));
        var directionChanged = !JsonEqual(
            MaskTextValues(beforeRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskLevel: true, maskTabStops: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskAlignment: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true),
            MaskTextValues(afterRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskLevel: true, maskTabStops: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskAlignment: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true));
        var levelChanged = !JsonEqual(
            MaskTextValues(beforeRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskAlignment: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true),
            MaskTextValues(afterRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskAlignment: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true));
        var bulletStartAtChanged = !JsonEqual(
            MaskTextValues(beforeRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskAlignment: true, maskLevel: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true),
            MaskTextValues(afterRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskAlignment: true, maskLevel: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true));
        var bulletSchemeChanged = !JsonEqual(
            MaskTextValues(beforeRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskAlignment: true, maskLevel: true, maskBulletStartAt: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true),
            MaskTextValues(afterRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskAlignment: true, maskLevel: true, maskBulletStartAt: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true));
        var bulletCharacterChanged = !JsonEqual(
            MaskTextValues(beforeRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskAlignment: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true),
            MaskTextValues(afterRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskAlignment: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true));
        var bulletFontChanged = !JsonEqual(
            MaskTextValues(beforeRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskBulletCharacter: true, maskTabStops: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskAlignment: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletColor: true, maskBulletSize: true),
            MaskTextValues(afterRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskBulletCharacter: true, maskTabStops: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskAlignment: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletColor: true, maskBulletSize: true));
        var bulletSizeChanged = !JsonEqual(
            MaskTextValues(beforeRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskBulletCharacter: true, maskBulletFont: true, maskTabStops: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskAlignment: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletColor: true),
            MaskTextValues(afterRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskBulletCharacter: true, maskBulletFont: true, maskTabStops: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskAlignment: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletColor: true));
        var bulletColorChanged = !JsonEqual(
            MaskTextValues(beforeRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskBulletCharacter: true, maskBulletFont: true, maskTabStops: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskAlignment: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletSize: true),
            MaskTextValues(afterRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskBulletCharacter: true, maskBulletFont: true, maskTabStops: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskAlignment: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletSize: true));
        var defaultBoldChanged = !JsonEqual(
            MaskTextValues(beforeRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true),
            MaskTextValues(afterRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true));
        var defaultItalicChanged = !JsonEqual(
            MaskTextValues(beforeRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true),
            MaskTextValues(afterRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true));
        var defaultSizeChanged = !JsonEqual(
            MaskTextValues(beforeRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true),
            MaskTextValues(afterRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true));
        var defaultFontFamilyChanged = !JsonEqual(
            MaskTextValues(beforeRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true),
            MaskTextValues(afterRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true));
        var defaultEastAsianFontChanged = !JsonEqual(
            MaskTextValues(beforeRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true),
            MaskTextValues(afterRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true));
        var defaultComplexScriptFontChanged = !JsonEqual(
            MaskTextValues(beforeRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true),
            MaskTextValues(afterRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true));
        var defaultLanguageChanged = !JsonEqual(
            MaskTextValues(beforeRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true),
            MaskTextValues(afterRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true));
        var defaultKerningChanged = !JsonEqual(
            MaskTextValues(beforeRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true),
            MaskTextValues(afterRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true));
        var defaultLetterSpacingChanged = !JsonEqual(
            MaskTextValues(beforeRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true),
            MaskTextValues(afterRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true));
        var defaultBaselineChanged = !JsonEqual(
            MaskTextValues(beforeRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true),
            MaskTextValues(afterRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true));
        var defaultCapitalizationChanged = !JsonEqual(
            MaskTextValues(beforeRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true),
            MaskTextValues(afterRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true));
        var defaultStrikeChanged = !JsonEqual(
            MaskTextValues(beforeRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true),
            MaskTextValues(afterRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true));
        var defaultUnderlineChanged = !JsonEqual(
            MaskTextValues(beforeRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true),
            MaskTextValues(afterRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true));
        var defaultHighlightChanged = !JsonEqual(
            MaskTextValues(beforeRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true),
            MaskTextValues(afterRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true));
        var defaultColorChanged = !JsonEqual(
            MaskTextValues(beforeRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true),
            MaskTextValues(afterRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true));
        var defaultGradientChanged = !JsonEqual(
            MaskTextValues(beforeRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true),
            MaskTextValues(afterRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true));
        var defaultGlowChanged = !JsonEqual(
            MaskTextValues(beforeRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true),
            MaskTextValues(afterRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true));
        var defaultInnerShadowChanged = !JsonEqual(
            MaskTextValues(beforeRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true),
            MaskTextValues(afterRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true));
        var defaultReflectionChanged = !JsonEqual(
            MaskTextValues(beforeRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true),
            MaskTextValues(afterRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true));
        var defaultShadowChanged = !JsonEqual(
            MaskTextValues(beforeRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true),
            MaskTextValues(afterRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true));
        var defaultSoftEdgeChanged = !JsonEqual(
            MaskTextValues(beforeRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true),
            MaskTextValues(afterRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true));
        var spaceBeforeChanged = !JsonEqual(
            MaskTextValues(beforeRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true),
            MaskTextValues(afterRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true));
        var spaceAfterChanged = !JsonEqual(
            MaskTextValues(beforeRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true),
            MaskTextValues(afterRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true));
        var lineSpacingChanged = !JsonEqual(
            MaskTextValues(beforeRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true),
            MaskTextValues(afterRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true));
        var rightIndentChanged = !JsonEqual(
            MaskTextValues(beforeRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true),
            MaskTextValues(afterRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true));
        var indentChanged = !JsonEqual(
            MaskTextValues(beforeRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true),
            MaskTextValues(afterRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true));
        var hangingChanged = !JsonEqual(
            MaskTextValues(beforeRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true),
            MaskTextValues(afterRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true));
        if (!JsonEqual(
                MaskTextValues(beforeRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true),
                MaskTextValues(afterRaw, maskDefaultTabSize: true, maskEastAsianLineBreak: true, maskLatinLineBreak: true, maskHangingPunctuation: true, maskFontAlignment: true, maskRightIndent: true, maskDirection: true, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true, maskBulletScheme: true, maskBulletCharacter: true, maskBulletFont: true, maskBulletColor: true, maskBulletSize: true)))
        ...
        if (tabStopsChanged || alignmentChanged || levelChanged || directionChanged || defaultTabSizeChanged || eastAsianLineBreakChanged || latinLineBreakChanged || hangingPunctuationChanged || fontAlignmentChanged || bulletStartAtChanged || bulletSchemeChanged || bulletCharacterChanged || bulletFontChanged || bulletColorChanged || bulletSizeChanged || defaultBoldChanged || defaultItalicChanged || defaultSizeChanged || defaultFontFamilyChanged || defaultEastAsianFontChanged || defaultComplexScriptFontChanged || defaultLanguageChanged || defaultKerningChanged || defaultLetterSpacingChanged || defaultBaselineChanged || defaultCapitalizationChanged || defaultStrikeChanged || defaultUnderlineChanged || defaultHighlightChanged || defaultColorChanged || defaultGradientChanged || defaultGlowChanged || defaultInnerShadowChanged || defaultReflectionChanged || defaultShadowChanged || defaultSoftEdgeChanged || spaceBeforeChanged || spaceAfterChanged || lineSpacingChanged || indentChanged || rightIndentChanged || hangingChanged)
        {
            ...
            if (directionChanged)
                RequireCapabilityField(nativeRef, "setTextParagraphStyle",
                    "text.paragraphs[].style.direction", path + ".paragraphStyle.direction");
            if (defaultTabSizeChanged)
                RequireCapabilityField(nativeRef, "setTextParagraphStyle",
                    "text.paragraphs[].style.defaultTabSize", path + ".paragraphStyle.defaultTabSize");
            if (eastAsianLineBreakChanged)
                RequireCapabilityField(nativeRef, "setTextParagraphStyle",
                    "text.paragraphs[].style.eastAsianLineBreak", path + ".paragraphStyle.eastAsianLineBreak");
            if (latinLineBreakChanged)
                RequireCapabilityField(nativeRef, "setTextParagraphStyle",
                    "text.paragraphs[].style.latinLineBreak", path + ".paragraphStyle.latinLineBreak");
            if (hangingPunctuationChanged)
                RequireCapabilityField(nativeRef, "setTextParagraphStyle",
                    "text.paragraphs[].style.hangingPunctuation", path + ".paragraphStyle.hangingPunctuation");
            if (fontAlignmentChanged)
                RequireCapabilityField(nativeRef, "setTextParagraphStyle",
                    "text.paragraphs[].style.fontAlignment", path + ".paragraphStyle.fontAlignment");
            if (bulletStartAtChanged)
                RequireCapabilityField(nativeRef, "setTextParagraphStyle",
                    "text.paragraphs[].style.bullet.startAt", path + ".paragraphStyle.bullet.startAt");
            if (bulletCharacterChanged)
                RequireCapabilityField(nativeRef, "setTextParagraphStyle",
                    "text.paragraphs[].style.bullet.character", path + ".paragraphStyle.bullet.character");
            if (bulletFontChanged)
                for (var index = 0; index < target.TextBody.Paragraphs.Count; index++)
                    foreach (var field in new[] { "fontFamily", "fontFollowText" })
                        if (PropertyChanged(ParagraphBullet(beforeRaw, index), ParagraphBullet(afterRaw, index), field))
                            RequireCapabilityField(nativeRef, "setTextParagraphStyle",
                                "text.paragraphs[].style.bullet." + field, path + ".paragraphStyle.bullet." + field);
            if (bulletColorChanged)
                for (var index = 0; index < target.TextBody.Paragraphs.Count; index++)
                    foreach (var field in new[] { "color", "colorFollowText" })
                        if (PropertyChanged(ParagraphBullet(beforeRaw, index), ParagraphBullet(afterRaw, index), field))
                            RequireCapabilityField(nativeRef, "setTextParagraphStyle",
                                "text.paragraphs[].style.bullet." + field, path + ".paragraphStyle.bullet." + field);
            if (bulletSizeChanged)
                for (var index = 0; index < target.TextBody.Paragraphs.Count; index++)
                    foreach (var field in new[] { "size", "sizePercent", "sizeFollowText" })
                        if (PropertyChanged(ParagraphBullet(beforeRaw, index), ParagraphBullet(afterRaw, index), field))
                            RequireCapabilityField(nativeRef, "setTextParagraphStyle",
                                "text.paragraphs[].style.bullet." + field, path + ".paragraphStyle.bullet." + field);
            if (bulletSchemeChanged)
                for (var index = 0; index < target.TextBody.Paragraphs.Count; index++)
                {
                    if (!ParagraphNumberingSchemeChanged(beforeRaw, afterRaw, index)) continue;
                    var field = ParagraphBullet(afterRaw, index) is { } bullet && bullet.TryGetProperty("format", out _)
                        ? "format" : "scheme";
                    RequireCapabilityField(nativeRef, "setTextParagraphStyle",
                        "text.paragraphs[].style.bullet." + field, path + ".paragraphStyle.bullet." + field);
                }
            ...
            if (defaultSizeChanged)
                RequireCapabilityField(nativeRef, "setTextParagraphStyle",
                    "text.paragraphs[].style.defaultText.size", path + ".paragraphStyle.defaultText.size");
            ...
            if (defaultComplexScriptFontChanged)
                RequireCapabilityField(nativeRef, "setTextParagraphStyle",
                    "text.paragraphs[].style.defaultText.fontFamilyComplexScript", path + ".paragraphStyle.defaultText.fontFamilyComplexScript");
            ...
            if (defaultLetterSpacingChanged)
                RequireCapabilityField(nativeRef, "setTextParagraphStyle",
                    "text.paragraphs[].style.defaultText.letterSpacing", path + ".paragraphStyle.defaultText.letterSpacing");
            if (defaultBaselineChanged)
                RequireCapabilityField(nativeRef, "setTextParagraphStyle",
                    "text.paragraphs[].style.defaultText.baseline", path + ".paragraphStyle.defaultText.baseline");
            if (defaultCapitalizationChanged)
                RequireCapabilityField(nativeRef, "setTextParagraphStyle",
                    "text.paragraphs[].style.defaultText.capitalization", path + ".paragraphStyle.defaultText.capitalization");
            if (defaultStrikeChanged)
                RequireCapabilityField(nativeRef, "setTextParagraphStyle",
                    "text.paragraphs[].style.defaultText.strike", path + ".paragraphStyle.defaultText.strike");
            if (defaultUnderlineChanged)
                RequireCapabilityField(nativeRef, "setTextParagraphStyle",
                    "text.paragraphs[].style.defaultText.underline", path + ".paragraphStyle.defaultText.underline");
            if (defaultHighlightChanged)
                RequireCapabilityField(nativeRef, "setTextParagraphStyle",
                    "text.paragraphs[].style.defaultText.highlight", path + ".paragraphStyle.defaultText.highlight");
            if (defaultColorChanged)
                RequireCapabilityField(nativeRef, "setTextParagraphStyle",
                    "text.paragraphs[].style.defaultText.color", path + ".paragraphStyle.defaultText.color");
            if (defaultGradientChanged)
                RequireCapabilityField(nativeRef, "setTextParagraphStyle",
                    "text.paragraphs[].style.defaultText.gradient", path + ".paragraphStyle.defaultText.gradient");
            if (defaultGlowChanged)
                RequireCapabilityField(nativeRef, "setTextParagraphStyle",
                    "text.paragraphs[].style.defaultText.glow", path + ".paragraphStyle.defaultText.glow");
            if (spaceBeforeChanged)
                foreach (var field in new[] { "spaceBefore", "spaceBeforeMultiplier" })
                    if (Enumerable.Range(0, target.TextBody.Paragraphs.Count).Any(index =>
                        PropertyChanged(ParagraphStyle(beforeRaw, index), ParagraphStyle(afterRaw, index), field)))
                        RequireCapabilityField(nativeRef, "setTextParagraphStyle",
                            "text.paragraphs[].style." + field, path + ".paragraphStyle." + field);
            if (spaceAfterChanged)
                foreach (var field in new[] { "spaceAfter", "spaceAfterMultiplier" })
                    if (Enumerable.Range(0, target.TextBody.Paragraphs.Count).Any(index =>
                        PropertyChanged(ParagraphStyle(beforeRaw, index), ParagraphStyle(afterRaw, index), field)))
                        RequireCapabilityField(nativeRef, "setTextParagraphStyle",
                            "text.paragraphs[].style." + field, path + ".paragraphStyle." + field);
            if (indentChanged)
                RequireCapabilityField(nativeRef, "setTextParagraphStyle",
                    "text.paragraphs[].style.indent", path + ".paragraphStyle.indent");
            if (rightIndentChanged)
                RequireCapabilityField(nativeRef, "setTextParagraphStyle",
                    "text.paragraphs[].style.rightIndent", path + ".paragraphStyle.rightIndent");
            if (hangingChanged)
                RequireCapabilityField(nativeRef, "setTextParagraphStyle",
                    "text.paragraphs[].style.hanging", path + ".paragraphStyle.hanging");
            if (lineSpacingChanged)
                foreach (var field in new[] { "lineSpacing", "lineSpacingMultiplier" })
                    if (Enumerable.Range(0, target.TextBody.Paragraphs.Count).Any(index =>
                        PropertyChanged(ParagraphStyle(beforeRaw, index), ParagraphStyle(afterRaw, index), field)))
                        RequireCapabilityField(nativeRef, "setTextParagraphStyle",
                            "text.paragraphs[].style." + field, path + ".paragraphStyle." + field);
            if (defaultSoftEdgeChanged)
                RequireCapabilityField(nativeRef, "setTextParagraphStyle",
                    "text.paragraphs[].style.defaultText.softEdge", path + ".paragraphStyle.defaultText.softEdge");
            if (defaultShadowChanged)
                RequireCapabilityField(nativeRef, "setTextParagraphStyle",
                    "text.paragraphs[].style.defaultText.shadow", path + ".paragraphStyle.defaultText.shadow");
            if (defaultReflectionChanged)
                RequireCapabilityField(nativeRef, "setTextParagraphStyle",
                    "text.paragraphs[].style.defaultText.reflection", path + ".paragraphStyle.defaultText.reflection");
            if (defaultInnerShadowChanged)
                RequireCapabilityField(nativeRef, "setTextParagraphStyle",
                    "text.paragraphs[].style.defaultText.innerShadow", path + ".paragraphStyle.defaultText.innerShadow");
            ApplyTextParagraphStyleMutation(beforeRaw, afterRaw, target, programRoot, path,
                tabStopsChanged, alignmentChanged, levelChanged, directionChanged, defaultTabSizeChanged, eastAsianLineBreakChanged, latinLineBreakChanged, hangingPunctuationChanged, fontAlignmentChanged, bulletStartAtChanged, bulletSchemeChanged, bulletCharacterChanged, bulletFontChanged, bulletColorChanged, bulletSizeChanged, defaultBoldChanged, defaultItalicChanged, defaultSizeChanged, defaultFontFamilyChanged, defaultEastAsianFontChanged, defaultComplexScriptFontChanged, defaultLanguageChanged, defaultKerningChanged, defaultLetterSpacingChanged, defaultBaselineChanged, defaultCapitalizationChanged, defaultStrikeChanged, defaultUnderlineChanged, defaultHighlightChanged, defaultColorChanged, defaultGradientChanged, defaultGlowChanged, defaultInnerShadowChanged, defaultReflectionChanged, defaultShadowChanged, defaultSoftEdgeChanged, spaceBeforeChanged, spaceAfterChanged, lineSpacingChanged, indentChanged, rightIndentChanged, hangingChanged);
            mutations.SemanticChanges = true;
        }
    ...
    private static void RequireThemeAccentTransformsOwnedSlots(JsonElement before, JsonElement after, string path)
    {
        var names = before.EnumerateObject().Select(property => property.Name)
            .Concat(after.EnumerateObject().Select(property => property.Name))
            .Distinct(StringComparer.Ordinal);
        foreach (var name in names)
        {
            if (name is not ("accent1" or "accent2" or "accent3" or "accent4" or "accent5" or "accent6"))
                throw new CodecException(
                    "ppj.sourceBound.themeAccentTransforms",
                    $"Source-bound PPJ cannot safely compile changing source-owned {name}.",
                    path + "." + name);
            ...
            if (!oldPresent || !newPresent ||
                ...
                throw Unsupported(path + "." + name, "source-bound accent1, accent2, accent3, accent4, accent5, or accent6 tint, shade, lumMod, lumOff, alphaMod, alphaOff, satMod, satOff, redMod, redOff, greenMod, greenOff, blueMod, blueOff, hueMod, or hueOff cannot be added or removed");
            ...
            foreach (var transformName in transformNames)
            {
                if (!transformName.Equals("tint", StringComparison.Ordinal) &&
                    ...
                    !transformName.Equals("lumOff", StringComparison.Ordinal) &&
                    !transformName.Equals("alphaMod", StringComparison.Ordinal) &&
                    !transformName.Equals("alphaOff", StringComparison.Ordinal) &&
                    !transformName.Equals("satMod", StringComparison.Ordinal) &&
                    !transformName.Equals("satOff", StringComparison.Ordinal) &&
                    !transformName.Equals("redMod", StringComparison.Ordinal) &&
                    !transformName.Equals("redOff", StringComparison.Ordinal) &&
                    !transformName.Equals("greenMod", StringComparison.Ordinal) &&
    ...
    private static JsonElement MaskTextValues(
        ...
        bool maskLevel = false,
        bool maskDirection = false,
        bool maskDefaultTabSize = false,
        bool maskEastAsianLineBreak = false,
        bool maskLatinLineBreak = false,
        bool maskHangingPunctuation = false,
        bool maskFontAlignment = false,
        bool maskBulletStartAt = false,
        bool maskBulletScheme = false,
        bool maskBulletCharacter = false,
        bool maskBulletFont = false,
        bool maskBulletColor = false,
        bool maskBulletSize = false,
        ...
        bool maskDefaultLetterSpacing = false,
        bool maskDefaultBaseline = false,
        bool maskDefaultCapitalization = false,
        bool maskDefaultStrike = false,
        bool maskDefaultUnderline = false,
        bool maskDefaultHighlight = false,
        bool maskDefaultColor = false,
        bool maskDefaultGradient = false,
        bool maskDefaultGlow = false,
        bool maskDefaultInnerShadow = false,
        bool maskDefaultReflection = false,
        bool maskDefaultShadow = false,
        bool maskDefaultSoftEdge = false,
        bool maskSpaceBefore = false,
        bool maskSpaceAfter = false,
        bool maskLineSpacing = false,
        bool maskIndent = false,
        bool maskRightIndent = false,
        bool maskHanging = false)
    {
        if (value.ValueKind == JsonValueKind.String)
        {
        ...
        if (node["paragraphs"] is System.Text.Json.Nodes.JsonArray paragraphs)
        {
            foreach (var paragraph in paragraphs.OfType<System.Text.Json.Nodes.JsonObject>())
            {
                ...
                if ((maskTabStops || maskAlignment || maskLevel || maskDirection || maskDefaultTabSize || maskEastAsianLineBreak || maskLatinLineBreak || maskHangingPunctuation || maskFontAlignment || maskBulletStartAt || maskBulletScheme || maskBulletCharacter || maskBulletFont || maskBulletColor || maskBulletSize || maskDefaultBold || maskDefaultItalic || maskDefaultSize || maskDefaultFontFamily || maskDefaultEastAsianFont || maskDefaultComplexScriptFont || maskDefaultLanguage || maskDefaultKerning || maskDefaultLetterSpacing || maskDefaultBaseline || maskDefaultCapitalization || maskDefaultStrike || maskDefaultUnderline || maskDefaultHighlight || maskDefaultColor || maskDefaultGradient || maskDefaultGlow || maskDefaultInnerShadow || maskDefaultReflection || maskDefaultShadow || maskDefaultSoftEdge || maskSpaceBefore || maskSpaceAfter || maskLineSpacing || maskIndent || maskRightIndent || maskHanging) && paragraph["style"] is System.Text.Json.Nodes.JsonObject style)
                {
                    ...
                    if (maskLevel) style.Remove("level");
                    if (maskDirection) style.Remove("direction");
                    if (maskDefaultTabSize) style.Remove("defaultTabSize");
                    if (maskEastAsianLineBreak) style.Remove("eastAsianLineBreak");
                    if (maskLatinLineBreak) style.Remove("latinLineBreak");
                    if (maskHangingPunctuation) style.Remove("hangingPunctuation");
                    if (maskFontAlignment) style.Remove("fontAlignment");
                    if (maskBulletStartAt && style["bullet"] is System.Text.Json.Nodes.JsonObject bullet)
                        bullet.Remove("startAt");
                    if (maskBulletCharacter && style["bullet"] is System.Text.Json.Nodes.JsonObject character)
                        character.Remove("character");
                    if (maskBulletSize && style["bullet"] is System.Text.Json.Nodes.JsonObject size)
                    {
                        size.Remove("size");
                        size.Remove("sizePercent");
                        size.Remove("sizeFollowText");
                    }
                    if (maskBulletColor && style["bullet"] is System.Text.Json.Nodes.JsonObject color)
                    {
                        color.Remove("color");
                        color.Remove("colorFollowText");
                    }
                    if (maskBulletFont && style["bullet"] is System.Text.Json.Nodes.JsonObject font)
                    {
                        font.Remove("fontFamily");
                        font.Remove("fontFollowText");
                    }
                    if (maskBulletScheme && style["bullet"] is System.Text.Json.Nodes.JsonObject numbering)
                    {
                        numbering.Remove("scheme");
                        numbering.Remove("format");
                    }
                    if (maskSpaceBefore)
                    {
                        style.Remove("spaceBefore");
                        style.Remove("spaceBeforeMultiplier");
                    }
                    if (maskSpaceAfter)
                    {
                        style.Remove("spaceAfter");
                        style.Remove("spaceAfterMultiplier");
                    }
                    if (maskIndent) style.Remove("indent");
                    if (maskRightIndent) style.Remove("rightIndent");
                    if (maskHanging) style.Remove("hanging");
                    if (maskLineSpacing)
                    {
                        style.Remove("lineSpacing");
                        style.Remove("lineSpacingMultiplier");
                    }
                    if ((maskDefaultBold || maskDefaultItalic || maskDefaultSize || maskDefaultFontFamily || maskDefaultEastAsianFont || maskDefaultComplexScriptFont || maskDefaultLanguage || maskDefaultKerning || maskDefaultLetterSpacing || maskDefaultBaseline || maskDefaultCapitalization || maskDefaultStrike || maskDefaultUnderline || maskDefaultHighlight || maskDefaultColor || maskDefaultGradient || maskDefaultGlow || maskDefaultInnerShadow || maskDefaultReflection || maskDefaultShadow || maskDefaultSoftEdge) && style["defaultText"] is System.Text.Json.Nodes.JsonObject defaults)
                    {
                        ...
                        if (maskDefaultLetterSpacing) defaults.Remove("letterSpacing");
                        if (maskDefaultBaseline) defaults.Remove("baseline");
                        if (maskDefaultCapitalization) defaults.Remove("capitalization");
                        if (maskDefaultStrike) defaults.Remove("strike");
                        if (maskDefaultUnderline) defaults.Remove("underline");
                        if (maskDefaultHighlight) defaults.Remove("highlight");
                        if (maskDefaultColor) defaults.Remove("color");
                        if (maskDefaultGradient) defaults.Remove("gradient");
                        if (maskDefaultGlow) defaults.Remove("glow");
                        if (maskDefaultInnerShadow) defaults.Remove("innerShadow");
                        if (maskDefaultReflection) defaults.Remove("reflection");
                        if (maskDefaultShadow) defaults.Remove("shadow");
                        if (maskDefaultSoftEdge) defaults.Remove("softEdge");
    ...
    private static bool ParagraphNumberingSchemeChanged(JsonElement before, JsonElement after, int index) =>
        PropertyChanged(ParagraphBullet(before, index), ParagraphBullet(after, index), "scheme") ||
        PropertyChanged(ParagraphBullet(before, index), ParagraphBullet(after, index), "format");

    private static JsonElement? ParagraphBullet(JsonElement text, int index) =>
        ParagraphStyle(text, index) is { } style && style.TryGetProperty("bullet", out var bullet) ? bullet : null;

    private static JsonElement? ParagraphStyle(JsonElement text, int index) =>
        text.ValueKind == JsonValueKind.Object && text.TryGetProperty("paragraphs", out var paragraphs) &&
        index < paragraphs.GetArrayLength() && paragraphs[index].TryGetProperty("style", out var style) ? style : null;

    private static JsonElement? ParagraphDefaultStyle(JsonElement text, int index) =>
        text.ValueKind == JsonValueKind.Object && text.TryGetProperty("paragraphs", out var paragraphs) &&
        index < paragraphs.GetArrayLength() && paragraphs[index].TryGetProperty("style", out var style) &&
        style.TryGetProperty("defaultText", out var defaults) ? defaults : null;
    ...
    private static void ApplyTextParagraphStyleMutation(
        ...
        bool defaultTabSizeChanged,
        bool eastAsianLineBreakChanged,
        bool latinLineBreakChanged,
        bool hangingPunctuationChanged,
        bool fontAlignmentChanged,
        bool bulletStartAtChanged,
        bool bulletSchemeChanged,
        bool bulletCharacterChanged,
        bool bulletFontChanged,
        bool bulletColorChanged,
        bool bulletSizeChanged,
        ...
        bool defaultLetterSpacingChanged,
        bool defaultBaselineChanged,
        bool defaultCapitalizationChanged,
        bool defaultStrikeChanged,
        bool defaultUnderlineChanged,
        bool defaultHighlightChanged,
        bool defaultColorChanged,
        bool defaultGradientChanged,
        bool defaultGlowChanged,
        bool defaultInnerShadowChanged,
        bool defaultReflectionChanged,
        bool defaultShadowChanged,
        bool defaultSoftEdgeChanged,
        bool spaceBeforeChanged,
        bool spaceAfterChanged,
        bool lineSpacingChanged,
        bool indentChanged,
        bool rightIndentChanged,
        bool hangingChanged)
    {
        ...
        for (var index = 0; index < requested.Paragraphs.Count; index++)
        {
            ...
            if (spaceBeforeChanged &&
                (PropertyChanged(ParagraphStyle(beforeRaw, index), ParagraphStyle(afterRaw, index), "spaceBefore") ||
                 PropertyChanged(ParagraphStyle(beforeRaw, index), ParagraphStyle(afterRaw, index), "spaceBeforeMultiplier")))
            {
                current.ClearSpaceBefore();
                if (next.SpaceBeforeCase == PresentationTextParagraph.SpaceBeforeOneofCase.SpaceBeforePoints)
                    current.SpaceBeforePoints = next.SpaceBeforePoints;
                else if (next.SpaceBeforeCase == PresentationTextParagraph.SpaceBeforeOneofCase.SpaceBeforeMultiplier)
                    current.SpaceBeforeMultiplier = next.SpaceBeforeMultiplier;
                else current.NoSpaceBefore = true;
            }
            if (spaceAfterChanged &&
                (PropertyChanged(ParagraphStyle(beforeRaw, index), ParagraphStyle(afterRaw, index), "spaceAfter") ||
                 PropertyChanged(ParagraphStyle(beforeRaw, index), ParagraphStyle(afterRaw, index), "spaceAfterMultiplier")))
            {
                current.ClearSpaceAfter();
                if (next.SpaceAfterCase == PresentationTextParagraph.SpaceAfterOneofCase.SpaceAfterPoints)
                    current.SpaceAfterPoints = next.SpaceAfterPoints;
                else if (next.SpaceAfterCase == PresentationTextParagraph.SpaceAfterOneofCase.SpaceAfterMultiplier)
                    current.SpaceAfterMultiplier = next.SpaceAfterMultiplier;
                else current.NoSpaceAfter = true;
            }
            if (indentChanged && PropertyChanged(ParagraphStyle(beforeRaw, index), ParagraphStyle(afterRaw, index), "indent"))
            {
                current.ClearLeftMargin();
                if (next.LeftMarginCase == PresentationTextParagraph.LeftMarginOneofCase.MarginLeftEmu)
                    current.MarginLeftEmu = next.MarginLeftEmu;
                else current.NoMarginLeft = true;
            }
            if (rightIndentChanged && PropertyChanged(ParagraphStyle(beforeRaw, index), ParagraphStyle(afterRaw, index), "rightIndent"))
            {
                current.ClearRightMargin();
                if (next.RightMarginCase == PresentationTextParagraph.RightMarginOneofCase.MarginRightEmu)
                    current.MarginRightEmu = next.MarginRightEmu;
                else current.NoMarginRight = true;
            }
            if (hangingChanged && PropertyChanged(ParagraphStyle(beforeRaw, index), ParagraphStyle(afterRaw, index), "hanging"))
            {
                current.ClearIndentation();
                if (next.IndentationCase == PresentationTextParagraph.IndentationOneofCase.IndentEmu)
                    current.IndentEmu = next.IndentEmu;
                else current.NoIndent = true;
            }
            if (lineSpacingChanged &&
                (PropertyChanged(ParagraphStyle(beforeRaw, index), ParagraphStyle(afterRaw, index), "lineSpacing") ||
                 PropertyChanged(ParagraphStyle(beforeRaw, index), ParagraphStyle(afterRaw, index), "lineSpacingMultiplier")))
            {
                current.ClearLineSpacing();
                if (next.LineSpacingCase == PresentationTextParagraph.LineSpacingOneofCase.LineSpacingPoints)
                    current.LineSpacingPoints = next.LineSpacingPoints;
                else if (next.LineSpacingCase == PresentationTextParagraph.LineSpacingOneofCase.LineSpacingMultiplier)
                    current.LineSpacingMultiplier = next.LineSpacingMultiplier;
                else current.NoLineSpacing = true;
            }
            if (bulletSizeChanged &&
                new[] { "size", "sizePercent", "sizeFollowText" }.Any(field =>
                    PropertyChanged(ParagraphBullet(beforeRaw, index), ParagraphBullet(afterRaw, index), field)))
            {
                if (current.BulletCase is PresentationTextParagraph.BulletOneofCase.None or PresentationTextParagraph.BulletOneofCase.NoBullet ||
                    current.BulletCase != next.BulletCase)
                    throw Unsupported(path, "bullet size requires the same existing modeled marker");
                current.ClearBulletSize();
                if (next.BulletSizeCase == PresentationTextParagraph.BulletSizeOneofCase.BulletSizePoints)
                    current.BulletSizePoints = next.BulletSizePoints;
                else if (next.BulletSizeCase == PresentationTextParagraph.BulletSizeOneofCase.BulletSizePercent)
                    current.BulletSizePercent = next.BulletSizePercent;
                else if (next.BulletSizeCase == PresentationTextParagraph.BulletSizeOneofCase.BulletSizeFollowText)
                    current.BulletSizeFollowText = true;
            }
            if (bulletColorChanged &&
                (PropertyChanged(ParagraphBullet(beforeRaw, index), ParagraphBullet(afterRaw, index), "color") ||
                 PropertyChanged(ParagraphBullet(beforeRaw, index), ParagraphBullet(afterRaw, index), "colorFollowText")))
            {
                if (current.BulletCase is PresentationTextParagraph.BulletOneofCase.None or PresentationTextParagraph.BulletOneofCase.NoBullet ||
                    current.BulletCase != next.BulletCase)
                    throw Unsupported(path, "bullet color requires the same existing modeled marker");
                current.ClearBulletColor();
                current.ClearBulletColorOpacityThousandthPercent();
                if (next.BulletColorCase == PresentationTextParagraph.BulletColorOneofCase.BulletColorRgb)
                    current.BulletColorRgb = next.BulletColorRgb;
                else if (next.BulletColorCase == PresentationTextParagraph.BulletColorOneofCase.BulletColorScheme)
                    current.BulletColorScheme = next.BulletColorScheme;
                else if (next.BulletColorCase == PresentationTextParagraph.BulletColorOneofCase.BulletColorFollowText)
                    current.BulletColorFollowText = true;
                if (next.HasBulletColorOpacityThousandthPercent)
                    current.BulletColorOpacityThousandthPercent = next.BulletColorOpacityThousandthPercent;
            }
            if (bulletFontChanged &&
                (PropertyChanged(ParagraphBullet(beforeRaw, index), ParagraphBullet(afterRaw, index), "fontFamily") ||
                 PropertyChanged(ParagraphBullet(beforeRaw, index), ParagraphBullet(afterRaw, index), "fontFollowText")))
            {
                if (current.BulletCase is PresentationTextParagraph.BulletOneofCase.None or PresentationTextParagraph.BulletOneofCase.NoBullet ||
                    current.BulletCase != next.BulletCase)
                    throw Unsupported(path, "bullet font requires the same existing modeled marker");
                current.ClearBulletFont();
                if (next.BulletFontCase == PresentationTextParagraph.BulletFontOneofCase.BulletFontFamily)
                    current.BulletFontFamily = next.BulletFontFamily;
                else if (next.BulletFontCase == PresentationTextParagraph.BulletFontOneofCase.BulletFontFollowText)
                    current.BulletFontFollowText = true;
            }
            if (bulletCharacterChanged && PropertyChanged(ParagraphBullet(beforeRaw, index), ParagraphBullet(afterRaw, index), "character"))
            {
                if (current.BulletCase != PresentationTextParagraph.BulletOneofCase.BulletCharacter ||
                    next.BulletCase != PresentationTextParagraph.BulletOneofCase.BulletCharacter)
                    throw Unsupported(path, "bullet character requires an existing character marker");
                current.BulletCharacter = next.BulletCharacter;
            }
            if (bulletSchemeChanged && ParagraphNumberingSchemeChanged(beforeRaw, afterRaw, index))
            {
                if (current.AutoNumber is null || next.AutoNumber is null)
                    throw Unsupported(path, "bullet scheme requires an existing numbered marker");
                current.AutoNumber.Scheme = next.AutoNumber.Scheme;
            }
            if (bulletStartAtChanged && PropertyChanged(ParagraphBullet(beforeRaw, index), ParagraphBullet(afterRaw, index), "startAt"))
            {
                if (current.AutoNumber is null || next.AutoNumber is null ||
                    current.AutoNumber.Scheme != next.AutoNumber.Scheme)
                    throw Unsupported(path, "bullet startAt requires the same existing numbered marker");
                current.AutoNumber.ClearStartAt();
                if (next.AutoNumber.HasStartAt) current.AutoNumber.StartAt = next.AutoNumber.StartAt;
            }
            if (directionChanged && PropertyChanged(ParagraphStyle(beforeRaw, index), ParagraphStyle(afterRaw, index), "direction"))
            {
                current.ClearRightToLeft();
                if (next.HasRightToLeft) current.RightToLeft = next.RightToLeft;
            }
            if (defaultTabSizeChanged && PropertyChanged(ParagraphStyle(beforeRaw, index), ParagraphStyle(afterRaw, index), "defaultTabSize"))
            {
                current.ClearDefaultTabSizeEmu();
                if (next.HasDefaultTabSizeEmu) current.DefaultTabSizeEmu = next.DefaultTabSizeEmu;
            }
            if (eastAsianLineBreakChanged && PropertyChanged(ParagraphStyle(beforeRaw, index), ParagraphStyle(afterRaw, index), "eastAsianLineBreak"))
            {
                current.ClearEastAsianLineBreak();
                if (next.HasEastAsianLineBreak) current.EastAsianLineBreak = next.EastAsianLineBreak;
            }
            if (latinLineBreakChanged && PropertyChanged(ParagraphStyle(beforeRaw, index), ParagraphStyle(afterRaw, index), "latinLineBreak"))
            {
                current.ClearLatinLineBreak();
                if (next.HasLatinLineBreak) current.LatinLineBreak = next.LatinLineBreak;
            }
            if (hangingPunctuationChanged && PropertyChanged(ParagraphStyle(beforeRaw, index), ParagraphStyle(afterRaw, index), "hangingPunctuation"))
            {
                current.ClearHangingPunctuation();
                if (next.HasHangingPunctuation) current.HangingPunctuation = next.HangingPunctuation;
            }
            if (fontAlignmentChanged && PropertyChanged(ParagraphStyle(beforeRaw, index), ParagraphStyle(afterRaw, index), "fontAlignment"))
            {
                current.ClearFontAlignment();
                if (next.HasFontAlignment) current.FontAlignment = next.FontAlignment;
            }
            if (levelChanged && PropertyChanged(ParagraphStyle(beforeRaw, index), ParagraphStyle(afterRaw, index), "level"))
            {
                current.ClearLevel();
                if (next.HasLevel) current.Level = next.Level;
            }
            ...
            if (defaultBoldChanged || defaultItalicChanged || defaultSizeChanged || defaultFontFamilyChanged || defaultEastAsianFontChanged || defaultComplexScriptFontChanged || defaultLanguageChanged || defaultKerningChanged || defaultLetterSpacingChanged || defaultBaselineChanged || defaultCapitalizationChanged || defaultStrikeChanged || defaultUnderlineChanged || defaultHighlightChanged || defaultColorChanged || defaultGradientChanged || defaultGlowChanged || defaultInnerShadowChanged || defaultReflectionChanged || defaultShadowChanged || defaultSoftEdgeChanged)
            {
                ...
                if (defaultSizeChanged)
                {
                    defaults.ClearFontSizePoints();
                    if (next.DefaultRunProperties is { HasFontSizePoints: true } nextSize)
                    {
                        var size = nextSize.FontSizePoints;
                        if (!double.IsFinite(size) || size < 1 || size > 768)
                            throw Unsupported(path, "paragraph default size must be within 1..768 points");
                        defaults.FontSizePoints = Math.Round(size * 100) / 100d;
                    }
                }
                if (defaultFontFamilyChanged)
                {
                ...
                if (defaultComplexScriptFontChanged)
                {
                    defaults.ClearFontFamilyComplexScript();
                    if (next.DefaultRunProperties is { HasFontFamilyComplexScript: true } nextComplexScript)
                        defaults.FontFamilyComplexScript = nextComplexScript.FontFamilyComplexScript;
                }
                if (defaultLanguageChanged)
                {
                ...
                if (defaultLetterSpacingChanged)
                {
                    defaults.ClearFontSpacingPoints();
                    if (next.DefaultRunProperties is { HasFontSpacingPoints: true } nextSpacing)
                    {
                        var spacing = nextSpacing.FontSpacingPoints;
                        if (!double.IsFinite(spacing) || spacing < -768 || spacing > 768)
                            throw Unsupported(path, "paragraph default letter spacing must be within -768..768 points");
                        // Match the native integer value, including canonical
                        // zero when a small negative spacing rounds to -0.
                        defaults.FontSpacingPoints = checked((int)Math.Round(spacing * 100)) / 100d;
                    }
                }
                if (defaultBaselineChanged)
                {
                    defaults.ClearFontBaselinePercent();
                    if (next.DefaultRunProperties is { HasFontBaselinePercent: true } nextBaseline)
                    {
                        var baseline = nextBaseline.FontBaselinePercent;
                        if (!double.IsFinite(baseline) || baseline < -400 || baseline > 400)
                            throw Unsupported(path, "paragraph default baseline must be within -400..400 percent");
                        defaults.FontBaselinePercent = checked((int)Math.Round(baseline * 1000)) / 1000d;
                    }
                }
                if (defaultCapitalizationChanged)
                {
                    defaults.ClearFontCaps();
                    if (next.DefaultRunProperties is { HasFontCaps: true } nextCaps)
                        defaults.FontCaps = nextCaps.FontCaps;
                }
                if (defaultStrikeChanged)
                {
                    defaults.ClearStrike();
                    if (next.DefaultRunProperties is { HasStrike: true } nextStrike)
                        defaults.Strike = nextStrike.Strike;
                }
                if (defaultUnderlineChanged)
                {
                    defaults.ClearUnderline();
                    if (next.DefaultRunProperties is { HasUnderline: true } nextUnderline)
                        defaults.Underline = nextUnderline.Underline;
                }
                if (defaultHighlightChanged && PropertyChanged(
                    ParagraphDefaultStyle(beforeRaw, index), ParagraphDefaultStyle(afterRaw, index), "highlight"))
                {
                    defaults.ClearHighlight();
                    if (next.DefaultRunProperties is { HighlightCase: PresentationTextStyle.HighlightOneofCase.HighlightRgb } nextHighlight)
                    {
                        defaults.HighlightRgb = nextHighlight.HighlightRgb;
                        var raw = ParagraphDefaultStyle(afterRaw, index)!.Value.GetProperty("highlight");
                        if (raw.ValueKind == JsonValueKind.Object && raw.TryGetProperty("token", out var token) &&
                            token.ValueKind == JsonValueKind.String)
                        {
                            if (TryDeclaredGrammarToken(programRoot, token.GetString()!, out _))
                            {
                                var color = ResolveGrammarColorValue(programRoot, raw, path + ".paragraphStyle.defaultText.highlight");
                                if (Math.Abs(color.Alpha - 1d) > 1e-9)
                                    throw Unsupported(path, "paragraph default highlight must resolve to opaque color");
                                defaults.HighlightRgb = color.Rgb;
                            }
                            else if (!raw.TryGetProperty("tint", out _) && !raw.TryGetProperty("shade", out _) &&
                                PptxColor.TrySchemeToken(token.GetString()!, out var scheme))
                                defaults.HighlightScheme = scheme;
                        }
                    }
                }
                if (defaultColorChanged && PropertyChanged(
                    ParagraphDefaultStyle(beforeRaw, index), ParagraphDefaultStyle(afterRaw, index), "color"))
                {
                    defaults.ClearColor();
                    defaults.ClearColorOpacityThousandthPercent();
                    if (next.DefaultRunProperties is { ColorCase: PresentationTextStyle.ColorOneofCase.ColorRgb } nextColor)
                    {
                        defaults.ColorRgb = nextColor.ColorRgb;
                        if (nextColor.HasColorOpacityThousandthPercent)
                            defaults.ColorOpacityThousandthPercent = nextColor.ColorOpacityThousandthPercent;
                        var raw = ParagraphDefaultStyle(afterRaw, index)!.Value.GetProperty("color");
                        var explicitAlpha = raw.ValueKind == JsonValueKind.String
                            ? raw.GetString()!.TrimStart('#').Length == 8
                            : raw.TryGetProperty("alpha", out _);
                        if (raw.ValueKind == JsonValueKind.Object && raw.TryGetProperty("token", out var token) &&
                            token.ValueKind == JsonValueKind.String)
                        {
                            if (TryDeclaredGrammarToken(programRoot, token.GetString()!, out _))
                            {
                                var color = ResolveGrammarColorValue(programRoot, raw, path + ".paragraphStyle.defaultText.color");
                                defaults.ColorRgb = color.Rgb;
                                defaults.ClearColorOpacityThousandthPercent();
                                if (explicitAlpha || color.Alpha < 1) defaults.ColorOpacityThousandthPercent = Unit(color.Alpha);
                            }
                            else if (!raw.TryGetProperty("tint", out _) && !raw.TryGetProperty("shade", out _) &&
                                PptxColor.TrySchemeToken(token.GetString()!, out var scheme))
                                defaults.ColorScheme = scheme;
                        }
                        if (explicitAlpha && !defaults.HasColorOpacityThousandthPercent)
                            defaults.ColorOpacityThousandthPercent = 100_000;
                    }
                }
                if (defaultGradientChanged && PropertyChanged(
                    ParagraphDefaultStyle(beforeRaw, index), ParagraphDefaultStyle(afterRaw, index), "gradient"))
                {
                    defaults.GradientFill = next.DefaultRunProperties?.GradientFill?.Clone();
                    if (defaults.GradientFill is { } gradient)
                    {
                        var stops = ParagraphDefaultStyle(afterRaw, index)!.Value.GetProperty("gradient").GetProperty("stops");
                        for (var stopIndex = 0; stopIndex < gradient.Stops.Count; stopIndex++)
                        {
                            var rawStop = stops[stopIndex];
                            var rawColor = rawStop.GetProperty("color");
                            if (rawColor.ValueKind == JsonValueKind.Object && rawColor.TryGetProperty("token", out var token) &&
                                token.ValueKind == JsonValueKind.String && TryDeclaredGrammarToken(programRoot, token.GetString()!, out _))
                            {
                                var color = ResolveGrammarColorValue(programRoot, rawColor, path + ".paragraphStyle.defaultText.gradient");
                                var stop = gradient.Stops[stopIndex];
                                stop.ColorRgb = color.Rgb;
                                if (!rawStop.TryGetProperty("opacity", out _))
                                {
                                    stop.ClearOpacityThousandthPercent();
                                    if (color.Alpha < 1) stop.OpacityThousandthPercent = Unit(color.Alpha);
                                }
                            }
                        }
                    }
                }
                if (defaultGlowChanged && PropertyChanged(
                    ParagraphDefaultStyle(beforeRaw, index), ParagraphDefaultStyle(afterRaw, index), "glow"))
                {
                    defaults.Glow = next.DefaultRunProperties?.Glow?.Clone();
                    if (defaults.Glow is not null)
                    {
                        var raw = ParagraphDefaultStyle(afterRaw, index)!.Value.GetProperty("glow");
                        var rawColor = raw.GetProperty("color");
                        if (rawColor.ValueKind == JsonValueKind.Object && rawColor.TryGetProperty("token", out var token) &&
                            token.ValueKind == JsonValueKind.String && TryDeclaredGrammarToken(programRoot, token.GetString()!, out _))
                            defaults.Glow = PpjAuthoredPresentationCompiler.BuildParagraphGlow(raw,
                                color => ResolveGrammarColorValue(programRoot, color, path + ".paragraphStyle.defaultText.glow.color"),
                                opacity => ResolveGrammarOpacityToken(programRoot, opacity, path + ".paragraphStyle.defaultText.glow.opacity"),
                                name => TryDeclaredGrammarToken(programRoot, name, out _));
                    }
                }
                if (defaultReflectionChanged && PropertyChanged(
                    ParagraphDefaultStyle(beforeRaw, index), ParagraphDefaultStyle(afterRaw, index), "reflection"))
                    defaults.Reflection = next.DefaultRunProperties?.Reflection?.Clone();
                if (defaultInnerShadowChanged && PropertyChanged(
                    ParagraphDefaultStyle(beforeRaw, index), ParagraphDefaultStyle(afterRaw, index), "innerShadow"))
                {
                    defaults.InnerShadow = next.DefaultRunProperties?.InnerShadow?.Clone();
                    if (defaults.InnerShadow is not null)
                    {
                        var raw = ParagraphDefaultStyle(afterRaw, index)!.Value.GetProperty("innerShadow");
                        var rawColor = raw.GetProperty("color");
                        if (rawColor.ValueKind == JsonValueKind.Object && rawColor.TryGetProperty("token", out var token) &&
                            token.ValueKind == JsonValueKind.String && TryDeclaredGrammarToken(programRoot, token.GetString()!, out _))
                            defaults.InnerShadow = PpjAuthoredPresentationCompiler.BuildParagraphInnerShadow(raw,
                                color => ResolveGrammarColorValue(programRoot, color, path + ".paragraphStyle.defaultText.innerShadow.color"),
                                opacity => ResolveGrammarOpacityToken(programRoot, opacity, path + ".paragraphStyle.defaultText.innerShadow.opacity"),
                                name => TryDeclaredGrammarToken(programRoot, name, out _));
                    }
                }
                if (defaultShadowChanged && PropertyChanged(
                    ParagraphDefaultStyle(beforeRaw, index), ParagraphDefaultStyle(afterRaw, index), "shadow"))
                {
                    defaults.Shadow = next.DefaultRunProperties?.Shadow?.Clone();
                    if (defaults.Shadow is not null)
                    {
                        var raw = ParagraphDefaultStyle(afterRaw, index)!.Value.GetProperty("shadow");
                        var rawColor = raw.GetProperty("color");
                        if (rawColor.ValueKind == JsonValueKind.Object && rawColor.TryGetProperty("token", out var token) &&
                            token.ValueKind == JsonValueKind.String && TryDeclaredGrammarToken(programRoot, token.GetString()!, out _))
                            defaults.Shadow = PpjAuthoredPresentationCompiler.BuildParagraphShadow(raw,
                                color => ResolveGrammarColorValue(programRoot, color, path + ".paragraphStyle.defaultText.shadow.color"),
                                opacity => ResolveGrammarOpacityToken(programRoot, opacity, path + ".paragraphStyle.defaultText.shadow.opacity"),
                                name => TryDeclaredGrammarToken(programRoot, name, out _));
                    }
                }
                if (defaultSoftEdgeChanged && PropertyChanged(
                    ParagraphDefaultStyle(beforeRaw, index), ParagraphDefaultStyle(afterRaw, index), "softEdge"))
                    defaults.SoftEdge = next.DefaultRunProperties?.SoftEdge?.Clone();
