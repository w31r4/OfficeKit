...
{
    [Fact]
    public void PpjSourceBoundShape3dDepthLeafEditsAndReprojects()
    {
        var authored = Invoke(ExportRequest());
        Assert.True(authored.Ok, Diagnostics(authored));
        var source = AddShape3dDepth(RemoveEmbeddedPpj(authored.File.ToByteArray()), -1_200);
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            {
                SourceUri = "deck.assets/source/shape-3d-depth.pptx",
            },
        });
        ...
        var leaves = projectedShape["nativeRef"]!["leaves"]!.AsArray()
            ...
            .Where(leaf => leaf["kind"]!.GetValue<string>() == "shape3dDepthEmu")
            .ToArray();
        ...
        Assert.Contains("z=\"-2400\"", editedXml, StringComparison.Ordinal);
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/shape-3d-depth.pptx",
            },
        });
    ...
    private static byte[] AddShape3dDepth(byte[] source, long depth)
    {
