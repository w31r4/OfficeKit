...
{
    [Fact]
    public void PpjSourceBoundThemeAccent4TintEditsOnlyTintAndReprojects()
    {
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            {
                SourceUri = "deck.assets/source/theme-accent4-tint.pptx",
            },
        });
        ...
        Assert.Contains(nativeRef["capabilities"]!.AsArray(), capability =>
            capability!["operation"]!.GetValue<string>() == "setThemeAccent4Tint" &&
            capability["fields"]!.AsArray().Any(field => field!.GetValue<string>() == "accentTransforms.accent4.tint"));
        ...
        editedProgram["design"]!["theme"]!["accentTransforms"]!["accent4"]!["tint"] = 0.7;
        ...
        using (var package = PresentationDocument.Open(stream, false))
        {
            ...
            Assert.Equal(70_000, Assert.Single(accent4.Elements<A.Tint>()).Val!.Value);
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/theme-accent4-tint.pptx",
            },
        });
        Assert.True(reprojected.Ok, Diagnostics(reprojected));
        var reprojectedProgram = JsonNode.Parse(reprojected.PresentationProgram.ProgramJson.ToByteArray())!.AsObject();
        Assert.Equal(0.7, reprojectedProgram["design"]!["theme"]!["accentTransforms"]!["accent4"]!["tint"]!.GetValue<double>());

        var unauthorizedProgram = JsonNode.Parse(projectedProgram.ToJsonString())!.AsObject();
        unauthorizedProgram["design"]!["theme"]!["accentTransforms"]!["accent4"]!["tint"] = 0.8;
        unauthorizedProgram["design"]!["theme"]!["nativeRef"]!["capabilities"]!.AsArray()
            .Single(capability => capability!["operation"]!.GetValue<string>() == "setThemeAccent4Tint")!["fields"] = new JsonArray("accentTransforms.accent4.shade");
        ...
        deletionProgram["design"]!["theme"]!["accentTransforms"]!["accent4"]!.AsObject().Remove("tint");
        ...
        outOfRangeProgram["design"]!["theme"]!["accentTransforms"]!["accent4"]!["tint"] = 1.01;
