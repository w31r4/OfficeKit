...
modulation transforms. A direct imported accent3 `a:blueMod` remains opaque,
...
- Project a canonical shared ThemePart whose accent3 direct RGB leaf contains
  ...
  `design.theme.accentTransforms.accent3.blueMod`, using a 0..1 fraction.
- Issue `setThemeAccent3BlueMod` for that field and compile one authorized
...
- `presentation-theme-accent3-bluemod`: Strict source-bound projection and
  source-preserving editing of one direct accent3 `a:blueMod` leaf.
