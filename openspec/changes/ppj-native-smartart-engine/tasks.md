## 1. Contract and authored native slice

- [x] 1.1 Add PPJ `connections` and `definitionAsset` schema/model validation.
- [x] 1.2 Add the additive `PresentationDiagram` wire contract and regenerate bindings.
- [x] 1.3 Compile the eight authored layouts to native SmartArt with a cached drawing.
- [x] 1.4 Reimport OfficeKit-authored native SmartArt as typed PPJ without embedded recovery.

## 2. Definition assets and deterministic engine
