...
{
    [Fact]
    public void PpjSourceBoundPictureShape3dContourColorSchemeLeafEditsAndReprojects()
    {
        ...
        var source = AddPictureShape3dContourColorScheme(RemoveEmbeddedPpj(authored.File.ToByteArray()), "accent1");
        var projected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/source/picture-shape-3d-contour-scheme.pptx",
            },
        });
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/picture-shape-3d-contour-scheme.pptx",
            },
        });
    ...
    private static byte[] AddPictureShape3dContourColorScheme(byte[] source, string scheme)
    {
