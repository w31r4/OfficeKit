...
{
    [Fact]
    public void PpjSourceBoundThemeAccent2SatModEditsOnlySatModAndReprojects()
    {
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            {
                SourceUri = "deck.assets/source/theme-accent2-satmod.pptx",
            },
        });
        ...
        Assert.Contains(nativeRef["capabilities"]!.AsArray(), capability =>
            capability!["operation"]!.GetValue<string>() == "setThemeAccent2SatMod" &&
            capability["fields"]!.AsArray().Any(field => field!.GetValue<string>() == "accentTransforms.accent2.satMod"));
        ...
        editedProgram["design"]!["theme"]!["accentTransforms"]!["accent2"]!["satMod"] = 0.5;
        ...
        using (var package = PresentationDocument.Open(stream, false))
        {
            ...
            Assert.Equal(50_000, Assert.Single(accent2.Elements<A.SaturationModulation>()).Val!.Value);
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/theme-accent2-satmod.pptx",
            },
        });
        Assert.True(reprojected.Ok, Diagnostics(reprojected));
        var reprojectedProgram = JsonNode.Parse(reprojected.PresentationProgram.ProgramJson.ToByteArray())!.AsObject();
        Assert.Equal(0.5, reprojectedProgram["design"]!["theme"]!["accentTransforms"]!["accent2"]!["satMod"]!.GetValue<double>());

        var unauthorizedProgram = JsonNode.Parse(projectedProgram.ToJsonString())!.AsObject();
        unauthorizedProgram["design"]!["theme"]!["accentTransforms"]!["accent2"]!["satMod"] = 0.6;
        unauthorizedProgram["design"]!["theme"]!["nativeRef"]!["capabilities"]!.AsArray()
            .Single(capability => capability!["operation"]!.GetValue<string>() == "setThemeAccent2SatMod")!["fields"] = new JsonArray("accentTransforms.accent2.shade");
        ...
        deletionProgram["design"]!["theme"]!["accentTransforms"]!["accent2"]!.AsObject().Remove("satMod");
        ...
        outOfRangeProgram["design"]!["theme"]!["accentTransforms"]!["accent2"]!["satMod"] = 1.01;
