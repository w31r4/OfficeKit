...
export const HELP_CATALOG = [
  ...
  { artifactKind: "presentation", kind: "api", name: "presentation.master.setNativeBackgroundImage", summary: "Set one embedded stretch-only native p:bg image on the Slide Master so inheriting slides receive a true background beneath their content. Crop, tile, effects, links, and complex imported graphs remain unsupported and fail closed." },
  { artifactKind: "presentation", kind: "api", name: "presentation.master.clearNativeBackgroundImage", summary: "Clear the Slide Master's direct native p:bg image without flattening or rewriting the inherited theme background." },
  ...
  { artifactKind: "presentation", kind: "api", name: "presentation.layout.setNativeBackgroundImage", summary: "Set one embedded stretch-only native p:bg image on a Slide Layout. Slides using the layout inherit it beneath their content; unsupported crop, tile, effects, links, and complex imported graphs fail closed." },
  { artifactKind: "presentation", kind: "api", name: "presentation.layout.clearNativeBackgroundImage", summary: "Clear a layout's direct native p:bg image and preserve the linked Slide Master background chain." },
...
const PRESENTATION_HELP_SCHEMAS = {
  ...
  "presentation.slides.add": helpSchema({
    ...
    background: { type: "string|object", description: "Optional direct slide background: RGB/theme color or { image: { dataUrl|assetId, fit: 'stretch' } } for one embedded native image. Crop, tile, transform, effects, links, and irregular imported graphs remain source-bound and fail closed." },
  ...
  "presentation.slides.insert": helpSchema({
    ...
    background: { type: "string|object", description: "Optional direct slide background: RGB/theme color or { image: { dataUrl|assetId, fit: 'stretch' } } for one embedded native image." },
  ...
  "presentation.master": helpSchema({
    ...
    background: { type: "string|object", description: "Solid RGB/scheme background, native style reference with index, or { image: { dataUrl|assetId, fit: 'stretch' } } for one embedded native p:bg image." },
  ...
  "presentation.master.setNativeBackgroundImage": helpSchema({
    blob: { type: "FileBlob", description: "Embedded PNG, JPEG, GIF, or safe SVG bytes." },
    dataUrl: { type: "string", description: "Embedded image data URL." },
    assetId: { type: "string", description: "Existing content-addressed presentation image asset ID." },
    fit: { type: "string", description: "Must be stretch; crop, tile, effects, transforms, and external links are unsupported." },
    alphaModulationFixed: { type: "boolean", description: "Optional preservation flag for a parameterless imported a:alphaModFix child." },
  ...
  "presentation.master.clearNativeBackgroundImage": helpSchema({}, "master", "PresentationSlideMaster", "Clear the direct native p:bg image on the Slide Master and preserve inherited theme/background behavior."),
  ...
  "presentation.layouts.add": helpSchema({
    ...
    background: { type: "string|object", description: "Optional layout background overriding the linked master: RGB/theme color or { image: { dataUrl|assetId, fit: 'stretch' } } for one embedded native image." },
  ...
  "presentation.layout.setBackground": helpSchema({
    background: { type: "string|object", required: true, description: "Direct solid RGB/scheme background, native style reference with index, or { image: { dataUrl|assetId, fit: 'stretch' } } for one embedded native p:bg image." },
  ...
  "presentation.layout.setNativeBackgroundImage": helpSchema({
    blob: { type: "FileBlob", description: "Embedded PNG, JPEG, GIF, or safe SVG bytes." },
    dataUrl: { type: "string", description: "Embedded image data URL." },
    assetId: { type: "string", description: "Existing content-addressed presentation image asset ID." },
    fit: { type: "string", description: "Must be stretch; crop, tile, effects, transforms, and external links are unsupported." },
  ...
  "presentation.layout.clearNativeBackgroundImage": helpSchema({}, "layout", "SlideLayoutTemplate", "Clear the layout's direct native p:bg image and preserve its linked Slide Master background chain."),
