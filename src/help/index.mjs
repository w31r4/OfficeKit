...
export const HELP_CATALOG = [
  ...
  { artifactKind: "presentation", kind: "api", name: "slide.shapes.add", summary: "Add a shape/textbox with preset or bounded DrawingML custom geometry, including ordered adjustment/guide formulas, optional custom-shape text rectangle, position, center-based rotation/flips, fill, line, text, and text-body layout." },
