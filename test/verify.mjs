...
consistencySheet.dataValidations.items.push({ id: "invalid-validation", kind: "dataValidation", sheet: consistencySheet.name, range: "??", rule: { type: "list", values: [] } });
...
assert.match(consistencyIssues, /dataValidationRuleInvalid/);
