...
{
    [Fact]
    public void PpjSourceBoundThemeColorRoleFollowedHyperlinkRgbaEditsOnlyFollowedHyperlinkAndReprojects()
    {
        ...
        authoredTheme.FollowedHyperlinkRgb = "60616240";
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            {
                SourceUri = "deck.assets/source/theme-color-role-followed-hyperlink.pptx",
            },
        });
        ...
        Assert.Equal("#505152", projectedColorRoles["hyperlink"]!.GetValue<string>());
        Assert.Equal("#60616240", projectedColorRoles["followedHyperlink"]!.GetValue<string>());
        ...
        Assert.Contains(nativeRef["capabilities"]!.AsArray(), capability =>
            capability!["operation"]!.GetValue<string>() == "setThemeColorRoleFollowedHyperlink" &&
            capability["fields"]!.AsArray().Any(field => field!.GetValue<string>() == "colorRoles.followedHyperlink"));
        Assert.Contains(nativeRef["capabilities"]!.AsArray(), capability =>
            capability!["operation"]!.GetValue<string>() == "setThemeColorRoleHyperlink" &&
            capability["fields"]!.AsArray().Any(field => field!.GetValue<string>() == "colorRoles.hyperlink"));
        ...
        editedProgram["design"]!["theme"]!["colorRoles"]!["followedHyperlink"] = "#ABCDEF40";
        ...
        using (var package = PresentationDocument.Open(stream, false))
        {
            ...
            Assert.Equal("ABCDEF", scheme.FollowedHyperlinkColor!.RgbColorModelHex!.Val!.Value);
            Assert.Equal(25098, scheme.FollowedHyperlinkColor.RgbColorModelHex.GetFirstChild<A.Alpha>()!.Val!.Value);
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/theme-color-role-followed-hyperlink.pptx",
            },
        });
        Assert.True(reprojected.Ok, Diagnostics(reprojected));
        var reprojectedProgram = JsonNode.Parse(reprojected.PresentationProgram.ProgramJson.ToByteArray())!.AsObject();
        Assert.Equal("#ABCDEF40", reprojectedProgram["design"]!["theme"]!["colorRoles"]!["followedHyperlink"]!.GetValue<string>());

        var alphaPresenceProgram = JsonNode.Parse(projectedProgram.ToJsonString())!.AsObject();
        alphaPresenceProgram["design"]!["theme"]!["colorRoles"]!["followedHyperlink"] = "#ABCDEF";
        ...
        unauthorizedProgram["design"]!["theme"]!["colorRoles"]!.AsObject().Remove("followedHyperlink");
        ...
        tamperedProgram["design"]!["theme"]!["nativeRef"]!["capabilities"]!.AsArray()
            .Single(capability => capability!["operation"]!.GetValue<string>() == "setThemeColorRoleFollowedHyperlink")!["fields"] = new JsonArray("colorRoles.hyperlink");
