...
Use this style when the brief matches **place-based annual report; work presentation**. It is designed for
operators, managers, cross-functional teams. Its visual premise is Warm paper and clay accents give business evidence a humane cadence. The style is a
...
**current state → signal → cause → trade-off → intervention → owner/date → follow-through**. This style is not a good fit for **night incident**;
...
- Use **#F4ECE0** as the main field, **#3A2B25** for primary type, **#C96B35** for the decisive signal, **#D89AA0** for secondary evidence, and **#D7C7B8** for rules or context.
...
- The recurring structure is **kiln, variable page silhouettes, documentary imagery**. Vary the silhouette between
  cover, evidence, data, process, comparison, and decision pages rather than
  repeating a component grid.
- Use warm paper, solid blocks, and crafted irregularity sparingly to give operating evidence a human cadence. Keep data geometry crisp inside the warmer surface.
...
The expected density is **sparse**: concentrate it around the title-to-body transition, chart
edges, column gutters, and the final implication.

## Style-specific playbook

- **Page skeleton.** Use warm off-white paper, a hairline split, and a fixed kicker/title/subtitle sequence. Let the left side make the claim and the right side carry one chart, photograph, or attribution; finish with a thin verdict line.
- **Type rhythm.** Use a Kai-like serif for titles and key numbers, and a calm sans for labels, body, tables, and sources. Preserve generous line height; the style is quiet because its hierarchy is precise.
- **Evidence carriers.** Use single-series bars, borderless comparison tables, four-step lists, and one cause-attribution graphic. A chart should carry one conclusion, not an entire dashboard.
- **Images and layers.** A portrait or craft/process photo can appear on the cover or a chapter page. Keep its crop square and its foreground clear; do not cover it with decorative labels.
- **Pacing.** Low density is intentional. Alternate a headline or three-number pause with one evidence page, and use one terracotta focal point per page.
- **Selection rule.** Choose this style for humane annual reviews, craft or service narratives, and business material that needs warmth without losing discipline.

## Signature moves and variation limits

- Let **kiln** recur as a quiet identity cue on selected pages; it must
