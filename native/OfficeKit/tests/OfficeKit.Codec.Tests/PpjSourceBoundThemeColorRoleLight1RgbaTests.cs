...
{
    [Fact]
    public void PpjSourceBoundThemeColorRoleLight1RgbaEditsOnlyLight1AndReprojects()
    {
        ...
        authoredTheme.Light1Rgb = "20212240";
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            {
                SourceUri = "deck.assets/source/theme-color-role-light1.pptx",
            },
        });
        ...
        Assert.Equal("#20212240", projectedColorRoles["light1"]!.GetValue<string>());
        ...
        editedProgram["design"]!["theme"]!["colorRoles"]!["light1"] = "#ABCDEF40";
        ...
        using (var package = PresentationDocument.Open(stream, false))
        {
            ...
            Assert.Equal("ABCDEF", scheme.Light1Color!.RgbColorModelHex!.Val!.Value);
            Assert.Equal(25098, scheme.Light1Color.RgbColorModelHex.GetFirstChild<A.Alpha>()!.Val!.Value);
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/theme-color-role-light1.pptx",
            },
        });
        Assert.True(reprojected.Ok, Diagnostics(reprojected));
        var reprojectedProgram = JsonNode.Parse(reprojected.PresentationProgram.ProgramJson.ToByteArray())!.AsObject();
        Assert.Equal("#ABCDEF40", reprojectedProgram["design"]!["theme"]!["colorRoles"]!["light1"]!.GetValue<string>());

        var alphaPresenceProgram = JsonNode.Parse(projectedProgram.ToJsonString())!.AsObject();
        alphaPresenceProgram["design"]!["theme"]!["colorRoles"]!["light1"] = "#ABCDEF";
        ...
        unauthorizedProgram["design"]!["theme"]!["colorRoles"]!.AsObject().Remove("light1");
        ...
        tamperedProgram["design"]!["theme"]!["nativeRef"]!["capabilities"]!.AsArray()
            .Single(capability => capability!["operation"]!.GetValue<string>() == "setThemeColorRoleLight1")!["fields"] = new JsonArray("colorRoles.dark2");
