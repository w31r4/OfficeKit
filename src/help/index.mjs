...
const PRESENTATION_HELP_SCHEMAS = {
  ...
  "slide.shapes.add": helpSchema({
    ...
    accessibility: { type: "object", description: "Ordinary p:sp only: non-visible { title?, description? }, each 1-1,024 XML-safe characters, mapped to p:nvSpPr/p:cNvPr. It is independent of visible text/name. Connectors reject it; irregular imports stay source-bound." },
