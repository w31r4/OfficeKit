...
export const HELP_CATALOG = [
  ...
  { artifactKind: "presentation", kind: "api", name: "shape.accessibilityCapability", summary: "Report sourceBound/editable/addable preflight for ordinary-shape p:cNvPr title/description; export re-proves it." },
  { artifactKind: "presentation", kind: "api", name: "shape.setAccessibilityMetadata", summary: "Add, change, or clear non-visible ordinary-shape title/description. Imported irregular p:cNvPr graphs fail closed." },
  ...
  { artifactKind: "presentation", kind: "api", name: "connector.accessibilityCapability", summary: "Report sourceBound/editable/addable preflight for connector p:cNvPr title/description; export re-proves it." },
  { artifactKind: "presentation", kind: "api", name: "connector.setAccessibilityMetadata", summary: "Add, change, or clear non-visible connector title/description. Imported irregular p:cNvPr graphs fail closed without disabling unrelated supported edits." },
  ...
  { artifactKind: "presentation", kind: "api", name: "group.accessibilityCapability", summary: "Report sourceBound/editable/addable preflight for group-frame p:cNvPr title/description; export re-proves it." },
  { artifactKind: "presentation", kind: "api", name: "group.setAccessibilityMetadata", summary: "Add, change, or clear non-visible group-frame title/description. Imported irregular p:cNvPr graphs fail closed without disabling unrelated supported edits." },
  ...
  { artifactKind: "presentation", kind: "api", name: "slide.images.add", summary: "Add an inspectable image facade with non-visible title/description metadata, the compatible alt description alias, embedded data, contain/cover/stretch fitting, explicit crop, frame, direct rotation/flips, layout JSON, crop-aware SVG preview, and PPTX output. OfficeKit maps the bounded rectangular profile to native DrawingML p:cNvPr and a:srcRect." },
  { artifactKind: "presentation", kind: "api", name: "image.accessibilityCapability", summary: "Report sourceBound/editable/addable preflight for picture p:cNvPr title/description; export re-proves the residual-protected picture profile." },
  { artifactKind: "presentation", kind: "api", name: "image.setAccessibilityMetadata", summary: "Add, change, or clear a picture's non-visible title/description. The legacy image.alt property reads and writes the same description state rather than creating a second metadata source." },
...
const PRESENTATION_HELP_SCHEMAS = {
  ...
  "slide.shapes.add": helpSchema({
    ...
    accessibility: { type: "object", description: "Non-visible { title?, description? }, each 1-1,024 XML-safe characters, mapped to the native p:cNvPr of an ordinary p:sp or exact-site p:cxnSp connector. It is independent of visible text/name; irregular imports stay source-bound." },
  ...
  "slide.shapes.connect": helpSchema({
    ...
    accessibility: { type: "object", description: "Optional non-visible connector { title?, description? }, each 1-1,024 XML-safe characters, mapped to p:nvCxnSpPr/p:cNvPr." },
  ...
  "slide.groups.add": helpSchema({
    ...
    accessibility: { type: "object", description: "Optional non-visible group { title?, description? }, each 1-1,024 XML-safe characters, mapped to p:nvGrpSpPr/p:cNvPr." },
  ...
  "slide.images.add": helpSchema({
    ...
    accessibility: { type: "object", description: "Non-visible { title?, description? }, each 1-1,024 XML-safe characters, mapped to p:nvPicPr/p:cNvPr independently of the object name and visible pixels." },
  ...
  "image.accessibilityCapability": helpSchema({}, "capability", "object", "Fresh { sourceBound, editable, addable } preflight for picture title/description metadata."),
