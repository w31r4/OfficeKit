...
for (const field of ["bold", "italic", "size", "fontFamily", "fontFamilyEastAsia", "fontFamilyComplexScript", "language", "kerning", "letterSpacing", "baseline", "capitalization", "strike", "underline", "highlight"]) {
  const defaults = assessPpjPreviewInput(deck([{ ...text, text: { paragraphs: [{ style: { defaultText: { [field]: field === "highlight" ? "#FFFF00" : field.startsWith("fontFamily") ? "Georgia" : ["size", "kerning", "letterSpacing", "baseline"].includes(field) ? 18.25 : field === "language" ? "fr-FR" : ["capitalization", "underline"].includes(field) ? "none" : false } }, runs: [{ text: "Default style" }] }] } }]));
