# Proposal: add source-bound paragraph default-text reflection start-opacity ownership to PPJ

Expose a bounded `paragraph.style.defaultText.reflection.startOpacity` owner
...
can change that start opacity without rewriting the surrounding slide.
