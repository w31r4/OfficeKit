...
{
    [Fact]
    public void PpjSourceBoundShape3dSceneCameraFovLeafEditsAndReprojects()
    {
        var authored = Invoke(ExportRequest());
        Assert.True(authored.Ok, Diagnostics(authored));
        var source = AddShape3dSceneCameraFov(RemoveEmbeddedPpj(authored.File.ToByteArray()), "2700000");
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            {
                SourceUri = "deck.assets/source/shape-3d-scene-camera-fov.pptx",
            },
        });
        ...
        Assert.Contains("<a:camera prst=\"perspectiveFront\" fov=\"5400000\"", editedXml, StringComparison.Ordinal);
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/shape-3d-scene-camera-fov.pptx",
            },
        });
    ...
    private static byte[] AddShape3dSceneCameraFov(byte[] source, string fov)
    {
