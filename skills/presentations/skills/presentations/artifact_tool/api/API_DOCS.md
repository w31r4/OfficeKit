...
- Author or safely adjust native PowerPoint sections as an ordered full-deck partition, including the narrow source-bound name transaction: [`references/sections.spec.md`](./references/sections.spec.md).
...
- [`references/sections.spec.md`](./references/sections.spec.md) — native PowerPoint section authoring, fixed-topology imported boundary edits, the shipped source-bound name transaction, opaque preservation, and verification.
