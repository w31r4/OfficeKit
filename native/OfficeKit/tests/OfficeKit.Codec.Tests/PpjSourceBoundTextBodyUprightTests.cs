...
{
    [Fact]
    public void PpjSourceBoundTextBodyUprightEditsLeafAndReprojects()
    {
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/text-body-upright.pptx",
            },
        });
        ...
        Assert.False(reprojectedShape["textStyle"]!["upright"]!.GetValue<bool>());
        Assert.False(reprojectedShape["nativeRef"]!["leaves"]!.AsArray().Single(leaf =>
            leaf!["kind"]!.GetValue<string>() == "textBodyUpright")["value"]!.GetValue<bool>());
    }
}
