...
{
    [Fact]
    public void PpjSourceBoundThemeColorRoleFollowedHyperlinkEditsOnlyFollowedHyperlinkAndReprojects()
    {
        ...
        Assert.Equal("#606162", projectedColorRoles["followedHyperlink"]!.GetValue<string>());
        ...
        editedProgram["design"]!["theme"]!["colorRoles"]!["followedHyperlink"] = "#ABCDEF";
        ...
        Assert.Equal("#ABCDEF", reprojectedProgram["design"]!["theme"]!["colorRoles"]!["followedHyperlink"]!.GetValue<string>());
