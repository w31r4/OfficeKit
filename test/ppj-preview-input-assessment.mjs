...
for (const field of ["bold", "italic", "size", "fontFamily", "fontFamilyEastAsia", "fontFamilyComplexScript"]) {
  const defaults = assessPpjPreviewInput(deck([{ ...text, text: { paragraphs: [{ style: { defaultText: { [field]: field.startsWith("fontFamily") ? "Georgia" : field === "size" ? 18.25 : false } }, runs: [{ text: "Default style" }] }] } }]));
