...
{
    [Fact]
    public void PpjSourceBoundShape3dSceneBackdropNormalDyLeafEditsAndReprojects()
    {
        var authored = Invoke(ExportRequest());
        Assert.True(authored.Ok, Diagnostics(authored));
        var source = AddShape3dSceneBackdropNormalDy(RemoveEmbeddedPpj(authored.File.ToByteArray()), "0");
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            {
                SourceUri = "deck.assets/source/shape-3d-scene-backdrop-normal-dy.pptx",
            },
        });
        ...
        Assert.Contains("<a:norm dx=\"0\" dy=\"500\" dz=\"1\"", editedXml, StringComparison.Ordinal);
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/shape-3d-scene-backdrop-normal-dy.pptx",
            },
        });
    ...
    private static byte[] AddShape3dSceneBackdropNormalDy(byte[] source, string normalDy)
    {
        ...
        using (var package = PresentationDocument.Open(stream, true))
        {
            ...
            normal.SetAttribute(new OpenXmlAttribute("dy", string.Empty, normalDy));
