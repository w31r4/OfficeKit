...
{
    [Fact]
    public void PpjValueAxisMinorUnitAuthorsAndEditsSourceChart()
    {
        ...
        {
            ["minorUnit"] = new JsonObject { ["kind"] = "size", ["value"] = 5 },
        };
        ...
        {
            ["minorUnit"] = new JsonObject { ["token"] = "minorUnit" },
        };
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest { SourceUri = "minor-unit/source.pptx" },
        });
        ...
        var projectedChart = projectedProgram["pages"]!.AsArray()
            ...
            .Select(item => item!.AsObject())
            .Single(item => item["type"]!.GetValue<string>() == "chart");
        Assert.Equal(5, projectedChart["yAxis"]!["minorUnit"]!.GetValue<double>());

        projectedProgram["design"]!["grammar"]!["tokens"] = new JsonObject
        {
            ["minorUnitEdited"] = new JsonObject { ["kind"] = "size", ["value"] = 8 },
        };
        projectedChart["yAxis"]!["minorUnit"] = new JsonObject { ["token"] = "minorUnitEdited" };
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            Family = ArtifactFamily.Presentation,
            File = edited.File,
            PresentationProgram = new PresentationProgramRequest { SourceUri = "minor-unit/edited.pptx" },
        });
        ...
        var reprojectedChart = reprojectedProgram["pages"]!.AsArray()
            ...
            .Select(item => item!.AsObject())
            .Single(item => item["type"]!.GetValue<string>() == "chart");
        Assert.Equal(8, reprojectedChart["yAxis"]!["minorUnit"]!.GetValue<double>());
    }
}
