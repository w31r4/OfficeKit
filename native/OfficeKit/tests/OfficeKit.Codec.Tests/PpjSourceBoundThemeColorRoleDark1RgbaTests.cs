...
{
    [Fact]
    public void PpjSourceBoundThemeColorRoleDark1RgbaEditsOnlyDark1AndReprojects()
    {
        ...
        authoredTheme.Dark1Rgb = "10111240";
        ...
        Assert.Equal("#10111240", projectedColorRoles["dark1"]!.GetValue<string>());
        ...
        editedProgram["design"]!["theme"]!["colorRoles"]!["dark1"] = "#ABCDEF40";
        ...
        using (var package = PresentationDocument.Open(stream, false))
        {
            ...
            Assert.Equal(25098, scheme.Dark1Color.RgbColorModelHex.GetFirstChild<A.Alpha>()!.Val!.Value);
        ...
        Assert.Equal("#ABCDEF40", reprojectedProgram["design"]!["theme"]!["colorRoles"]!["dark1"]!.GetValue<string>());

        var alphaPresenceProgram = JsonNode.Parse(projectedProgram.ToJsonString())!.AsObject();
        alphaPresenceProgram["design"]!["theme"]!["colorRoles"]!["dark1"] = "#ABCDEF";
