...
const PRESENTATION_HELP_SCHEMAS = {
  ...
  }, "image", "ImageElement", "Appended editable image facade. OfficeKit authors/imports embedded PNG/JPEG/GIF/safe-SVG rectangular pictures and permits native source-rectangle add/edit/remove, bounded border/shadow effects, same-format byte, name/title/description/decorative metadata, frame, and direct-transform edits; unmodeled cNvPr children and effects outside the bounded border/shadow profile remain residual-protected, while external sources, complex blips, and non-rectangular geometry remain opaque."),
