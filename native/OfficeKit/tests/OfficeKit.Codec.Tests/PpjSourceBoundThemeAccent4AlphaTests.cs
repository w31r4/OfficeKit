...
{
    [Fact]
    public void PpjSourceBoundThemeAccent4RgbaEditsOnlyAccent4AndReprojects()
    {
        var authoredRequest = ExportRequest();
        var authoredTheme = new PresentationThemeArtifact();
        authoredTheme.AccentRgb.Add(new[] { "112233", "223344", "334455", "44556680", "556677", "667788" });
        ...
        Assert.Equal("#44556680", projectedColors["accent4"]!.GetValue<string>());
        ...
        editedProgram["design"]!["theme"]!["accentColors"]!["accent4"] = "#ABCDEF40";
        ...
        using (var package = PresentationDocument.Open(stream, false))
        {
            ...
            Assert.Equal(25098, scheme.Accent4Color.RgbColorModelHex.GetFirstChild<A.Alpha>()!.Val!.Value);
        ...
        Assert.Equal("#ABCDEF40", reprojectedProgram["design"]!["theme"]!["accentColors"]!["accent4"]!.GetValue<string>());

        var alphaPresenceProgram = JsonNode.Parse(projectedProgram.ToJsonString())!.AsObject();
        alphaPresenceProgram["design"]!["theme"]!["accentColors"]!["accent4"] = "#ABCDEF";
        ...
        tamperedProgram["design"]!["theme"]!["nativeRef"]!["capabilities"]!.AsArray()
            .Single(capability => capability!["operation"]!.GetValue<string>() == "setThemeAccent4Color")!["fields"] = new JsonArray("accentColors.accent1");
