...
{
    [Fact]
    public void PpjSourceBoundLiteralCustomGeometryPathArcWidthRadiusLeafEditsAndReprojects()
    {
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            {
                SourceUri = "deck.assets/source/custom-geometry-path-arc-width-radius.pptx",
            },
        });
        ...
        var arcLeaves = projectedShape["nativeRef"]!["leaves"]!.AsArray()
            ...
            .Where(leaf => leaf["kind"]!.GetValue<string>() == "customGeometryPathArcWidthRadius")
            .ToArray();
        ...
        Assert.Contains("wR=\"250\" hR=\"150\" stAng=\"0\" swAng=\"5400000\"", editedXml, StringComparison.Ordinal);
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/custom-geometry-path-arc-width-radius.pptx",
            },
        });
