...
{
    [Fact]
    public void PpjSourceBoundShape3dBevelBottomPresetLeafEditsAndReprojects()
    {
        var authored = Invoke(ExportRequest());
        Assert.True(authored.Ok, Diagnostics(authored));
        var source = AddShape3dBevelBottomWidth(RemoveEmbeddedPpj(authored.File.ToByteArray()), 1_200);
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            {
                SourceUri = "deck.assets/source/shape-3d-bevel-bottom-preset.pptx",
            },
        });
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/shape-3d-bevel-bottom-preset.pptx",
            },
        });
        ...
        var reprojectedLeaves = reprojectedShape["nativeRef"]!["leaves"]!.AsArray()
            ...
            .Where(leaf => leaf["kind"]!.GetValue<string>() == "shape3dBevelBottomPreset")
            .ToArray();
        Assert.Equal("softRound", Assert.Single(reprojectedLeaves)["value"]!.GetValue<string>());
    }
}
