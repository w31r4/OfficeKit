...
- [x] 1.1 Add highlight to the shared PPJ text-style schema.
- [x] 1.2 Compile run and default-run highlights through the existing wire.
- [x] 1.3 Project safe direct RGB highlights without flattening theme state.
