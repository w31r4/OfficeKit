...
{
    [Fact]
    public void PpjSourceBoundThemeMinorEastAsianFontEditsOnlyOwnedSlotAndReprojects()
    {
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            {
                SourceUri = "deck.assets/source/theme-minor-eastasia-font.pptx",
            },
        });
        ...
        Assert.Contains(nativeRef["capabilities"]!.AsArray(), capability =>
            capability!["operation"]!.GetValue<string>() == "setThemeMinorFontEastAsia" &&
            capability["fields"]!.AsArray().Any(field => field!.GetValue<string>() == "fontScheme.minorEastAsia"));
        ...
        editedProgram["design"]!["theme"]!["fontScheme"]!["minorEastAsia"] = "Nebula CJK";
        ...
        using (var package = PresentationDocument.Open(stream, false))
        {
            ...
            Assert.Equal("Nebula CJK", fontScheme.MinorFont.EastAsianFont!.Typeface!.Value);
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/theme-minor-eastasia-font.pptx",
            },
        });
        Assert.True(reprojected.Ok, Diagnostics(reprojected));
        var reprojectedProgram = JsonNode.Parse(reprojected.PresentationProgram.ProgramJson.ToByteArray())!.AsObject();
        Assert.Equal("Nebula CJK", reprojectedProgram["design"]!["theme"]!["fontScheme"]!["minorEastAsia"]!.GetValue<string>());
        ...
        tamperedProgram["design"]!["theme"]!["nativeRef"]!["capabilities"]!.AsArray()
            .Single(capability => capability!["operation"]!.GetValue<string>() == "setThemeMinorFontEastAsia")!["fields"] = new JsonArray("fontScheme.major");
