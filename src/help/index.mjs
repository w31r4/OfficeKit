...
export const HELP_CATALOG = [
  ...
  { artifactKind: "presentation", kind: "api", name: "slide.shapes.add", summary: "Add a shape/textbox, a free-positioned p:sp line with bounded dash/line-end/cap/join styling, bounded DrawingML custom geometry with ordered adjustment/guide formulas, or an exact-site p:cxnSp connector. A free line is defined by its start-plus-delta frame; only a connector retains target-plus-site identity." },
