...
{
    [Fact]
    public void PpjSourceBoundPictureShape3dContourWidthLeafEditsAndReprojects()
    {
        ...
        var source = AddPictureShape3dContourWidth(RemoveEmbeddedPpj(authored.File.ToByteArray()), 1_200);
        var projected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/source/picture-shape-3d-contour-width.pptx",
            },
        });
        ...
        using (var package = PresentationDocument.Open(stream, false))
        {
            ...
            Assert.Equal(2_400, picture.ShapeProperties!.GetFirstChild<A.Shape3DType>()!.ContourWidth!.Value);
        }
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/picture-shape-3d-contour-width.pptx",
            },
        });
        ...
        Assert.Equal(2_400, reprojectedImage["nativeRef"]!["leaves"]!.AsArray()
            .Select(leaf => leaf!.AsObject())
            .Single(leaf => leaf["kind"]!.GetValue<string>() == "shape3dContourWidthEmu")["value"]!.GetValue<long>());
    }

    private static byte[] AddPictureShape3dContourWidth(byte[] source, long width)
    {
