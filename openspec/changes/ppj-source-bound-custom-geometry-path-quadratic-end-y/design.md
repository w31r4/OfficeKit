...
- Owner: `p:sp/p:spPr/a:custGeom/a:pathLst/a:path/a:quadBezTo/a:pt[1]/@y`.
- PPJ surface: `shape.nativeRef.leaves[]`.
- Native leaf: `customGeometryPathQuadraticEndY`.
...
- No line-to, move-to, control-point, quadratic end-point x, cubic/arc,
...
quadratic command, removes embedded PPJ, projects the quadratic end-point y
...
unchanged control/end-point x coordinates.
