...
for (const field of ["bold", "italic", "size", "fontFamily", "fontFamilyEastAsia", "fontFamilyComplexScript", "language"]) {
  const defaults = assessPpjPreviewInput(deck([{ ...text, text: { paragraphs: [{ style: { defaultText: { [field]: field.startsWith("fontFamily") ? "Georgia" : field === "size" ? 18.25 : field === "language" ? "fr-FR" : false } }, runs: [{ text: "Default style" }] }] } }]));
