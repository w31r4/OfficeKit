...
{
    [Fact]
    public void PpjSourceBoundCustomGeometryPathMoveToXEditsAndReprojects()
    {
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            {
                SourceUri = "deck.assets/source/custom-geometry-path-move-to-x.pptx",
            },
        });
        ...
        var moveLeaves = projectedShape["nativeRef"]!["leaves"]!.AsArray()
            ...
            .Where(leaf => leaf["kind"]!.GetValue<string>() == "customGeometryPathMoveToX")
            .ToArray();
        ...
        Assert.Contains("x=\"250\" y=\"100\"", editedXml, StringComparison.Ordinal);
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/custom-geometry-path-move-to-x.pptx",
            },
        });
