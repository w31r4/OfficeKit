...
{
    [Fact]
    public void PpjSourceBoundCustomGeometryPathQuadraticEndYEditsAndReprojects()
    {
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            {
                SourceUri = "deck.assets/source/custom-geometry-path-quadratic-end-y.pptx",
            },
        });
        ...
        var quadraticLeaves = projectedShape["nativeRef"]!["leaves"]!.AsArray()
            ...
            .Where(leaf => leaf["kind"]!.GetValue<string>() == "customGeometryPathQuadraticEndY")
            .ToArray();
        ...
        Assert.Contains("x=\"700\" y=\"650\"", editedXml, StringComparison.Ordinal);
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/custom-geometry-path-quadratic-end-y.pptx",
            },
        });
