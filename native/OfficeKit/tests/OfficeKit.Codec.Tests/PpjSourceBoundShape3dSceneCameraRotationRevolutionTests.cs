...
{
    [Fact]
    public void PpjSourceBoundShape3dSceneCameraRotationRevolutionLeafEditsAndReprojects()
    {
        var authored = Invoke(ExportRequest());
        Assert.True(authored.Ok, Diagnostics(authored));
        var source = AddShape3dSceneCameraRotationRevolution(RemoveEmbeddedPpj(authored.File.ToByteArray()), "0");
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            {
                SourceUri = "deck.assets/source/shape-3d-scene-camera-rotation-revolution.pptx",
            },
        });
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/shape-3d-scene-camera-rotation-revolution.pptx",
            },
        });
    ...
    private static byte[] AddShape3dSceneCameraRotationRevolution(byte[] source, string revolution)
    {
