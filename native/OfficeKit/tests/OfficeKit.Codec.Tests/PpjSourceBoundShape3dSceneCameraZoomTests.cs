...
{
    [Fact]
    public void PpjSourceBoundShape3dSceneCameraZoomLeafEditsAndReprojects()
    {
        var authored = Invoke(ExportRequest());
        Assert.True(authored.Ok, Diagnostics(authored));
        var source = AddShape3dSceneCameraZoom(RemoveEmbeddedPpj(authored.File.ToByteArray()), "100000");
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            {
                SourceUri = "deck.assets/source/shape-3d-scene-camera-zoom.pptx",
            },
        });
        ...
        Assert.Contains("<a:camera prst=\"perspectiveFront\" zoom=\"50000\"", editedXml, StringComparison.Ordinal);
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/shape-3d-scene-camera-zoom.pptx",
            },
        });
    ...
    private static byte[] AddShape3dSceneCameraZoom(byte[] source, string zoom)
    {
