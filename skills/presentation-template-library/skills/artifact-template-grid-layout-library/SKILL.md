...
description: "Use a rigorous Swiss editorial grid language for modular evidence and typographic hierarchy without fixed layouts."
---
...
Use a visible but flexible alignment system: black type, warm paper, signal red, disciplined columns, strong indices, and precise rules. The grid governs relationships rather than prescribing fixed page layouts. Never recreate the retired module library.
