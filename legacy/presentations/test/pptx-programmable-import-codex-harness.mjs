...
assert.match(prompt, /explicit top-level `return`/u);
assert.match(prompt, /commit[.]commitId: "c0001"[\s\S]*never[\s\S]*rerunning phase 1/u);
assert.match(prompt, /Phase 2 must commit but must not publish[.] Phase 3 is the only cell/u);
