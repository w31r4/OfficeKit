        ...
        switch (source.ContentCase)
        {
            ...
            case PresentationTextRun.ContentOneofCase.Field:
                ...
                if (source.Field.Automatic && !IsAutomaticFieldType(source.Field.Type))
                    throw new CodecException("invalid_presentation_text", "The bounded automatic presentation field profile only supports type slidenum, datetime, datetime1, datetime2, datetime3, datetime4, datetime5, or datetime6.");
                return;
