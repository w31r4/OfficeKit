...
export const HELP_CATALOG = [
  ...
  { artifactKind: "presentation", kind: "api", name: "slide.images.add", summary: "Add an embedded image with accessibility metadata, fit/crop, frame, opacity, rotation/flips, layout, preview, and PPTX output. Ready bounded-overlay accepts rectangular images in a clean export. OfficeKit writes native p:cNvPr, a:alphaModFix, decorative metadata, and a:srcRect." },
