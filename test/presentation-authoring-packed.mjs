...
function selfDirectedFirstCell() {
  return [
    ...
    'const plan = { schema:"office-kit/presentation-authoring-plan/v1", mode:"create", brief:{audience:"Engineering leadership", purpose:"Choose a migration path", primaryJob:"decide", expectedOutcome:"One bounded decision"}, narrative:{thesis:"The bounded path is the safer decision", sections:["Context","Decision"]}, design:{sourceMode:"self-directed", scenario:{primary:"technical-engineering",secondary:null}, direction:{name:"Decision architecture",rationale:"A sparse evidence hierarchy keeps the migration trade-off legible"}, mechanismPacks:["technical-architecture"], designGrammar:{density:"one claim per page", rhythm:"sparse conclusion then evidence"}}, pages:[{id:"p01-decision", readerTask:"Understand the recommendation", claim:"Choose the bounded path", evidence:["Measured build time"], contentBudget:{maxCharacters:240,maxObjects:8}, compositionIntent:"One dominant conclusion and one evidence line"}], editorial:{voice:"direct and evidence-led", lockedFacts:["measured build time"], avoid:["empty transition phrases"]}, artifactRefs:[], recipe:"tasks/create.md", unresolved:[], nextAction:"Review and continue the deck"};',
    'await ctx.plan(plan);',
