...
- Owner: `p:pic/p:spPr/a:sp3d/a:bevelB/@h`.
- Native leaf: existing `shape3dBevelBottomHeightEmu`.
- Source model: add an additive presence-aware
  `PresentationImage.shape_3d_bevel_bottom_height_emu` field. It is
...
- Picture projection stores the bevel height, issues the existing native
