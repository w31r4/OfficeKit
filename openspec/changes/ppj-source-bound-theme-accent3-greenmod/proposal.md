...
modulation transforms. A direct imported accent3 `a:greenMod` remains opaque,
...
- Project a canonical shared ThemePart whose accent3 direct RGB leaf contains
  ...
  `design.theme.accentTransforms.accent3.greenMod`, using a 0..1 fraction.
- Issue `setThemeAccent3GreenMod` for that field and compile one authorized
...
- `presentation-theme-accent3-greenmod`: Strict source-bound projection and
  source-preserving editing of one direct accent3 `a:greenMod` leaf.
