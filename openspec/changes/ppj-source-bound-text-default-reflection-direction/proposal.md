# Proposal: add source-bound paragraph default-text reflection direction ownership to PPJ

Expose a bounded `paragraph.style.defaultText.reflection.angle` owner for an
...
change that reflection direction without rewriting the surrounding slide.
