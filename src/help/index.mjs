...
const PRESENTATION_HELP_SCHEMAS = {
  ...
  "presentation.inspect": helpSchema({
    kind: { type: "string", description: "Comma-separated deck/theme/layout/slide/transition/textbox/textRange/shape/groupShape/table/chart/image/connector/animation/morph/nativeObject/nativeLeaf/componentCandidate/contentPart/oleObject/diagram/comment/notes/customShow/section kinds; layer/zOrder records are also available." },
    search: { type: "string", description: "Case-insensitive record filter." },
    target: { type: "string", description: "Stable target ID/anchor." },
    before: { type: "number", description: "Context records before matches." },
    after: { type: "number", description: "Context records after matches." },
