...
- [x] 1.1 Add `textStyle.glow` to the PPJ schema and add run/default-run wire
  fields.
- [x] 1.2 Parse glow on authored run and default-run styles.
- [x] 1.3 Lower glow after any bounded text shadow while preserving the direct
