...
{
    [Fact]
    public void PpjSourceBoundThemeMinorFontEditsOnlyLatinMinorSlotAndReprojects()
    {
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            {
                SourceUri = "deck.assets/source/theme-minor-font.pptx",
            },
        });
        ...
        Assert.Contains(nativeRef["capabilities"]!.AsArray(), capability =>
            capability!["operation"]!.GetValue<string>() == "setThemeMinorFont" &&
            capability["fields"]!.AsArray().Any(field => field!.GetValue<string>() == "fontScheme.minor"));
        ...
        editedProgram["design"]!["theme"]!["fontScheme"]!["minor"] = "Nebula Sans";
        ...
        using (var package = PresentationDocument.Open(stream, false))
        {
            ...
            Assert.Equal("Nebula Sans", fontScheme.MinorFont!.LatinFont!.Typeface!.Value);
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/theme-minor-font.pptx",
            },
        });
        Assert.True(reprojected.Ok, Diagnostics(reprojected));
        var reprojectedProgram = JsonNode.Parse(reprojected.PresentationProgram.ProgramJson.ToByteArray())!.AsObject();
        Assert.Equal("Nebula Sans", reprojectedProgram["design"]!["theme"]!["fontScheme"]!["minor"]!.GetValue<string>());
        ...
        tamperedProgram["design"]!["theme"]!["nativeRef"]!["capabilities"]!.AsArray()
            .Single(capability => capability!["operation"]!.GetValue<string>() == "setThemeMinorFont")!["fields"] = new JsonArray("fontScheme.major");
