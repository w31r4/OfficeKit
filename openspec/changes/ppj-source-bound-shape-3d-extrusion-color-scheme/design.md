...
- Expose one canonical supported DrawingML theme token for 3-D extrusion
  color.
...
- Preserve all other 3-D attributes/children, image relationships, effects,
...
- Contour color, complex effect/extension topology, or shared relationships.

# Decisions

- Reuse the strict root/owner topology of the existing 3-D RGB reader and the
  scheme-specific color reader, changing only the owner name to
  `extrusionClr`.
