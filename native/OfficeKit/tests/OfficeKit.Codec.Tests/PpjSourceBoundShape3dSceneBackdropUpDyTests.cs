...
{
    [Fact]
    public void PpjSourceBoundShape3dSceneBackdropUpDyLeafEditsAndReprojects()
    {
        var authored = Invoke(ExportRequest());
        Assert.True(authored.Ok, Diagnostics(authored));
        var source = AddShape3dSceneBackdropUpDy(RemoveEmbeddedPpj(authored.File.ToByteArray()), "1");
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            {
                SourceUri = "deck.assets/source/shape-3d-scene-backdrop-up-dy.pptx",
            },
        });
        ...
        var target = Assert.Single(projectedShape["nativeRef"]!["leaves"]!.AsArray()
            ...
            .Where(leaf => leaf["kind"]!.GetValue<string>() == "shape3dSceneBackdropUpDyEmu"));
        ...
        Assert.Contains("<a:up dx=\"0\" dy=\"500\" dz=\"0\"", editedXml, StringComparison.Ordinal);
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/shape-3d-scene-backdrop-up-dy.pptx",
            },
        });
    ...
    private static byte[] AddShape3dSceneBackdropUpDy(byte[] source, string upDy)
    {
        ...
        using (var package = PresentationDocument.Open(stream, true))
        {
            ...
            up.SetAttribute(new OpenXmlAttribute("dy", string.Empty, upDy));
