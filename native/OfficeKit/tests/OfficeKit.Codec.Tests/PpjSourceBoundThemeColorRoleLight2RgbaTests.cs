...
{
    [Fact]
    public void PpjSourceBoundThemeColorRoleLight2RgbaEditsOnlyLight2AndReprojects()
    {
        ...
        authoredTheme.Light2Rgb = "40414240";
        ...
        Assert.Equal("#40414240", projectedColorRoles["light2"]!.GetValue<string>());
        ...
        editedProgram["design"]!["theme"]!["colorRoles"]!["light2"] = "#ABCDEF40";
        ...
        using (var package = PresentationDocument.Open(stream, false))
        {
            ...
            Assert.Equal(25098, scheme.Light2Color.RgbColorModelHex.GetFirstChild<A.Alpha>()!.Val!.Value);
        ...
        Assert.Equal("#ABCDEF40", reprojectedProgram["design"]!["theme"]!["colorRoles"]!["light2"]!.GetValue<string>());

        var alphaPresenceProgram = JsonNode.Parse(projectedProgram.ToJsonString())!.AsObject();
        alphaPresenceProgram["design"]!["theme"]!["colorRoles"]!["light2"] = "#ABCDEF";
