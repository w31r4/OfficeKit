...
- [x] 1.1 Add the additive wire-v2 radar chart enum.
- [x] 1.2 Read, validate, build and patch the bounded native radar profile.
- [x] 1.3 Compile and project PPJ radar charts.
