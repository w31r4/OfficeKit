...
{
    [Fact]
    public void PpjSourceBoundPictureShape3dBevelTopWidthLeafEditsAndReprojects()
    {
        ...
        var source = AddPictureShape3dBevelTopWidth(RemoveEmbeddedPpj(authored.File.ToByteArray()), 1_200);
        var projected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/source/picture-shape-3d-bevel-top-width.pptx",
            },
        });
        ...
        using (var package = PresentationDocument.Open(stream, false))
        {
            ...
            var bevel = picture.ShapeProperties!.GetFirstChild<A.Shape3DType>()!.GetFirstChild<A.BevelTop>();
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/picture-shape-3d-bevel-top-width.pptx",
            },
        });
        ...
        Assert.Equal(2_400, reprojectedImage["nativeRef"]!["leaves"]!.AsArray()
            .Select(leaf => leaf!.AsObject())
            .Single(leaf => leaf["kind"]!.GetValue<string>() == "shape3dBevelTopWidthEmu")["value"]!.GetValue<long>());
    }

    private static byte[] AddPictureShape3dBevelTopWidth(byte[] source, long width)
    {
