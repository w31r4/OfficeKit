...
export const HELP_CATALOG = [
  ...
  { artifactKind: "presentation", kind: "api", name: "shape.deletionCapability", summary: "Report whether one imported top-level ordinary shape is inside the bounded deletion profile, with a package-local native ID used for post-write absence proof. Export recomputes the capability from source bytes." },
  { artifactKind: "presentation", kind: "api", name: "shape.delete", summary: "Explicitly remove a source-free shape or one capability-proven imported top-level ordinary shape. Relationship-owning shapes, connector/comment/timing/extension identity graphs, non-shape elements, nested children, and raw collection mutation fail closed." },
