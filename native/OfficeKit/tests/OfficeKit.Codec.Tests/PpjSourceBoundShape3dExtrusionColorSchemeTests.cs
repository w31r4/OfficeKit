...
{
    [Fact]
    public void PpjSourceBoundShape3dExtrusionColorSchemeLeafEditsAndReprojects()
    {
        var authored = Invoke(ExportRequest());
        Assert.True(authored.Ok, Diagnostics(authored));
        var source = AddShape3dExtrusionColorScheme(RemoveEmbeddedPpj(authored.File.ToByteArray()), "accent1");
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            {
                SourceUri = "deck.assets/source/shape-3d-extrusion-scheme.pptx",
            },
        });
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/shape-3d-extrusion-scheme.pptx",
            },
        });
    ...
    private static byte[] AddShape3dExtrusionColorScheme(byte[] source, string scheme)
    {
