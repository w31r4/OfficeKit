...
A direct imported accent5 `a:greenMod` remains opaque, leaving one concrete F-15
...
- Project a canonical shared ThemePart whose accent5 direct RGB leaf contains
  ...
  `design.theme.accentTransforms.accent5.greenMod`, using a 0..1 fraction.
- Issue `setThemeAccent5GreenMod` for that field and compile one authorized
...
- `presentation-theme-accent5-greenmod`: Strict source-bound projection and
  source-preserving editing of one direct accent5 `a:greenMod` leaf.
