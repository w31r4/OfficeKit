...
{
    [Fact]
    public void PpjSourceBoundShape3dSceneCameraRotationLatitudeLeafEditsAndReprojects()
    {
        var authored = Invoke(ExportRequest());
        Assert.True(authored.Ok, Diagnostics(authored));
        var source = AddShape3dSceneCameraRotationLatitude(RemoveEmbeddedPpj(authored.File.ToByteArray()), "0");
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            {
                SourceUri = "deck.assets/source/shape-3d-scene-camera-rotation-latitude.pptx",
            },
        });
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/shape-3d-scene-camera-rotation-latitude.pptx",
            },
        });
    ...
    private static byte[] AddShape3dSceneCameraRotationLatitude(byte[] source, string latitude)
    {
