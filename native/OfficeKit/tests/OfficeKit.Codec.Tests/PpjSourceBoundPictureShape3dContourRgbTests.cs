...
{
    [Fact]
    public void PpjSourceBoundPictureShape3dContourRgbLeafEditsAndReprojects()
    {
        ...
        var source = AddPictureShape3dContourRgb(RemoveEmbeddedPpj(authored.File.ToByteArray()), "336699");
        var projected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/source/picture-shape-3d-contour-rgb.pptx",
            },
        });
        ...
        using (var package = PresentationDocument.Open(stream, false))
        {
            ...
            Assert.Equal("6699CC", shape3d.GetFirstChild<A.ContourColor>()!.GetFirstChild<A.RgbColorModelHex>()!.Val!.Value);
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/picture-shape-3d-contour-rgb.pptx",
            },
        });
    ...
    private static byte[] AddPictureShape3dContourRgb(byte[] source, string rgb)
    {
