...
export const HELP_CATALOG = [
  ...
  { artifactKind: "document", kind: "api", name: "document.addParagraph", summary: "Append a styled paragraph with optional run spans and bounded direct paragraph formatting, including presence-aware contextual spacing and line-number suppression." },
