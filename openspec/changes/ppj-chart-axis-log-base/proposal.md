...
PPJ schema/compiler/projector/validator, shared additive axis wire field, ChartML axis codec, focused tests and reference/backlog docs. No new dependency or wire version bump.
