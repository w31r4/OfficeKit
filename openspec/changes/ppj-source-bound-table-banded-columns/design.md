...
- Owner: `p:graphicFrame/a:graphicData/a:tbl/a:tblPr/@bandCol`.
- PPJ semantic location: `table.style.bandedColumns`.
- Native leaf: `tableBandedColumns`.
...
- Editing replaces only `bandCol/@value`; it does not change cell text,
  geometry, relationships, or other table style flags.

## Evidence

The focused test authors a rectangular table with `bandedColumns`, removes the
