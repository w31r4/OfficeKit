...
{
    [Fact]
    public void PpjSourceBoundPictureShape3dSceneCameraRotationRevolutionLeafEditsAndReprojects()
    {
        ...
        var source = AddPictureShape3dSceneCameraRotationRevolution(RemoveEmbeddedPpj(authored.File.ToByteArray()), "6000000");
        var projected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/source/picture-shape-3d-scene-camera-rotation-revolution.pptx",
            },
        });
        ...
        var target = Assert.Single(projectedImage["nativeRef"]!["leaves"]!.AsArray()
            ...
            .Where(leaf => leaf["kind"]!.GetValue<string>() == "shape3dSceneCameraRotationRevolution60000"));
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/picture-shape-3d-scene-camera-rotation-revolution.pptx",
            },
        });
    ...
    private static byte[] AddPictureShape3dSceneCameraRotationRevolution(byte[] source, string revolution)
    {
