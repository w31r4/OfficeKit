...
{
    [Fact]
    public void PpjSourceBoundShape3dContourColorSchemeLeafEditsAndReprojects()
    {
        var authored = Invoke(ExportRequest());
        Assert.True(authored.Ok, Diagnostics(authored));
        var source = AddShape3dContourColorScheme(RemoveEmbeddedPpj(authored.File.ToByteArray()), "accent1");
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            {
                SourceUri = "deck.assets/source/shape-3d-contour-scheme.pptx",
            },
        });
        ...
        var target = Assert.Single(projectedShape["nativeRef"]!["leaves"]!.AsArray()
            ...
            .Where(leaf => leaf["kind"]!.GetValue<string>() == "shape3dContourColorScheme"));
        ...
        Assert.Contains("<a:contourClr><a:schemeClr val=\"accent2\"", editedXml, StringComparison.Ordinal);
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/shape-3d-contour-scheme.pptx",
            },
        });
    ...
    private static byte[] AddShape3dContourColorScheme(byte[] source, string scheme)
    {
        ...
        using (var package = PresentationDocument.Open(stream, true))
        {
            ...
            var shape3d = new A.Shape3DType(
                new A.ContourColor(new A.SchemeColor { Val = A.SchemeColorValues.Accent1 }));
            ...
            shape3d.GetFirstChild<A.ContourColor>()!.GetFirstChild<A.SchemeColor>()!.SetAttribute(
