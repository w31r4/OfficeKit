...
internal sealed class DocxPartContext
{
    ...
    internal bool IgnoresModeledRelationship(OfficeKit.Artifact.Wire.V1.OpaqueOpcRelationship relationship) =>
    ...
    internal bool IgnoresModeledPart(OfficeKit.Artifact.Wire.V1.OpaqueOpcPart part) =>
