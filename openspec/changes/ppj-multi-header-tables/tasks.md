...
- [x] 1.1 Add header fill and text-style fallbacks to PPJ table styles.
- [x] 1.2 Lower bounded multi-row headers to direct native cell formatting.
- [x] 1.3 Reject invalid or inert header declarations before output.
