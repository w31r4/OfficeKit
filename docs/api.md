...
| `slide.shapes.add` | api | Add a shape/textbox with preset or bounded DrawingML custom geometry, including ordered adjustment/guide formulas, optional custom-shape text rectangle, position, center-based rotation/flips, fill, line, text, and text-body layout. |
...
Add a shape/textbox with preset or bounded DrawingML custom geometry, including ordered adjustment/guide formulas, optional custom-shape text rectangle, position, center-based rotation/flips, fill, line, text, and text-body layout.
