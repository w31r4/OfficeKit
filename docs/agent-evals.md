...
The twelve ready signature/boundary/repair/redaction fixture inputs live below `evals/assets/`, outside the npm
...
The following twelve ready PDF cases have complete case-specific grading:
