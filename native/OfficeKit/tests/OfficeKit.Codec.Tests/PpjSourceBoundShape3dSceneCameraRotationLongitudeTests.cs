...
{
    [Fact]
    public void PpjSourceBoundShape3dSceneCameraRotationLongitudeLeafEditsAndReprojects()
    {
        var authored = Invoke(ExportRequest());
        Assert.True(authored.Ok, Diagnostics(authored));
        var source = AddShape3dSceneCameraRotationLongitude(RemoveEmbeddedPpj(authored.File.ToByteArray()), "0");
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            {
                SourceUri = "deck.assets/source/shape-3d-scene-camera-rotation-longitude.pptx",
            },
        });
        ...
        Assert.Contains("<a:rot lat=\"0\" lon=\"1800000\" rev=\"6000000\"", editedXml, StringComparison.Ordinal);
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/shape-3d-scene-camera-rotation-longitude.pptx",
            },
        });
    ...
    private static byte[] AddShape3dSceneCameraRotationLongitude(byte[] source, string longitude)
    {
