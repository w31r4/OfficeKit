...
{
    [Fact]
    public void PpjSourceBoundPictureShape3dSceneBackdropNormalDzLeafEditsAndReprojects()
    {
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest { SourceUri = "deck.assets/source/picture-backdrop-normal-dz.pptx" },
        });
        ...
        Assert.Equal(3, target["value"]!.GetValue<long>());
        target["value"] = 4;
        ...
        Assert.Contains("<a:norm dx=\"1\" dy=\"2\" dz=\"4\"", xml, StringComparison.Ordinal);
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest { SourceUri = "deck.assets/edited/picture-backdrop-normal-dz.pptx" },
        });
        ...
        var reprojectedTarget = Assert.Single(reprojectedImage["nativeRef"]!["leaves"]!.AsArray().Select(leaf => leaf!.AsObject())
            .Where(leaf => leaf["kind"]!.GetValue<string>() == "shape3dSceneBackdropNormalDzEmu"));
        Assert.Equal(4, reprojectedTarget["value"]!.GetValue<long>());
    }
}
