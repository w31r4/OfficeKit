...
| Lucide Iconify JSON (`@iconify-json/lucide`) | Runtime-lazy offline icon-name search and deterministic SVG materialization for Presentation image assets | ISC; the Iconify JSON type dependency retains its MIT notice |
...
`skills/default-template-library/` retains 13 source-backed template Skills—seven DOCX and six XLSX—from [`office-artifact-tool` commit `256cb31bfe0a07b3cef0051b6b159342be381378`](https://github.com/w31r4/office-artifact-tool/commit/256cb31bfe0a07b3cef0051b6b159342be381378), **Add default Office template library**. That source repository declares the following MIT license and copyright:
