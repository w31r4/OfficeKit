...
{
    [Fact]
    public void PpjSourceBoundThemeAccent2RedModEditsOnlyRedModAndReprojects()
    {
        ...
        {
            Role = "accent2",
            RedModulationThousandth = 35_000,
        });
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            {
                SourceUri = "deck.assets/source/theme-accent2-redMod.pptx",
            },
        });
        ...
        Assert.Equal(0.35, projectedTransform["redMod"]!.GetValue<double>());
        var nativeRef = Assert.IsType<JsonObject>(projectedTheme["nativeRef"]);
        Assert.Contains(nativeRef["capabilities"]!.AsArray(), capability =>
            capability!["operation"]!.GetValue<string>() == "setThemeAccent2RedMod" &&
            capability["fields"]!.AsArray().Any(field => field!.GetValue<string>() == "accentTransforms.accent2.redMod"));
        ...
        editedProgram["design"]!["theme"]!["accentTransforms"]!["accent2"]!["redMod"] = 0.4;
        ...
        using (var package = PresentationDocument.Open(stream, false))
        {
            ...
            Assert.Equal(40_000, Assert.Single(accent2.Elements<A.RedModulation>()).Val!.Value);
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/theme-accent2-redMod.pptx",
            },
        });
        Assert.True(reprojected.Ok, Diagnostics(reprojected));
        var reprojectedProgram = JsonNode.Parse(reprojected.PresentationProgram.ProgramJson.ToByteArray())!.AsObject();
        Assert.Equal(0.4, reprojectedProgram["design"]!["theme"]!["accentTransforms"]!["accent2"]!["redMod"]!.GetValue<double>());

        var unauthorizedProgram = JsonNode.Parse(projectedProgram.ToJsonString())!.AsObject();
        unauthorizedProgram["design"]!["theme"]!["accentTransforms"]!["accent2"]!["redMod"] = 0.8;
        unauthorizedProgram["design"]!["theme"]!["nativeRef"]!["capabilities"]!.AsArray()
            .Single(capability => capability!["operation"]!.GetValue<string>() == "setThemeAccent2RedMod")!["fields"] = new JsonArray("accentTransforms.accent2.tint");
        ...
        deletionProgram["design"]!["theme"]!["accentTransforms"]!["accent2"]!.AsObject().Remove("redMod");
        ...
        outOfRangeProgram["design"]!["theme"]!["accentTransforms"]!["accent2"]!["redMod"] = 1.1;
