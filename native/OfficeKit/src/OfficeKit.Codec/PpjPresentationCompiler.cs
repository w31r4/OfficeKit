...
internal static partial class PpjSourceBoundPresentationCompiler
{
        ...
        JsonElement programRoot)
    {
        ...
        var defaultGlowChanged = !JsonEqual(
            MaskTextValues(beforeRaw, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultInnerShadow: true),
            MaskTextValues(afterRaw, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultInnerShadow: true));
        ...
        if (node["paragraphs"] is System.Text.Json.Nodes.JsonArray paragraphs)
        {
            foreach (var paragraph in paragraphs.OfType<System.Text.Json.Nodes.JsonObject>())
            {
                ...
                if ((maskTabStops || maskAlignment || maskDefaultBold || maskDefaultItalic || maskDefaultSize || maskDefaultFontFamily || maskDefaultEastAsianFont || maskDefaultComplexScriptFont || maskDefaultLanguage || maskDefaultKerning || maskDefaultLetterSpacing || maskDefaultBaseline || maskDefaultCapitalization || maskDefaultStrike || maskDefaultUnderline || maskDefaultHighlight || maskDefaultColor || maskDefaultGradient || maskDefaultGlow || maskDefaultInnerShadow) && paragraph["style"] is System.Text.Json.Nodes.JsonObject style)
                {
                    ...
                    if ((maskDefaultBold || maskDefaultItalic || maskDefaultSize || maskDefaultFontFamily || maskDefaultEastAsianFont || maskDefaultComplexScriptFont || maskDefaultLanguage || maskDefaultKerning || maskDefaultLetterSpacing || maskDefaultBaseline || maskDefaultCapitalization || maskDefaultStrike || maskDefaultUnderline || maskDefaultHighlight || maskDefaultColor || maskDefaultGradient || maskDefaultGlow || maskDefaultInnerShadow) && style["defaultText"] is System.Text.Json.Nodes.JsonObject defaults)
                    {
