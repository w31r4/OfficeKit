...
{
    [Fact]
    public void PpjSourceBoundPictureShape3dSceneBackdropNormalDxLeafEditsAndReprojects()
    {
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest { SourceUri = "deck.assets/source/picture-backdrop-normal-dx.pptx" },
        });
        ...
        Assert.Contains("<a:norm dx=\"2\" dy=\"2\" dz=\"3\"", xml, StringComparison.Ordinal);
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest { SourceUri = "deck.assets/edited/picture-backdrop-normal-dx.pptx" },
        });
