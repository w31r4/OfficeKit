...
- Update authored style construction, per-field grammar precedence, source-bound conversion and projection. Pass chart language defaults to vector title runs when no more-specific run language exists.
