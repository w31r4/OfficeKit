...
internal sealed class XlsxChartCodec
{
    ...
    private static string ChartSpaceEditSemanticHash(SpreadsheetChartArtifact chart) => Hash(string.Join('\0', ChartSpaceSemanticHash(chart), chart.HasOverlap ? chart.Overlap.ToString(CultureInfo.InvariantCulture) : "absent"));
