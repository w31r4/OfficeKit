...
{
    [Fact]
    public void PpjSourceBoundShape3dSceneLightRigRotationLongitudeLeafEditsAndReprojects()
    {
        var authored = Invoke(ExportRequest());
        Assert.True(authored.Ok, Diagnostics(authored));
        var source = AddShape3dSceneLightRigRotationLongitude(RemoveEmbeddedPpj(authored.File.ToByteArray()), "0");
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            {
                SourceUri = "deck.assets/source/shape-3d-scene-light-rig-rotation-longitude.pptx",
            },
        });
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/shape-3d-scene-light-rig-rotation-longitude.pptx",
            },
        });
    ...
    private static byte[] AddShape3dSceneLightRigRotationLongitude(byte[] source, string longitude)
    {
