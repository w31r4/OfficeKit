...
{
    [Fact]
    public void PpjSourceBoundShape3dBevelBottomWidthLeafEditsAndReprojects()
    {
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            {
                SourceUri = "deck.assets/source/shape-3d-bevel-bottom-width.pptx",
            },
        });
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/shape-3d-bevel-bottom-width.pptx",
            },
        });
    ...
    private static byte[] AddShape3dBevelBottomWidth(byte[] source, long width)
    {
