...
// line/scatter/radar-series marker. Picture markers, transformed colors, extensions, and
...
internal static class XlsxChartSeriesMarkerCodec
{
    ...
    internal static void Validate(SpreadsheetChartSeriesArtifact series, SpreadsheetChartType chartType, string worksheetId, string chartId)
    {
        ...
        if (chartType is not (SpreadsheetChartType.Line or SpreadsheetChartType.Scatter or SpreadsheetChartType.Radar))
            throw Invalid(worksheetId, chartId, series.Name, "is supported only on line, scatter, or radar charts");
    ...
    internal static bool TryRead(XElement nativeSeries, SpreadsheetChartSeriesArtifact series, SpreadsheetChartType chartType)
    {
        ...
        if (markers.Length != 1 || chartType is not (SpreadsheetChartType.Line or SpreadsheetChartType.Scatter or SpreadsheetChartType.Radar)) return false;
