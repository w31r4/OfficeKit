...
{
    [Fact]
    public void PpjSourceBoundThemeAccent3HueModEditsOnlyHueModAndReprojects()
    {
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            {
                SourceUri = "deck.assets/source/theme-accent3-hueMod.pptx",
            },
        });
        ...
        Assert.Contains(nativeRef["capabilities"]!.AsArray(), capability =>
            capability!["operation"]!.GetValue<string>() == "setThemeAccent3HueMod" &&
            capability["fields"]!.AsArray().Any(field => field!.GetValue<string>() == "accentTransforms.accent3.hueMod"));
        ...
        editedProgram["design"]!["theme"]!["accentTransforms"]!["accent3"]!["hueMod"] = 0.7;
        ...
        using (var package = PresentationDocument.Open(stream, false))
        {
            ...
            Assert.Equal(70_000, Assert.Single(accent3.Elements<A.HueModulation>()).Val!.Value);
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/theme-accent3-hueMod.pptx",
            },
        });
        Assert.True(reprojected.Ok, Diagnostics(reprojected));
        var reprojectedProgram = JsonNode.Parse(reprojected.PresentationProgram.ProgramJson.ToByteArray())!.AsObject();
        Assert.Equal(0.7, reprojectedProgram["design"]!["theme"]!["accentTransforms"]!["accent3"]!["hueMod"]!.GetValue<double>());

        var unauthorizedProgram = JsonNode.Parse(projectedProgram.ToJsonString())!.AsObject();
        unauthorizedProgram["design"]!["theme"]!["accentTransforms"]!["accent3"]!["hueMod"] = 0.8;
        unauthorizedProgram["design"]!["theme"]!["nativeRef"]!["capabilities"]!.AsArray()
            .Single(capability => capability!["operation"]!.GetValue<string>() == "setThemeAccent3HueMod")!["fields"] = new JsonArray("accentTransforms.accent3.tint");
        ...
        deletionProgram["design"]!["theme"]!["accentTransforms"]!["accent3"]!.AsObject().Remove("hueMod");
        ...
        outOfRangeProgram["design"]!["theme"]!["accentTransforms"]!["accent3"]!["hueMod"] = 1.1;
