...
const presentationTemplateSkills = [
  ...
  "artifact-template-capital-signal",
  "artifact-template-cinematic-launch",
  "artifact-template-data-lesson",
  "artifact-template-decision-brief",
  "artifact-template-dynamic-collage",
  "artifact-template-evidence-ledger",
  "artifact-template-grid-layout-library",
  "artifact-template-hard-newsprint",
  "artifact-template-incident-field-notes",
  "artifact-template-ink-register",
  "artifact-template-lab-notebook",
  "artifact-template-market-observatory",
  "artifact-template-market-trends-report",
  "artifact-template-material-evidence",
  "artifact-template-operating-review",
  "artifact-template-operating-rhythm",
  "artifact-template-pop-geometry",
  "artifact-template-procedure-map",
  "artifact-template-project-kickoff",
  "artifact-template-protocol-map",
  "artifact-template-quiet-luxury",
  "artifact-template-research-monograph",
  "artifact-template-simple-dark-mode",
  "artifact-template-simple-light-mode",
  "artifact-template-study-handbook",
  "artifact-template-swiss-signal",
  "artifact-template-systems-blueprint",
  "artifact-template-team-alignment",
  "artifact-template-thesis-defense",
  "artifact-template-venture-thesis",
  "artifact-template-workshop-canvas",
];
