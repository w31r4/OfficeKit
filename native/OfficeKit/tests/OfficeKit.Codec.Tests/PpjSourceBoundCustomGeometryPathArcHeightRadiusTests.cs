...
{
    [Fact]
    public void PpjSourceBoundLiteralCustomGeometryPathArcHeightRadiusLeafEditsAndReprojects()
    {
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            {
                SourceUri = "deck.assets/source/custom-geometry-path-arc-height-radius.pptx",
            },
        });
        ...
        var arcLeaves = projectedShape["nativeRef"]!["leaves"]!.AsArray()
            ...
            .Where(leaf => leaf["kind"]!.GetValue<string>() == "customGeometryPathArcHeightRadius")
            .ToArray();
        var target = Assert.Single(arcLeaves);
        Assert.Equal(150, target["value"]!.GetValue<long>());
        target["value"] = 250;
        ...
        Assert.Contains("wR=\"200\" hR=\"250\" stAng=\"0\" swAng=\"5400000\"", editedXml, StringComparison.Ordinal);
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/custom-geometry-path-arc-height-radius.pptx",
            },
        });
