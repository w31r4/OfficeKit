...
- [x] 1.2 Record current direct source order, element kinds, dependency risks, and reorder capability for each sample.
...
- [x] 3.4 Reimport and continue editing without changing unrelated OPC parts, relationships, or opaque objects.
