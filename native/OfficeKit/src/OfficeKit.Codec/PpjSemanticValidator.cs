...
internal static class PpjSemanticValidator
{
    ...
    private static readonly IReadOnlyDictionary<string, IReadOnlySet<string>> CapabilityFields =
        new Dictionary<string, IReadOnlySet<string>>(StringComparer.Ordinal)
        {
            ...
            ["setTextParagraphStyle"] = Set("textStyles", "text.paragraphs[].style.alignment", "text.paragraphs[].style.tabStops", "text.paragraphs[].style.spaceBefore", "text.paragraphs[].style.spaceBeforeMultiplier", "text.paragraphs[].style.spaceAfter", "text.paragraphs[].style.spaceAfterMultiplier", "text.paragraphs[].style.lineSpacing", "text.paragraphs[].style.lineSpacingMultiplier", "text.paragraphs[].style.defaultText.bold", "text.paragraphs[].style.defaultText.italic", "text.paragraphs[].style.defaultText.size", "text.paragraphs[].style.defaultText.fontFamily", "text.paragraphs[].style.defaultText.fontFamilyEastAsia", "text.paragraphs[].style.defaultText.fontFamilyComplexScript", "text.paragraphs[].style.defaultText.language", "text.paragraphs[].style.defaultText.kerning", "text.paragraphs[].style.defaultText.letterSpacing", "text.paragraphs[].style.defaultText.baseline", "text.paragraphs[].style.defaultText.capitalization", "text.paragraphs[].style.defaultText.strike", "text.paragraphs[].style.defaultText.underline", "text.paragraphs[].style.defaultText.highlight", "text.paragraphs[].style.defaultText.color", "text.paragraphs[].style.defaultText.gradient", "text.paragraphs[].style.defaultText.glow", "text.paragraphs[].style.defaultText.innerShadow", "text.paragraphs[].style.defaultText.reflection", "text.paragraphs[].style.defaultText.shadow", "text.paragraphs[].style.defaultText.softEdge"),
            ["setFill"] = Set("fill"),
