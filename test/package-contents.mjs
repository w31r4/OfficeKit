...
assert.match(standaloneInstaller, /OFFICE_KIT_VERSION=1\.1\.0/);
...
assert.match(windowsStandaloneInstaller, /\$OfficeKitVersion = "1\.1\.0"/);
...
// and hosted gates. The 1.1.0 global CLI deliberately ships the twenty-one audited
// default DOCX/XLSX/PPTX templates once inside the package. Keep narrow
// cross-platform headroom over the measured 36,901,120-byte archive.
