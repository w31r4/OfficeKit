...
- Ship the capability as the additive `1.1.0` minor release without changing the Office wire protocol.
...
- Dependencies: exact runtime pins for `webfetch-core@0.1.5` and `@iconify-json/lucide@1.2.126`.
