...
internal static partial class PpjSourceBoundPresentationCompiler
{
        ...
        JsonElement programRoot)
    {
        ...
        var levelChanged = !JsonEqual(
            MaskTextValues(beforeRaw, maskTabStops: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskAlignment: true, maskBulletStartAt: true),
            MaskTextValues(afterRaw, maskTabStops: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskAlignment: true, maskBulletStartAt: true));
        var bulletStartAtChanged = !JsonEqual(
            MaskTextValues(beforeRaw, maskTabStops: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskAlignment: true, maskLevel: true),
            MaskTextValues(afterRaw, maskTabStops: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskAlignment: true, maskLevel: true));
        ...
        var defaultSoftEdgeChanged = !JsonEqual(
            MaskTextValues(beforeRaw, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true),
            MaskTextValues(afterRaw, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true));
        var spaceBeforeChanged = !JsonEqual(
            MaskTextValues(beforeRaw, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true),
            MaskTextValues(afterRaw, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true));
        var spaceAfterChanged = !JsonEqual(
            MaskTextValues(beforeRaw, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true),
            MaskTextValues(afterRaw, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true));
        var lineSpacingChanged = !JsonEqual(
            MaskTextValues(beforeRaw, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true),
            MaskTextValues(afterRaw, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true));
        var indentChanged = !JsonEqual(
            MaskTextValues(beforeRaw, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true),
            MaskTextValues(afterRaw, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true));
        var hangingChanged = !JsonEqual(
            MaskTextValues(beforeRaw, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskLevel: true, maskBulletStartAt: true),
            MaskTextValues(afterRaw, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskLevel: true, maskBulletStartAt: true));
        if (!JsonEqual(
                MaskTextValues(beforeRaw, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true),
                MaskTextValues(afterRaw, maskTabStops: true, maskAlignment: true, maskDefaultBold: true, maskDefaultItalic: true, maskDefaultSize: true, maskDefaultFontFamily: true, maskDefaultEastAsianFont: true, maskDefaultComplexScriptFont: true, maskDefaultLanguage: true, maskDefaultKerning: true, maskDefaultLetterSpacing: true, maskDefaultBaseline: true, maskDefaultCapitalization: true, maskDefaultStrike: true, maskDefaultUnderline: true, maskDefaultHighlight: true, maskDefaultColor: true, maskDefaultGradient: true, maskDefaultGlow: true, maskDefaultInnerShadow: true, maskDefaultReflection: true, maskDefaultShadow: true, maskDefaultSoftEdge: true, maskSpaceBefore: true, maskSpaceAfter: true, maskLineSpacing: true, maskIndent: true, maskHanging: true, maskLevel: true, maskBulletStartAt: true)))
        ...
        if (tabStopsChanged || alignmentChanged || levelChanged || bulletStartAtChanged || defaultBoldChanged || defaultItalicChanged || defaultSizeChanged || defaultFontFamilyChanged || defaultEastAsianFontChanged || defaultComplexScriptFontChanged || defaultLanguageChanged || defaultKerningChanged || defaultLetterSpacingChanged || defaultBaselineChanged || defaultCapitalizationChanged || defaultStrikeChanged || defaultUnderlineChanged || defaultHighlightChanged || defaultColorChanged || defaultGradientChanged || defaultGlowChanged || defaultInnerShadowChanged || defaultReflectionChanged || defaultShadowChanged || defaultSoftEdgeChanged || spaceBeforeChanged || spaceAfterChanged || lineSpacingChanged || indentChanged || hangingChanged)
        {
            ...
            ApplyTextParagraphStyleMutation(beforeRaw, afterRaw, target, programRoot, path,
                tabStopsChanged, alignmentChanged, levelChanged, bulletStartAtChanged, defaultBoldChanged, defaultItalicChanged, defaultSizeChanged, defaultFontFamilyChanged, defaultEastAsianFontChanged, defaultComplexScriptFontChanged, defaultLanguageChanged, defaultKerningChanged, defaultLetterSpacingChanged, defaultBaselineChanged, defaultCapitalizationChanged, defaultStrikeChanged, defaultUnderlineChanged, defaultHighlightChanged, defaultColorChanged, defaultGradientChanged, defaultGlowChanged, defaultInnerShadowChanged, defaultReflectionChanged, defaultShadowChanged, defaultSoftEdgeChanged, spaceBeforeChanged, spaceAfterChanged, lineSpacingChanged, indentChanged, hangingChanged);
            mutations.SemanticChanges = true;
        }
