...
{
    [Fact]
    public void PpjSourceBoundThemeAccent3BlueModEditsOnlyBlueModAndReprojects()
    {
        ...
        {
            Role = "accent3",
            BlueModulationThousandth = 25_000,
        });
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            {
                SourceUri = "deck.assets/source/theme-accent3-blueMod.pptx",
            },
        });
        ...
        Assert.Equal(0.25, projectedTransform["blueMod"]!.GetValue<double>());
        var nativeRef = Assert.IsType<JsonObject>(projectedTheme["nativeRef"]);
        Assert.Contains(nativeRef["capabilities"]!.AsArray(), capability =>
            capability!["operation"]!.GetValue<string>() == "setThemeAccent3BlueMod" &&
            capability["fields"]!.AsArray().Any(field => field!.GetValue<string>() == "accentTransforms.accent3.blueMod"));
        ...
        editedProgram["design"]!["theme"]!["accentTransforms"]!["accent3"]!["blueMod"] = 0.4;
        ...
        using (var package = PresentationDocument.Open(stream, false))
        {
            ...
            Assert.Equal(40_000, Assert.Single(accent3.Elements<A.BlueModulation>()).Val!.Value);
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/theme-accent3-blueMod.pptx",
            },
        });
        Assert.True(reprojected.Ok, Diagnostics(reprojected));
        var reprojectedProgram = JsonNode.Parse(reprojected.PresentationProgram.ProgramJson.ToByteArray())!.AsObject();
        Assert.Equal(0.4, reprojectedProgram["design"]!["theme"]!["accentTransforms"]!["accent3"]!["blueMod"]!.GetValue<double>());

        var unauthorizedProgram = JsonNode.Parse(projectedProgram.ToJsonString())!.AsObject();
        unauthorizedProgram["design"]!["theme"]!["accentTransforms"]!["accent3"]!["blueMod"] = 0.8;
        unauthorizedProgram["design"]!["theme"]!["nativeRef"]!["capabilities"]!.AsArray()
            .Single(capability => capability!["operation"]!.GetValue<string>() == "setThemeAccent3BlueMod")!["fields"] = new JsonArray("accentTransforms.accent3.tint");
        ...
        deletionProgram["design"]!["theme"]!["accentTransforms"]!["accent3"]!.AsObject().Remove("blueMod");
        ...
        outOfRangeProgram["design"]!["theme"]!["accentTransforms"]!["accent3"]!["blueMod"] = 1.1;
