...
for (const required of [
  ...
  "skills/presentations/skills/presentations/references/imported-capabilities.md",
  "skills/presentations/skills/presentations/references/source-continuation.md",
  "skills/presentations/skills/presentations/references/primitives.md",
  ...
  "skills/skill-update/.codex-plugin/plugin.json",
  "skills/skill-update/manifest.json",
  "skills/skill-update/README.md",
  "skills/skill-update/assets/icon.svg",
  "skills/skill-update/skills/skill-update/SKILL.md",
  "skills/skill-update/skills/skill-update/agents/openai.yaml",
  "skills/skill-update/skills/skill-update/assets/icon.svg",
  "skills/skill-update/skills/skill-update/scripts/check-primitive-impact.mjs",
