...
{
    [Fact]
    public void PpjSourceBoundThemeColorRoleDark2RgbaEditsOnlyDark2AndReprojects()
    {
        ...
        authoredTheme.Dark2Rgb = "30313240";
        ...
        Assert.Equal("#30313240", projectedColorRoles["dark2"]!.GetValue<string>());
        ...
        editedProgram["design"]!["theme"]!["colorRoles"]!["dark2"] = "#ABCDEF40";
        ...
        using (var package = PresentationDocument.Open(stream, false))
        {
            ...
            Assert.Equal(25098, scheme.Dark2Color.RgbColorModelHex.GetFirstChild<A.Alpha>()!.Val!.Value);
        ...
        Assert.Equal("#ABCDEF40", reprojectedProgram["design"]!["theme"]!["colorRoles"]!["dark2"]!.GetValue<string>());

        var alphaPresenceProgram = JsonNode.Parse(projectedProgram.ToJsonString())!.AsObject();
        alphaPresenceProgram["design"]!["theme"]!["colorRoles"]!["dark2"] = "#ABCDEF";
