...
export const HELP_CATALOG = [
  ...
  { artifactKind: "presentation", kind: "api", name: "nativeObject.setDiagramNodeText", summary: "Replace a one-run source-bound SmartArt document node after its top-level four-part graph and single-paragraph DiagramDataPart profile are proven. Multi-run nodes reject so OfficeKit never guesses a formatting boundary." },
  { artifactKind: "presentation", kind: "api", name: "nativeObject.setDiagramNodeRunText", summary: "Replace one existing direct a:r/a:t value by zero-based run index in a proven single-paragraph SmartArt document node. Run count/order and every a:rPr stay source-bound; fields, breaks, topology changes, and unsupported diagrams reject without fallback." },
