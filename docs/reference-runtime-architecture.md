...
The subsequent DOCX hyperlink slice passes 37 local codec tests, a 38-file/12,878,023-byte runtime build, the 194-file clean-install package, and real Chromium/LibreOffice/Poppler-backed document gates. Fresh hosted evidence remains pending until the milestone lands on `main`.
