...
{
    [Fact]
    public void PpjSourceBoundThemeMajorEastAsianFontEditsOnlyOwnedSlotAndReprojects()
    {
        ...
        var projected = Invoke(new CodecRequest
        {
            ...
            {
                SourceUri = "deck.assets/source/theme-major-eastasia-font.pptx",
            },
        });
        ...
        Assert.Contains(nativeRef["capabilities"]!.AsArray(), capability =>
            capability!["operation"]!.GetValue<string>() == "setThemeMajorFontEastAsia" &&
            capability["fields"]!.AsArray().Any(field => field!.GetValue<string>() == "fontScheme.majorEastAsia"));
        ...
        editedProgram["design"]!["theme"]!["fontScheme"]!["majorEastAsia"] = "Nebula CJK";
        ...
        using (var package = PresentationDocument.Open(stream, false))
        {
            ...
            Assert.Equal("Nebula CJK", fontScheme.MajorFont.EastAsianFont!.Typeface!.Value);
        ...
        var reprojected = Invoke(new CodecRequest
        {
            ...
            PresentationProgram = new PresentationProgramRequest
            {
                SourceUri = "deck.assets/edited/theme-major-eastasia-font.pptx",
            },
        });
        Assert.True(reprojected.Ok, Diagnostics(reprojected));
        var reprojectedProgram = JsonNode.Parse(reprojected.PresentationProgram.ProgramJson.ToByteArray())!.AsObject();
        Assert.Equal("Nebula CJK", reprojectedProgram["design"]!["theme"]!["fontScheme"]!["majorEastAsia"]!.GetValue<string>());

        var combinedProgram = JsonNode.Parse(editedProgram.ToJsonString())!.AsObject();
        combinedProgram["design"]!["theme"]!["fontScheme"]!["minor"] = "Changed Minor";
        ...
        tamperedProgram["design"]!["theme"]!["nativeRef"]!["capabilities"]!.AsArray()
            .Single(capability => capability!["operation"]!.GetValue<string>() == "setThemeMajorFontEastAsia")!["fields"] = new JsonArray("fontScheme.minor");
