        ...
        switch (source.ContentCase)
        {
            ...
            case PresentationTextRun.ContentOneofCase.Field:
                ...
                if (source.Field.Automatic && !IsAutomaticFieldType(source.Field.Type))
                    throw new CodecException("invalid_presentation_text", "The bounded automatic presentation field profile only supports type slidenum, author, datetime, datetime1, datetime2, datetime3, datetime4, datetime5, datetime6, datetime7, datetime8, datetime9, datetime10, datetime11, datetime12, or datetime13.");
                return;
